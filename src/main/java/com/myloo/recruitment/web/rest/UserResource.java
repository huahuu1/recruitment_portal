...
import com.myloo.recruitment.web.rest.errors.NotFoundException;
...
public class UserResource {
    ...
    @PutMapping("/admin/users/current")
        ...
        , @RequestParam(value = "imageFile", required = false) MultipartFile imageFile)
    {
        ...
        if (currentUser == null || currentUser.getId() != userDTO.getId() || !currentUser.getLogin().equals(userDTO.getLogin())) {
        ...
        Optional<UserDTO> updatedUser = userService.updateUserWithFile(userDTO, imageFile);
