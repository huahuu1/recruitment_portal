<template>
    <div>
        ...
        <!-- <header class="top-bar">
          <div class="topbar">
            ...
            <div class="row justify-content-end">
              ...
              <div class="topbar-social text-center text-md-left topbar-left">
                ...
                <li class="ml-10 pr-10"><a href="#"><i class="text-white fa fa-envelope"></i> info@Joblly.com</a></li>
          ...
          <nav class="nav-white nav-transparent full-width core-nav nav-core-sticky on-scroll">
            ...
            <ul class="menu core-nav-list">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="job_list.html">Jobs List</a></li>
                  <li><a href="job_list_right_sidebar.html">Jobs List Right Sidebar</a></li>
                  <li><a href="job_list-map.html">Jobs with Map</a></li>
                  <li><a href="job_categories.html">Jobs Categories</a></li>
                  <li><a href="job_details.html">Jobs Details</a></li>
                  <li><a href="job_details_right_sidebar.html">Jobs Details right sidebar</a></li>
                </ul>
              </li>
              <li class="megamenu">
                <a href="#">Pages</a>
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-12">
                      <ul class="list-group">
                        ...
                        <li><a href="faqs.html"><i class="ti-arrow-circle-right mr-10"></i>FAQs</a></li>
                        ...
                        <li><a href="user_list.html"><i class="ti-arrow-circle-right mr-10"></i>Employer List</a></li>
                        <li><a href="userprofile.html"><i class="ti-arrow-circle-right mr-10"></i>Employer Profile</a></li>
                    ...
                    <div class="col-lg-3 col-12">
                      <ul class="list-group">
                        ...
                        <li><a href="job_list.html"><i class="ti-arrow-circle-right mr-10"></i>Jobs List</a></li>
                        <li><a href="job_details.html"><i class="ti-arrow-circle-right mr-10"></i>Jobs Details</a></li>
                        ...
                        <li><a href="register_login.html"><i class="ti-arrow-circle-right mr-10"></i>Register & Login</a></li>
                        <li><a href="forgot_pass.html"><i class="ti-arrow-circle-right mr-10"></i>Forgot Password</a></li>
                        <li><a href="lockscreen.html"><i class="ti-arrow-circle-right mr-10"></i>Lock Screen</a></li>
                        <li><a href="maintenance.html"><i class="ti-arrow-circle-right mr-10"></i>Under Constructions</a></li>
                        <li><a href="404.html"><i class="ti-arrow-circle-right mr-10"></i>404</a></li>
                        <li><a href="500.html"><i class="ti-arrow-circle-right mr-10"></i>500</a></li>
                      </ul>
                    </div>
                    <div class="col-lg-3 col-12">
                      <ul class="list-group">
                        <li><h4 class="menu-title">Features</h4></li>
                        <li><a href="header_default.html"><i class="ti-arrow-circle-right mr-10"></i>Header One</a></li>
                        ...
                        <li><a href="footer_style4.html"><i class="ti-arrow-circle-right mr-10"></i>Footer Four</a></li>
                        <li><a href="footer_style5.html"><i class="ti-arrow-circle-right mr-10"></i>Footer Five</a></li>
                        <li><a href="footer_style6.html"><i class="ti-arrow-circle-right mr-10"></i>Footer Six</a></li>
                      </ul>
                    </div>
            ...
            <ul class="attributes">
              <li class="d-md-block d-none"><a href="#" class="px-10 pt-15 pb-10"><div class="btn btn-primary py-5">Post a job</div></a></li>
      ...
      <header class="top-bar">
		  ...
		  <div class="container-fluid">
			<div class="row justify-content-end">
			  ...
			  <div class="col-lg-6 col-12 xs-mb-10">
				<div class="topbar-call text-center text-lg-right topbar-right">
				  <ul class="list-inline d-lg-flex justify-content-end">
					  <li v-if="!authenticated" class="mr-10 pl-10 font-size-14"><router-link to="/dang-ky-tai-khoan"><i class="text-white fa fa-user d-md-inline-block d-none"></i> Registration </router-link></li>
					  <li v-if="!authenticated" class="mr-10 pl-10 font-size-14"><router-link to="/dang-nhap"><i class="text-white fa fa-sign-in d-md-inline-block d-none"></i> Sign in</router-link></li>
            <li v-if="!authenticated" class="mr-10 pl-10 font-size-14"><router-link to="/admin/dang-nhap"><i class="text-white fa fa-sign-in d-md-inline-block d-none"></i> Sign in for employers </router-link></li>
            <li v-if="authenticated" class="mr-10 pl-10 font-size-14">
              <div class="dropdown">
                  <span style="font-weight: bold; font-size: 1rem" class="dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     Hello, {{username}}
                  </span>
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <router-link class="dropdown-item font-size-14"  to="/trang-ca-nhan">Personal page</router-link>
                    <a @click="logout()" class="dropdown-item font-size-14" href="javascript:void(0);">Sign out</a>
                  </div>
                </div>
		...
		<div class="stand-sticky h-0" style="height: 63px; display: none;"></div><nav class="nav-white nav-transparent full-width core-nav nav-core-sticky"><div class="nav-container">
        ...
        <router-link to="/" class="brand">
			...
			<div class="wrap-core-nav-list right"><ul class="attributes">
				<!-- <li class="d-md-block d-none"><a href="#" class="px-10 pt-15 pb-10"><div class="btn btn-primary py-5">Post a job</div></a></li>
				<li><a href="#" class="toggle-search-fullscreen"><span class="ti-search"></span></a></li> -->
			</ul><ul class="menu core-nav-list">
				<li>
					<router-link :active-class="'active'" to="/"> Home page</router-link>
				</li>
				<li>
					<router-link :active-class="'active'" to="/danh-sach-viec-lam">Latest jobs</router-link>
				</li>
        <li>
					<router-link :active-class="'active'" to="/bai-viet">Posts</router-link>
				</li>
				<!-- <li class="dropdown">
					<a href="#"></a>
					<ul class="dropdown-menu">
			...
			<div class="wrap-search-fullscreen"><div class="nav-container">
				<div class="container-fluid">
					<button class="close-search"><span class="ti-close"></span></button>
					<input type="text" placeholder="Search...">
				</div>
...
<script lang="ts" src="./header.component.ts">
</script>

<!-- Add "scoped" attribute to limit CSS to this component only -->
<style>
 @import '../../../../content/css/vendors_css.css';
 @import '../../../../content/css/style.css';
 @import '../../../../content/css/skin_color.css';
