      ...
      return (
        ...
        (a._jQueryInterface = function (i) {
          return this.each(function () {
            ...
            if (
              (!e && n.toggle && /show|hide/.test(i) && (n.toggle = !1), e || ((e = new a(this, n)), t.data(dt, e)), 'string' == typeof i)
            ) {
              ...
              if (!this._inNavbar && t) {
                ...
                'parent' === this._config.reference
                  ...
                  : _.isElement(this._config.reference) &&
                    ((o = this._config.reference), 'undefined' != typeof this._config.reference.jquery && (o = this._config.reference[0])),
    ...
    Yn = (function () {
      ...
      return (
        (t.show = function () {
          ...
          if (
            !(
              (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && g(this._element).hasClass(Rn)) ||
        ...
        if (b.parent().hasClass(a.wrapperClass)) {
          ...
          b.bind('touchmove', function (b) {
            ...
            b.originalEvent.touches.length &&
              (n((A - b.originalEvent.touches[0].pageY) / a.touchScrollStep, !0), (A = b.originalEvent.touches[0].pageY));
          });
          x();
          'bottom' === a.start
  ...
  (function (factory) {
    ...
    $.fn.sparkline.discrete = discrete = createClass($.fn.sparkline._base, barHighlightMixin, {
      ...
      renderRegion: function (valuenum, highlight) {
        ...
        color =
          options.get('thresholdColor') && val < options.get('thresholdValue') ? options.get('thresholdColor') : options.get('lineColor');
        if (highlight) {
          color = this.calcHighlightColor(color, options);
        }
    ...
    $.fn.sparkline.pie = pie = createClass($.fn.sparkline._base, {
      ...
      render: function () {
        ...
        if (borderWidth) {
          target
            .drawCircle(radius, radius, Math.floor(radius - borderWidth / 2), options.get('borderColor'), undefined, borderWidth)
            .append();
        }
        for (i = values.length; i--; ) {
          if (values[i]) {
      ...
      setTimeout(function () {
        ...
        e('body').on('click', '#gdpr-cookie-accept', function () {
          ...
          e.each(e('input[name="gdpr[]"]').serializeArray(), function (e, o) {
            ...
            i('cookieControlPrefs', encodeURIComponent(JSON.stringify(t)), 365),
      ...
      (function (t) {
        ...
        function n(e, t, n) {
          ...
          return (
            (t = u(t) || 0),
            i(n) &&
              ((_ = !!n.leading), (S = 'maxWait' in n), (y = S ? x(u(n.maxWait) || 0, t) : y), (z = 'trailing' in n ? !!n.trailing : z)),
            (m.cancel = l),
            (m.flush = p),
            m
          );
      ...
      (function (t) {
        ...
        function n(e, t, n) {
          ...
          return (
            (t = a(t) || 0),
            o(n) &&
              ((_ = !!n.leading), (S = 'maxWait' in n), (y = S ? k(a(n.maxWait) || 0, t) : y), (z = 'trailing' in n ? !!n.trailing : z)),
            (m.cancel = l),
            (m.flush = p),
            m
          );
