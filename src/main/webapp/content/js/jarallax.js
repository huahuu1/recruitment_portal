...
!(function (e) {
    ...
    e.requestAnimationFrame ||
      !(function () {
        for (var t = ['webkit', 'moz'], n = 0; n < t.length && !e.requestAnimationFrame; ++n) {
          var i = t[n];
          (e.requestAnimationFrame = e[i + 'RequestAnimationFrame']),
            (e.cancelAnimationFrame = e[i + 'CancelAnimationFrame'] || e[i + 'CancelRequestAnimationFrame']);
        }
  ...
  var a,
    ...
    p = m.toLowerCase().indexOf('android') > -1,
    u = /iPad|iPhone|iPod/.test(m) && !e.MSStream,
    ...
    y = (function () {
      function e(e, n) {
        ...
        if (
          ...
          (i = JSON.parse(o.$item.getAttribute('data-jarallax') || '{}')),
          (o.options = o.extend({}, o.defaults, i, n)),
  ...
  (y.prototype.css = function (t, n) {
    ...
    n.transform &&
      (c && (n.transform += ' translateZ(0)'), (n.WebkitTransform = n.MozTransform = n.msTransform = n.OTransform = n.transform));
    ...
    (y.prototype.init = function () {
      ...
      (o || 'opacity' === t.options.type || 'scale' === t.options.type || 'scale-opacity' === t.options.type) &&
        ...
        t.image.width && t.image.height
          ? e()
          : t.getImageSize(t.image.src, function (n, i) {
              (t.image.width = n), (t.image.height = i), e();
            }),
        h.push(t);
    }),
    (y.prototype.destroy = function () {
      for (var e = this, t = 0, n = h.length; t < n; t++)
      ...
      e.$item.removeAttribute('data-jarallax-original-styles'),
        'null' === i ? e.$item.removeAttribute('style') : e.$item.setAttribute('style', i),
    ...
    (y.prototype.coverImage = function () {
      ...
      if (e.image.width && e.image.height) {
        var t = e.image.$container.getBoundingClientRect(),
          ...
          g = 0;
        c &&
          ((m = s < 0 ? s * Math.max(i, r) : s * (i + r)),
          s > 1 ? (u = Math.abs(m - r)) : s < 0 ? (u = m / s + Math.abs(m)) : (u += Math.abs(r - i) * (1 - s)),
          (m /= 2)),
          (p = (u * a) / l),
          p < n && ((p = n), (u = (p * l) / a)),
          c ? ((d = o + (n - p) / 2), (g = (r - u) / 2)) : ((d = (n - p) / 2), (g = (i - u) / 2)),
          'absolute' === e.image.position && (d -= o),
          (e.parallaxScrollDistance = m),
          e.css(e.image.$item, { width: p + 'px', height: u + 'px', marginLeft: d + 'px', marginTop: g + 'px' }),
    ...
    (y.prototype.onScroll = function (e) {
      ...
      if (t.image.width && t.image.height) {
        var n = t.$item.getBoundingClientRect(),
          i = n.top,
          o = n.height,
          l = { visibility: 'visible', backgroundPosition: '50% 50%' },
          s = n;
        if (
          (t.options.elementInViewport && (s = t.options.elementInViewport.getBoundingClientRect()),
    ...
    i(e, 'scroll', o),
    i(e, 'resize', o),
    i(e, 'orientationchange', o),
    i(e, 'load', o);
  var v = function (e) {
    ('object' == typeof HTMLElement
      ? e instanceof HTMLElement
      : e && 'object' == typeof e && null !== e && 1 === e.nodeType && 'string' == typeof e.nodeName) && (e = [e]);
    var t,
      n = arguments[1],
    ...
    for (a; a < o; a++)
      if (
        ('object' == typeof n || 'undefined' == typeof n
          ? e[a].jarallax || (e[a].jarallax = new y(e[a], n))
          : e[a].jarallax && (t = e[a].jarallax[n].apply(e[a].jarallax, i)),
        'undefined' != typeof t)
      )
        return t;
    return e;
...
!(function (e) {
  ...
  function t(e) {
    e = e || {};
    for (var t = 1; t < arguments.length; t++)
      if (arguments[t]) for (var i in arguments[t]) arguments[t].hasOwnProperty(i) && (e[i] = arguments[t][i]);
    return e;
  }
  function i() {
  ...
  var a = (function () {
    function e(e, o) {
      var a = this;
      (a.url = e),
        (a.options_default = { autoplay: 1, loop: 1, mute: 1, controls: 0, startTime: 0, endTime: 0 }),
  ...
  (a.prototype.parseURL = function (e) {
    ...
    (a.prototype.off = function (e, t) {
      if (this.userEventsList && this.userEventsList[e])
        if (t) for (var i = 0; i < this.userEventsList[e].length; i++) this.userEventsList[e][i] === t && (this.userEventsList[e][i] = !1);
    ...
    (a.prototype.play = function (e) {
      var t = this;
      t.player &&
        ('youtube' === t.type && t.player.playVideo && ('undefined' != typeof e && t.player.seekTo(e || 0), t.player.playVideo()),
        'vimeo' === t.type &&
    ...
    (a.prototype.pause = function () {
      this.player &&
        ('youtube' === this.type && this.player.pauseVideo && this.player.pauseVideo(),
      ...
      if ('youtube' === t.type) {
        ...
        (a.onload = function () {
          120 !== (this.naturalWidth || this.width) || o === i.length - 1
            ? ((t.videoImage = 'https://img.youtube.com/vi/' + t.videoID + '/' + i[o] + '.jpg'), e(t.videoImage))
            : (o++, (this.src = 'https://img.youtube.com/vi/' + t.videoID + '/' + i[o] + '.jpg'));
        }),
        ...
        : void i.onAPIready(function () {
            ...
            if ((i.$iframe || ((n = document.createElement('div')), (n.style.display = 'none')), 'youtube' === i.type)) {
              (i.playerOptions = {}),
                ...
                (i.playerOptions.playerVars = { autohide: 1, rel: 0, autoplay: 0 }),
                i.options.controls ||
              ...
              i.playerOptions.events = {
                ...
                onStateChange: function (e) {
                  i.options.loop && e.data === YT.PlayerState.ENDED && i.play(i.options.startTime),
                    r || e.data !== YT.PlayerState.PLAYING || ((r = 1), i.fire('started', e)),
              ...
              (i.player = i.player || new e.YT.Player(i.playerID, i.playerOptions)),
                s &&
                  ((i.$iframe = document.getElementById(i.playerID)),
                  (i.videoWidth = parseInt(i.$iframe.getAttribute('width'), 10) || 1280),
                  (i.videoHeight = parseInt(i.$iframe.getAttribute('height'), 10) || 720));
            }
            if ('vimeo' === i.type) {
              (i.playerOptions = ''),
                (i.playerOptions += 'player_id=' + i.playerID),
                (i.playerOptions += '&autopause=0'),
                i.options.controls || (i.playerOptions += '&badge=0&byline=0&portrait=0&title=0'),
                (i.playerOptions += '&autoplay=' + (i.options.autoplay ? '1' : '0')),
                (i.playerOptions += '&loop=' + (i.options.loop ? 1 : 0)),
                i.$iframe ||
                  ((i.$iframe = document.createElement('iframe')),
                  i.$iframe.setAttribute('id', i.playerID),
                  i.$iframe.setAttribute('src', 'https://player.vimeo.com/video/' + i.videoID + '?' + i.playerOptions),
  ...
  a.prototype.loadAPI = function () {
    ...
    if (!n || !r) {
      var i = '';
      if (
        ('youtube' !== t.type || n || ((n = 1), (i = '//www.youtube.com/iframe_api')),
        'vimeo' !== t.type || r || ((r = 1), (i = '//player.vimeo.com/api/player.js')),
        i)
      ) {
    ...
    if ('undefined' != typeof jarallax) {
      ...
      e.prototype.initImg = function () {
        ...
        if ((e.options.videoSrc || (e.options.videoSrc = e.$item.getAttribute('data-jarallax-video') || !1), e.options.videoSrc)) {
          var i = new VideoWorker(e.options.videoSrc, { startTime: e.options.videoStartTime || 0, endTime: e.options.videoEndTime || 0 });
          if (
            (i.isValid() &&
              ((e.image.useImgTag = !0),
              i.on('ready', function () {
              ...
              i.on('started', function () {
                (e.image.$default_item = e.image.$item),
                  ...
                  (e.image.width = e.options.imgWidth = e.video.videoWidth || 1280),
                  (e.image.height = e.options.imgHeight = e.video.videoHeight || 720),
                  e.coverImage(),
                  e.clipContainer(),
                  e.onScroll(),
