...
!(function (n) {
    ...
    var t = {
      ...
      setPosition: function () {
        var n = $('.core-nav-list'),
          e = n.outerHeight() / 2;
        $(window).width() > 920
          ? (n.css('margin-top', -1 * e), n.css('top', 0.5 * $(window).height()))
          : (n.css('margin-top', 0), n.css('top', 0));
      },
    };
    n.exports = t;
  },
  ...
  function (n, e, o) {
    ...
    var t = {
      init: function (n, e) {
        e.container ? n.wrapInner("<div class='nav-container'></div>") : n.wrapInner("<div class='full-container'></div>"),
          $('.core-nav-list').addClass('split-list'),
          this.devidedMenu(e);
      },
      devidedMenu: function (n) {
        var e = $('.split-list');
        e.each(function () {
          for (var n = new Array(), e = $('.split-list > li'), o = Math.floor(e.length / 2), t = e.length - 2 * o, a = 0; a < 2; a++)
            n[a] = a < t ? o + 1 : o;
          for (a = 0; a < 2; a++) {
  ...
  function (n, e, o) {
    ...
    n.exports = function (n, e, o) {
      ...
      return (
        (e = r(e) || 0),
        t(o) && ((w = !!o.leading), (u = ($ = 'maxWait' in o) ? s(r(o.maxWait) || 0, e) : u), (h = 'trailing' in o ? !!o.trailing : h)),
        (S.cancel = function () {
    ...
    var i = {
      init: function (n, e) {
        ...
        if (
          ...
          switch (e.menuPosition) {
            case 'bottom':
              e.container
                ? ($('.wrap-core-nav-list').wrapInner("<div class='nav-container'></div>"),
                  $(e.header).wrapInner("<div class='nav-container'></div>"))
                : ($('.wrap-core-nav-list').wrapInner("<div class='full-container'></div>"),
                  $(e.header).wrapInner("<div class='full-container'></div>"));
              break;
            case 'bottom center':
              e.container
                ? ($('.wrap-core-nav-list').wrapInner("<div class='nav-container center'></div>"),
                  $(e.header).wrapInner("<div class='nav-container center'></div>"))
                : ($('.wrap-core-nav-list').wrapInner("<div class='full-container center'></div>"),
                  $(e.header).wrapInner("<div class='full-container center'></div>"));
              break;
            case 'bottom right':
              e.container
                ? ($('.wrap-core-nav-list').wrapInner("<div class='nav-container right'></div>"),
                  $(e.header).wrapInner("<div class='nav-container'></div>"))
                : ($('.wrap-core-nav-list').wrapInner("<div class='full-container right'></div>"),
                  $(e.header).wrapInner("<div class='full-container'></div>"));
              break;
            default:
              e.container ? n.wrapInner("<div class='nav-container'></div>") : n.wrapInner("<div class='full-container'></div>");
      ...
      setMode: function (n) {
        switch (n.mode) {
          case 'fixed':
            ...
            break;
          case 'sticky':
            $('.core-nav').addClass('nav-core-sticky'),
              $('<div class="stand-sticky h-0"></div>').insertBefore('.core-nav'),
              $('.stand-sticky').css('height', $('.core-nav').height()),
              $('.stand-sticky').css('display', 'none');
            var e = 50;
            $(window).on('resize', function () {
              $('.stand-sticky').css('height', $('.core-nav').height());
            }),
              $(window).on('scroll', function () {
                $(window).scrollTop() > e
                  ? ($('.nav-core-sticky').hasClass('on-scroll') || ($.isFunction(n.onStartSticky) && n.onStartSticky()),
                    $('.nav-core-sticky').addClass('on-scroll'),
                    $('.stand-sticky').css('display', 'block'))
                  : ($('.nav-core-sticky').hasClass('on-scroll') && $.isFunction(n.onEndSticky) && n.onEndSticky(),
                    $('.nav-core-sticky').removeClass('on-scroll'),
                    $('.stand-sticky').css('display', 'none'));
              });
        }
      },
      topSearch: function (n) {
        ...
        e.length && (e.remove(), $('.core-nav').prepend('<div class="wrap-search-top">' + o + '</div>')),
          n.container
            ? $('.wrap-search-top').wrapInner("<div class='nav-container'></div>")
            : $('.wrap-search-top').wrapInner("<div class='full-container'></div>"),
        ...
        if ($('.content-header').length && 'default' == n.layout)
          switch (n.menuPosition) {
            case 'bottom':
              o > 992
                ? n.container
                  ? ($('.nav-header .nav-container').prepend("<div class='content-header'>" + e + '</div>'),
                    $('.core-nav > .content-header').remove())
                  : ($('.nav-header .full-container').prepend("<div class='content-header'>" + e + '</div>'),
                    $('.core-nav > .content-header').remove())
        ...
        $('.core-nav-toggle').on('click', function (e) {
          e.preventDefault(),
            ...
            $('.open-responsive').length
              ? ($('.dropdown-overlay').addClass('open-dropdown'),
                $('.core-nav').addClass('open-dropdown'),
                $('.core-nav .attributes .megamenu').removeClass('open'),
                $('.core-nav .attributes .dropdown').removeClass('open'))
        ...
        $('.dropdown-overlay').length || $('.core-nav').after('<div class="dropdown-overlay"></div>'),
          $(e).each(function () {
            var e = $(this),
              ...
              t = $(this).data('width');
            switch (
              (void 0 != t && ($(this).css('position', 'relative'), $(this).find('.megamenu-content').eq(0).css('width', t)),
              e.removeClass('open'),
                  ...
                  $(window).width() < 920 &&
                    (e.hasClass('open')
                      ...
                      : ($('.megamenu').removeClass('open'),
                        n.animated
                          ? (e.addClass('open'), i.animateCss(e.find('.megamenu-content').eq(0), n, n.animatedIn, !0))
                          : e.addClass('open'),
              ...
              o.on('click', function (o) {
                o.preventDefault(),
                  $(window).width() < 920 &&
                    (e.hasClass('open')
                      ? (n.animated
                          ? i.animateCss(e.find('.dropdown-menu').eq(0), n, n.animatedOut, !1, function () {
                              setTimeout(function () {
                                e.removeClass('open');
                              }, 500);
                            })
                      ...
                      : (n.animated
                          ? (e.addClass('open'), i.animateCss(e.find('.dropdown-menu').eq(0), n, n.animatedIn, !0))
                          : e.addClass('open'),
      ...
      overlayDropdown: function () {
        ...
        n || e
          ? ($('.dropdown-overlay').addClass('open-dropdown'), $('.core-nav').addClass('open-dropdown'))
          : ($('.dropdown-overlay').removeClass('open-dropdown'), $('.core-nav').removeClass('open-dropdown'));
      },
        ...
        if (t) {
          switch (n.menuPosition) {
            ...
            case 'bottom':
              n.container
                ? e > 992 &&
                  ($('.core-nav .nav-container').prepend('<ul class="attributes">' + a + '</ul>'), $('.nav-header .attributes').remove())
                : e > 992 &&
                  ($('.core-nav .full-container').prepend('<ul class="attributes">' + a + '</ul>'), $('.nav-header .attributes').remove());
              break;
            default:
              n.container,
                e > 992 &&
                  ($('.core-nav .wrap-core-nav-list').prepend('<ul class="attributes">' + a + '</ul>'),
                  $('.nav-header .attributes').remove());
          }
        ...
        $('.scrollspy').each(function () {
          ...
          $(o).length &&
            $(window).on('scroll', function () {
              var t = void 0;
              (t =
                'section' == n.layout && $(window).width() > 920
                  ? $(o).offset().top
                  : $(o).offset().top - parseInt($(o).css('padding-top'))),
                $(window).scrollTop() > t - 1 || $(window).scrollTop() > t + 1
                  ? ($('.scrollspy').removeClass('active'), $(e).addClass('active'))
            ...
            $('a', this).on('click', function (e) {
              ...
              (a =
                'section' == n.layout && $(window).width() > 920
                  ? $(o).offset().top + 1
                  : $(o).offset().top - parseInt($(o).css('padding-top')) / 2),
                t.stop().animate(
                  {
                    scrollTop: a,
                  },
      ...
      animateCss: function (n, e, o, t, a) {
        n.removeClass('animated'),
          t ? n.removeClass(e.animatedOut) : n.removeClass(e.animatedIn),
          n.addClass('animated ' + o),
          'function' == typeof a && a();
      },
    };
    n.exports = i;
