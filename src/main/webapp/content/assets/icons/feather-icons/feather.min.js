...
*/
    ...
    function (e, n, i) {
      ...
      })('versions', []).push({ version: l.version, mode: i(29) ? 'pure' : 'global', copyright: '© 2018 Denis Pushkarev (zloirock.ru)' });
    },
    function (e, n, i) {
      var l = i(15),
        t = Math.min;
                ...
                return (
                  ...
                  (function (e) {
                    return Object.keys(e)
                      ...
                      .join(' ');
                  })(l({}, this.attrs, e, { class: (0, r.default)(this.attrs.class, e.class) })) +
                  '>' +
                  this.contents +
                  '</svg>'
                );
        ...
        'Array',
        {
          from: function (e) {
            var n,
              ...
              v = 0,
              g = p(x);
            if ((f && (d = l(d, u > 2 ? arguments[2] : void 0, 2)), void 0 == g || (s == Array && a(g)))) for (i = new s((n = c(x.length))); n > v; v++) y(i, v, f ? d(x[v], v) : x[v]);
            else for (h = g.call(x), i = new s(); !(t = h.next()).done; v++) y(i, v, f ? o(h, d, [t.value, v], !0) : t.value);
            return (i.length = v), i;
          },
        }
      );
    ...
    function (e, n, i) {
      ...
      e.exports = function (e, n, i, u, d, f, v) {
        ...
        if (
          (O && (M = p(O.call(new e()))) !== Object.prototype && M.next && (y(M, b, !0), l || 'function' == typeof M[h] || o(M, h, s)),
          z &&
            H &&
            'values' !== H.name &&
            ((A = !0),
          ...
          if (((g = { values: z ? V : w('values'), keys: f ? V : w('keys'), entries: j }), v)) for (m in g) m in k || r(k, m, g[m]);
