      ...
      a(t, [
        {
          ...
          value: function (t) {
            ...
            h.appendChild(c), c.setAttributeNS(window.SVG.xlink, 'href', n), p.setAttrs(c, { x: 0, y: 0, preserveAspectRatio: 'none', width: o + 'px', height: l + 'px' }), (c.style.opacity = t.opacity), e.globals.dom.elDefs.node.appendChild(h);
          },
        },
        {
          key: 'getSeriesIndex',
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (c.enabled && !m) {
              ...
              var v = '';
              void 0 !== a && (v = x(a, { seriesIndex: s, dataPointIndex: r, w: d })), 0 === a && d.config.chart.stacked && (v = '');
      ...
      a(t, [
        {
          ...
          value: function (t, e) {
            ...
            for (var o = 0, l = 0; o < t.length; o++, l++) {
              ...
              for (var C = a.group({ class: 'apexcharts-datalabels', 'data:realIndex': y }), L = 0; L < i.globals.dataPoints; L++) {
                var P = this.barHelpers.getStrokeWidth(o, L, y),
                  T = null,
                  z = { indexes: { i: o, j: L, realIndex: y, bc: l }, x: f, y: x, strokeWidth: P, elSeries: w };
                this.isHorizontal ? ((T = this.drawBarPaths(n({}, z, { barHeight: k, zeroW: u, yDivision: c }))), (A = this.series[o][L] / this.invertedYRatio)) : ((T = this.drawColumnPaths(n({}, z, { xDivision: h, barWidth: A, zeroH: d }))), (k = this.series[o][L] / this.yRatio[this.yaxisIndex])), (x = T.y), (f = T.x), L > 0 && v.push(f + A / 2), b.push(x);
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return h.globals.isXNumeric || (n += o), this.barHelpers.barBackground({ bc: g, i: c, y1: u - i * this.visibleI, y2: i * this.seriesLen, elSeries: l }), { pathTo: f.pathTo, pathFrom: f.pathFrom, x: r, y: n, barYPosition: u };
          },
        },
        {
          key: 'drawColumnPaths',
      ...
      a(i, [
        {
          ...
          value: function (t, e) {
            ...
            for (var s = a.group({ class: 'apexcharts-rangebar-series apexcharts-plot-series' }), r = 0; r < t.length; r++) {
              ...
              for (var y = a.group({ class: 'apexcharts-datalabels', 'data:realIndex': f }), w = 0; w < i.globals.dataPoints; w++) {
                ...
                } else b = (C = this.drawRangeColumnPaths(n({ indexes: { i: r, j: w, realIndex: f }, zeroH: l, barWidth: m, xDivision: o }, P))).barHeight;
                (d = C.y), (c = C.x);
        ...
        },
        {
          ...
          value: function (t) {
            var e = t.i,
              ...
              o = t.parent,
              l = this.w;
            (0 === e && l.globals.skipFirstTimelinelabel) || (e === n - 1 && l.globals.skipLastTimelinelabel) || 'radar' === l.config.chart.type || (l.config.grid.xaxis.lines.show && this._drawGridLine({ x1: i, y1: a, x2: s, y2: r, parent: o }), new G(this.ctx).drawXaxisTicks(i, this.elg));
          },
        },
        {
          key: '_drawGridLine',
            ...
            if (0 !== a.responsive.length) {
              ...
              var r = new D({}),
                n = function () {
                  ...
                  } else for (var l = 0; l < s.length; l++) n < s[l].breakpoint && ((t = m.extendArrayProps(r, s[l].options, i)), (t = g.extend(i.config, t)), e.overrideResponsiveOptions(t));
                };
              if (t) {
              ...
              e.config.yaxis.map(function (r, n) {
                ...
                if (!s.isYAxisHidden(n) && r.labels.show && o.result.length) {
                  ...
                  if (((void 0 !== c && 0 !== c.length) || (c = h), e.globals.isBarHorizontal)) {
                    ...
                    (c = l((c = g.getLargestStringFromArr(u)), { seriesIndex: n, dataPointIndex: -1, w: e })), (d = t.dCtx.dimHelpers.getLargestStringFromMultiArr(c, u));
                  }
                  var f = new p(t.dCtx.ctx),
                    x = f.getTextRects(c, r.labels.style.fontSize),
                    b = x;
                  c !== d && (b = f.getTextRects(d, r.labels.style.fontSize)), i.push({ width: (b.width > x.width ? b.width : x.width) + a, height: b.height > x.height ? b.height : x.height });
        ...
        },
        {
          ...
          value: function () {
            ...
            for (var r = t.globals.legendFormatter, n = t.config.legend.inverseOrder, o = n ? i.length - 1 : 0; n ? o >= 0 : o <= i.length - 1; n ? o-- : o++) {
              ...
              L || (L = t.config.chart.foreColor), (C.style.color = L), (C.style.fontSize = parseFloat(t.config.legend.fontSize) + 'px'), (C.style.fontWeight = t.config.legend.fontWeight), (C.style.fontFamily = e || t.config.chart.fontFamily), p.setAttrs(C, { rel: o + 1, i: o, 'data:default-text': encodeURIComponent(l), 'data:collapsed': h || c }), S.appendChild(u), S.appendChild(C);
          ...
          value: function (t) {
            ...
            if (
              ...
              if (a.globals.zoomEnabled) {
                ...
                if (
                  ((a.globals.zoomed = !0),
                  a.globals.zoomed || ((a.globals.lastXAxis = g.clone(a.config.xaxis)), (a.globals.lastYAxis = g.clone(a.config.yaxis))),
      ...
      a(t, [
        {
          ...
          value: function (t) {
            ...
            return (
              ...
              r.globals.isXNumeric && ((p = (x = this.closestInMultiArray(c, d, b, f)).index), (u = x.j), null !== p && ((b = r.globals.seriesXvalues[p]), (u = (x = this.closestInArray(c, b)).index))),
      ...
      a(i, [
                ...
                c = function (s, r) {
                  ...
                  for (var A = 0; A < a.globals.dataPoints; A++) {
                    var S = i.barHelpers.getStrokeWidth(s, A, b),
                      ...
                      L = null;
                    i.isHorizontal ? ((L = i.drawStackedBarPaths(n({}, C, { zeroW: f, barHeight: y, yDivision: d }))), (w = i.series[s][A] / i.invertedYRatio)) : ((L = i.drawStackedColumnPaths(n({}, C, { xDivision: c, barWidth: w, zeroH: u }))), (y = i.series[s][A] / i.yRatio[i.yaxisIndex])), (h = L.y), (l = L.x), p.push(l), x.push(h);
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return this.barHelpers.barBackground({ bc: f, i: g, y1: d, y2: a, elSeries: h }), (o += l), { pathTo: m.pathTo, pathFrom: m.pathFrom, x: n, y: o };
          },
        },
        {
          ...
          value: function (t) {
            ...
            return this.barHelpers.barBackground({ bc: d, i: h, x1: f, x2: r, elSeries: o }), (i += s), { pathTo: k.pathTo, pathFrom: k.pathFrom, x: l.globals.isXNumeric ? i - s : i, y: a };
          },
        },
      ]),
      i
      ...
      a(i, [
        {
          ...
          value: function (t, e) {
            ...
            for (var n = a.group({ class: 'apexcharts-candlestick-series apexcharts-plot-series' }), o = 0; o < t.length; o++) {
              ...
              for (var k = a.group({ class: 'apexcharts-datalabels', 'data:realIndex': x }), A = 0; A < i.globals.dataPoints; A++) {
                var S,
        ...
        },
        {
          ...
          value: function (t) {
            ...
            var A = l.move(k, r),
              S = l.move(k, y);
            return o.globals.previousPaths.length > 0 && (S = this.getPreviousPath(x, c, !0)), (A = l.move(k, w) + l.line(k + s / 2, w) + l.line(k + s / 2, m) + l.line(k + s / 2, w) + l.line(k + s, w) + l.line(k + s, y) + l.line(k + s / 2, y) + l.line(k + s / 2, v) + l.line(k + s / 2, y) + l.line(k, y) + l.line(k, w - n / 2)), (S += l.move(k, y)), o.globals.isXNumeric || (i += a), { pathTo: A, pathFrom: S, x: i, y: w, barXPosition: k, color: d ? g : u };
          },
        },
        {
          key: 'getOHLCValue',
          ...
          value: function (t) {
            ...
            for (var h = o ? 0 : l.length - 1; o ? h < l.length : h >= 0; o ? h++ : h--) {
              ...
              for (var f = 0, x = 0; x < l[h].length; x++) {
                ...
                var y = v.color,
                  w = new g();
                if ((e.config.plotOptions.heatmap.enableShades && (b < 0 && (b = 0), (y = g.hexToRgba(w.shadeColor(b, v.color), e.config.fill.opacity))), 'image' === e.config.fill.type))
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (h.enabled) {
              ...
              d.plotDataLabelsText({ x: b, y: m, text: v, i: a, j: s, color: r.foreColor, parent: u, dataLabelsConfig: h });
            }
            return u;
          },
        },
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            for (var d = 0; d < t.length; d++) {
              ...
              this.addListeners(v, this.donutDataLabels), p.setAttrs(v.node, { 'data:angle': x, 'data:startAngle': o, 'data:strokeWidth': this.strokeWidth, 'data:value': e[d] });
              var w = { x: 0, y: 0 };
              ...
              var k = 0;
              if (
                (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (0 === (k = ((h - o) / this.fullAngle) * i.config.chart.animations.speed) && (k = 1), (this.animDur = k + this.animDur), this.animBeginArr.push(this.animDur)),
          ...
          value: function (t) {
            ...
            if (
              ...
              t.forEach(function (t, o) {
                ...
                (p = e.graphics.group({ class: 'apexcharts-series-markers-wrap apexcharts-element-hidden' })), (x = e.graphics.group({ class: 'apexcharts-datalabels', 'data:realIndex': o })), i.globals.delayedElements.push({ el: p.node, index: o });
                var d = {
                    i: o,
                    realIndex: o,
                    animationDelay: o,
          ...
          value: function (t) {
            ...
            for (var m = b ? t.series.length - 1 : 0; b ? m >= 0 : m < t.series.length; b ? m-- : m++) {
              ...
              var y = a.fillPath({ seriesNumber: m, size: t.size, value: t.series[m] }),
                ...
                C = void 0;
              e.globals.dataChanged && ((k = this.startAngle), (C = Math.round((this.totalAngle * g.negToZero(e.globals.previousPaths[m])) / 100) + k)), Math.abs(S) + Math.abs(w) >= 360 && (S -= 0.01), Math.abs(C) + Math.abs(k) >= 360 && (C -= 0.01);
              var P = S - w,
              ...
              if ((p.setAttrs(z.node, { 'data:angle': P, 'data:value': t.series[m] }), e.config.chart.dropShadow.enabled)) {
          ...
          value: function (t, e, i) {
            ...
            for (var l = [], h = 0; h < t.length; h++) {
              ...
              var f,
                ...
                b = x,
                v = this.zeroY;
              (v = this.lineHelpers.determineFirstPrevY({ i: h, series: t, prevY: v, lineYPosition: 0 }).prevY), d.push(v), (f = v);
      ...
      a(t, [
        {
          ...
          value: function (t, e) {
            ...
            var m = this.timeScaleArray.map(function (t) {
              ...
              return 'month' === t.unit ? n({}, e, { day: 1, value: t.value + 1 }) : 'day' === t.unit || 'hour' === t.unit ? n({}, e, { value: t.value }) : 'minute' === t.unit ? n({}, e, { value: t.value, minute: t.value }) : t;
            });
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (e.minDate > 1 || e.minMonth > 0) {
              ...
              (o = (l.determineDaysOfYear(e.minYear) - h + 1) * s), (n = e.minYear + 1), this.timeScaleArray.push({ position: o, value: n, unit: 'year', year: n, month: g.monthMod(i + 1) });
            } else 1 === e.minDate && 0 === e.minMonth && this.timeScaleArray.push({ position: o, value: n, unit: 'year', year: a, month: g.monthMod(i + 1) });
            for (var c = n, d = o, u = 0; u < r; u++) c++, (d = l.determineDaysOfYear(c - 1) * s + d), this.timeScaleArray.push({ position: d, value: c, unit: 'year', year: c, month: 1 });
          },
        },
        {
          ...
          value: function (t) {
            ...
            if (e.minDate > 1) {
              ...
              var u = s + d,
                f = g.monthMod(o),
                p = o;
              0 === o && ((c = 'year'), (p = u), (f = 1), (u += d += 1)), this.timeScaleArray.push({ position: l, value: p, unit: c, year: u, month: f });
        ...
        },
        {
          ...
          value: function (t) {
            var e = t.firstVal,
              ...
              u = l,
              f = c(h, i, a);
            0 === e.minHour && 1 === e.minDate && ((d = 0), (u = g.monthMod(e.minMonth)), (o = 'month'), (h = e.minDate), r++), this.timeScaleArray.push({ position: d, value: u, unit: o, year: this._getYear(a, f, 0), month: g.monthMod(f), day: h });
        ...
        },
        {
          ...
          value: function (t) {
            ...
            var x = i,
              b = c(x, a);
            this.timeScaleArray.push({ position: u, value: f, unit: l, day: x, hour: p, year: s, month: g.monthMod(b) });
            for (var m = u, v = 0; v < n; v++) {
              if (((l = 'hour'), p >= 24)) (p = 0), (l = 'day'), (b = h((x += 1), b).month), (b = c(x, b));
              var y = this._getYear(s, b, 0);
              m = 0 === p && 0 === v ? d * r : 60 * r + m;
              var w = 0 === p ? x : p;
              this.timeScaleArray.push({ position: m, value: w, unit: l, hour: p, day: x, year: y, month: g.monthMod(b) }), p++;
            }
          },
        },
        {
          ...
          value: function (t) {
            var e = t.firstVal,
              ...
              p = n,
              x = a;
            this.timeScaleArray.push({ position: h, value: c, unit: 'minute', day: u, hour: x, minute: d, year: p, month: g.monthMod(f) });
      ...
      a(t, [
        ...
        },
        {
          ...
          value: function () {
            ...
            e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute('height', l), (e.dom.elWrap.style.height = l + 'px'), p.setAttrs(e.dom.Paper.node, { height: l }), (e.dom.Paper.node.parentNode.parentNode.style.minHeight = l + 'px');
          },
        },
        {
