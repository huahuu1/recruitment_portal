...
!(function (a) {
  ...
  a.fn.TouchSpin = function (b) {
    if ('destroy' === b)
      return void this.each(function () {
        var b = a(this),
          d = b.data();
        a(document).off(
          c(['mouseup', 'touchend', 'touchcancel', 'mousemove', 'touchmove', 'scroll', 'scrollstart'], d.spinnerid).join(' ')
        );
      });
    var e = {
        min: 0,
    ...
    return this.each(function () {
      ...
      function l(b) {
        (B = a.extend({}, B, b)),
          b.postfix && J.parent().find('.bootstrap-touchspin-postfix').text(b.postfix),
          b.prefix && J.parent().find('.bootstrap-touchspin-prefix').text(b.prefix);
      }
      function m() {
        var a = J.val(),
          b = J.parent();
      ...
      function n(b) {
        ...
        e.hasClass('input-group-btn')
          ? ((c = '<button class="' + B.buttondown_class + ' bootstrap-touchspin-down" type="button">' + B.buttondown_txt + '</button>'),
            e.append(c))
          : ((c =
          ...
          f.hasClass('input-group-btn')
            ? ((d = '<button class="' + B.buttonup_class + ' bootstrap-touchspin-up" type="button">' + B.buttonup_txt + '</button>'),
              f.prepend(d))
            : ((d =
                '<span class="input-group-btn"><button class="' +
                B.buttonup_class +
      ...
      function u() {
        ...
        return (
          (a = J.val()),
          '' === a
            ? void ('' !== B.replacementval && (J.val(B.replacementval), J.trigger('change')))
            : void (
                (B.decimals > 0 && '.' === a) ||
                ((b = parseFloat(a)),
                isNaN(b) && (b = '' !== B.replacementval ? B.replacementval : 0),
                (c = b),
                b.toString() !== a && (c = b),
                b < B.min && (c = B.min),
                b > B.max && (c = B.max),
                (c = t(c)),
                Number(a).toString() !== c.toString() && (J.val(c), J.trigger('change')))
              )
        );
      }
      function v() {
