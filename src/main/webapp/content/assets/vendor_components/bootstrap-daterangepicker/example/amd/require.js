...
(function (ga) {
  ...
  function Y(b, c, d, g) {
    c &&
      D(c, function (c, e) {
        if (d || !x(b, e))
          !g || 'object' !== typeof c || !c || L(c) || K(c) || c instanceof RegExp ? (b[e] = c) : (b[e] || (b[e] = {}), Y(b[e], c, d, g));
      });
    return b;
  }
  function z(b, c) {
  ...
  function ma(b) {
      ...
      if (a) {
        ...
        for (f = 0; f < k.length; f++)
          (c = k[f]),
            '.' === c
              ? (k.splice(f, 1), --f)
              : '..' === c && 0 !== f && (1 !== f || '..' !== k[2]) && '..' !== k[f - 1] && 0 < f && (k.splice(f - 1, 2), (f -= 2));
        a = a.join('/');
      }
      if (b && q && (n || m)) {
        k = a.split('/');
    ...
    function m(a) {
      var n = e(p.paths, a);
      if (n && L(n) && 1 < n.length) return n.shift(), l.require.undef(a), l.makeRequire(null, { skipMap: !0 })([a]), !0;
    }
    function r(a) {
      var n,
        b = a ? a.indexOf('!') : -1;
        ...
        (d
          ? (m =
              f && f.normalize
                ...
                ? c(a, g, h)
                : a)
          : ((m = c(a, g, h)), (a = r(m)), (d = a[0]), (m = a[1]), (b = !0), (k = l.nameToUrl(m))));
      ...
      makeRequire: function (a, n) {
        function m(c, d, f) {
          ...
          if ('string' === typeof c) {
            ...
            return x(v, e)
              ? v[e]
              : A(F('notloaded', 'Module name "' + e + '" has not been loaded yet for context: ' + b + (a ? '' : '. Use require([])')));
          }
          P();
          l.nextTick(function () {
            P();
        ...
        Y(m, {
          ...
          toUrl: function (b) {
            var d,
              f = b.lastIndexOf('.'),
              g = b.split('/')[0];
            -1 !== f && (('.' !== g && '..' !== g) || 1 < f) && ((d = b.substring(f, b.length)), (b = b.substring(0, f)));
  ...
  if ('undefined' === typeof define) {
    ...
    E &&
      ((C = B.head = document.getElementsByTagName('head')[0]), (H = document.getElementsByTagName('base')[0])) &&
    ...
    g.load = function (b, c, d) {
      ...
      if (E) {
        ...
        !e.attachEvent || (e.attachEvent.toString && 0 > e.attachEvent.toString().indexOf('[native code')) || ca
      ...
      X(document.getElementsByTagName('script'), function (b) {
        ...
        if ((O = b.getAttribute('data-main')))
          return (
            ...
            w.baseUrl ||
              -1 !== u.indexOf('!') ||
              ((I = u.split('/')), (u = I.pop()), (T = I.length ? I.join('/') + '/' : './'), (w.baseUrl = T)),
            (u = u.replace(U, '')),
