          ...
          if (b.is('select')) {
            ...
            if (f) {
              ...
              (i.template = a.extend(
                {},
                l.DEFAULTS.template,
                a.fn.selectpicker.defaults ? a.fn.selectpicker.defaults.template : {},
                b.data().template,
                g.template
              )),
    ...
    (l.VERSION = '1.12.4'),
      (l.DEFAULTS = {
        ...
        maxOptionsText: function (a, b) {
          return [
            1 == a ? 'Limit reached ({n} item max)' : 'Limit reached ({n} items max)',
            1 == b ? 'Group limit reached ({n} item max)' : 'Group limit reached ({n} items max)',
          ];
        },
      ...
      (l.prototype = {
            ...
            m.each(function (b) {
              ...
              if ((g++, !f.hasClass('bs-title-option'))) {
                var k,
                  ...
                  r =
                    'undefined' != typeof f.data('icon') ? '<span class="' + c.options.iconBase + ' ' + f.data('icon') + '"></span> ' : '',
                  s = f.parent(),
            ...
            var b,
              ...
              y = function () {
                ...
                j.options.container && !d.is('body')
                  ? ((b = d.offset()), (b.top += parseInt(d.css('borderTopWidth'))), (b.left += parseInt(d.css('borderLeftWidth'))))
                  : (b = { top: 0, left: 0 });
        ...
        selectPosition: function () {
          ...
          this.$button.on('click', function () {
            var b = a(this);
            e.isDisabled() ||
              (g(e.$newElement), e.$bsContainer.appendTo(e.options.container).toggleClass('open', !b.hasClass('open')).append(e.$menu));
          }),
        ...
        setSelected: function (a, b, c) {
          c || (this.togglePlaceholder(), (c = this.findLis().eq(this.liObj[a]))),
            c.toggleClass('selected', b).find('a').attr('aria-selected', b);
        },
        setDisabled: function (a, b, c) {
          c || (c = this.findLis().eq(this.liObj[a])),
            b
              ? c.addClass('disabled').children('a').attr('href', '#').attr('tabindex', -1).attr('aria-disabled', !0)
              : c.removeClass('disabled').children('a').removeAttr('href').attr('tabindex', 0).attr('aria-disabled', !1);
        },
        isDisabled: function () {
        ...
        checkDisabled: function () {
          ...
          this.isDisabled()
            ...
            : (this.$button.hasClass('disabled') &&
                (this.$newElement.removeClass('disabled'), this.$button.removeClass('disabled').attr('aria-disabled', !1)),
          ...
          c.data('spaceSelect', !1),
            ...
            this.$menuInner.on('click', 'li a', function (c) {
              var d = a(this),
                ...
                i = !0;
              if (
                (b.multiple && 1 !== b.options.maxOptions && c.stopPropagation(),
                c.preventDefault(),
                ...
                !b.multiple || (b.multiple && 1 === b.options.maxOptions)
                  ...
                  i &&
                    ((g != b.$element.val() && b.multiple) || (h != b.$element.prop('selectedIndex') && !b.multiple)) &&
                    ((e = [f, k.prop('selected'), l]), b.$element.triggerNative('change'));
              }
            }),
              ...
              if (
                ...
                if (
                  ((e = c.options.liveSearchNormalize
                    ? f.not(':a' + c._searchStyle() + '("' + b(c.$searchbox.val()) + '")')
                    : f.not(':' + c._searchStyle() + '("' + c.$searchbox.val() + '")')),
                  e.length === f.length)
                )
        ...
        keydown: function (b) {
          ...
          if (
            ...
            return (
              i.options.container ? i.$button.trigger('click') : (i.setSize(), i.$menu.parent().addClass('open'), (f = !0)),
          ...
          if (
            (i.options.liveSearch &&
              ...
              f &&
              (b.preventDefault(), b.stopPropagation(), i.$menuInner.click(), i.$button.focus()),
            ...
            (d = i.options.liveSearch ? c.index(c.filter('.active')) : c.index(c.find('a').filter(':focus').parent())),
              ...
              38 == b.keyCode
                ? ((!i.options.liveSearch && d != e) || d == -1 || d--, d < 0 && (d += c.length))
                : 40 == b.keyCode && ((i.options.liveSearch || d == e) && d++, (d %= c.length)),
              i.$menuInner.data('prevIndex', d),
              i.options.liveSearch
                ? (b.preventDefault(),
                  g.hasClass('dropdown-toggle') || (c.removeClass('active').eq(d).addClass('active').children('a').focus(), g.focus()))
            ...
            (c = i.$lis.filter(j)),
              ...
              m != k[b.keyCode]
                ...
                : l >= n.length && (a(document).data('keycount', 0), l > n.length && (l = 1)),
              c
                .eq(n[l - 1])
                .children('a')
                .focus();
          ...
          ((/(^9$|27)/.test(b.keyCode.toString(10)) && f && (i.multiple || i.options.liveSearch)) ||
