...
(function (root, factory) {
  ...
  (function ($) {
    ...
    Selectpicker.prototype = {
      ...
      createDropdown: function () {
        ...
        var drop =
          ...
          ' dropdown-toggle btn-rounded" data-toggle="dropdown"' +
          autofocus +
          ' role="button">' +
          ...
          var optionClass = this.className || '',
            ...
            icon =
              typeof $this.data('icon') !== 'undefined'
                ? '<span class="' + that.options.iconBase + ' ' + $this.data('icon') + '"></span> '
                : '',
            $parent = $this.parent(),
          ...
          if (isOptgroup && $this.data('divider') !== true) {
            ...
            if ($this.index() === 0) {
              ...
              var label = $parent[0].label,
                labelSubtext =
                  typeof $parent.data('subtext') !== 'undefined' ? '<small class="text-muted">' + $parent.data('subtext') + '</small>' : '',
              ...
              var $this = $(this),
                icon =
                  $this.data('icon') && that.options.showIcon
                    ? '<i class="' + that.options.iconBase + ' ' + $this.data('icon') + '"></i> '
                    : '',
                subtext;
      ...
      liHeight: function (refresh) {
        ...
        var liHeight = a.offsetHeight,
          ...
          menuPadding = {
            ...
            horiz:
              parseInt(menuStyle ? menuStyle.paddingLeft : $menu.css('paddingLeft')) +
          ...
          menuExtras = {
            ...
            horiz:
              ...
              parseInt(menuStyle ? menuStyle.marginRight : $menu.css('marginRight')) +
              2,
          };
        ...
        if (this.options.size === 'auto') {
          var getSize = function () {
            ...
            if (that.options.dropdownAlignRight === 'auto') {
              $menu.toggleClass(
                'dropdown-menu-right',
                selectOffsetLeft > selectOffsetRight && menuWidth - menuExtras.horiz < getWidth - selectWidth
              );
            }
      ...
      keydown: function (e) {
        ...
        if (
          !isActive &&
          ((e.keyCode >= 48 && e.keyCode <= 57) || (e.keyCode >= 96 && e.keyCode <= 105) || (e.keyCode >= 65 && e.keyCode <= 90))
        ) {
          if (!that.options.container) {
            that.setSize();
        ...
        if (
          (/(^9$|27)/.test(e.keyCode.toString(10)) && isActive && (that.multiple || that.options.liveSearch)) ||
    ...
    $(document)
      ...
      .on('focusin.modal', '.bootstrap-select [data-toggle=dropdown], .bootstrap-select [role="listbox"], .bs-searchbox input', function (
        e
      ) {
        e.stopPropagation();
      });
