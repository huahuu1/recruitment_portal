  ...
  !(function (a) {
    a.fn.selectpicker.defaults = {
      ...
      maxOptionsText: function (a, b) {
        return [
          1 == a ? 'Limit je postignut ({n} stvar maximalno)' : 'Limit je postignut ({n} stavke maksimalno)',
          1 == b ? 'Grupni limit je postignut ({n} stvar maksimalno)' : 'Grupni limit je postignut ({n} stavke maksimalno)',
        ];
      },
