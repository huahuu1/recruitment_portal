  ...
  !(function (a) {
    a.fn.selectpicker.defaults = {
      ...
      maxOptionsText: function (a, b) {
        return [
          1 == a ? 'Pasiekta riba ({n} elementas daugiausiai)' : 'Riba pasiekta ({n} elementai(-ų) daugiausiai)',
          1 == b ? 'Grupės riba pasiekta ({n} elementas daugiausiai)' : 'Grupės riba pasiekta ({n} elementai(-ų) daugiausiai)',
        ];
      },
