...
!(function (a, b) {
  'function' == typeof define && define.amd
    ...
    : jQuery && !jQuery.fn.colorpicker && b(jQuery);
})(this, function (a) {
  'use strict';
    ...
    (b.prototype = {
      ...
      setColor: function (a) {
        if ((a = a.toLowerCase().trim())) {
          if (this.isTransparent(a)) return (this.value = { h: 0, s: 0, b: 0, a: 0 }), !0;
          var b = this.parse(a);
      ...
      toAlias: function (a, b, c, d) {
        var e,
          f = 0 === arguments.length ? this.toHex() : this.toHex(a, b, c, d),
          g = 'alias' === this.origFormat ? f : this.toString(this.origFormat, !1);
        for (var h in this.colors) if (((e = this.colors[h].toLowerCase().trim()), e === f || e === g)) return h;
        return !1;
      },
      ...
      parse: function (b) {
        ...
        return (
          g && (b = this.colors[b].toLowerCase().trim()),
          a.each(this.stringParsers, function (a, h) {
            var i = h.re.exec(b);
  ...
  var c = {
    ...
    d = function (b, d) {
      ...
      e.on(
        ...
        e.find('.colorpicker-saturation, .colorpicker-hue, .colorpicker-alpha').on('mousedown.colorpicker touchstart.colorpicker', a.proxy(this.mousedown, this)),
        e.appendTo(this.container ? this.container : a('body')),
        this.input !== !1 && (this.input.on({ 'keyup.colorpicker': a.proxy(this.keyup, this) }), this.input.on({ 'change.colorpicker': a.proxy(this.change, this) }), this.component === !1 && this.element.on({ 'focus.colorpicker': a.proxy(this.show, this) }), this.options.inline === !1 && this.element.on({ 'focusout.colorpicker': a.proxy(this.hide, this) })),
        this.component !== !1 && this.component.on({ 'click.colorpicker': a.proxy(this.show, this) }),
        this.input === !1 && this.component === !1 && this.element.on({ 'click.colorpicker': a.proxy(this.show, this) }),
        this.input !== !1 && this.component !== !1 && 'color' === this.input.attr('type') && this.input.on({ 'click.colorpicker': a.proxy(this.show, this), 'focus.colorpicker': a.proxy(this.show, this) }),
        this.update(),
        a(
          a.proxy(function () {
  ...
  (d.Color = b),
    (d.prototype = {
        ...
        if (0 !== c.length)
          return (
            this.options.horizontal === !1
              ? ((b = this.options.sliders),
                c
                  .eq(1)
                  .css('top', b.hue.maxTop * (1 - this.color.value.h))
                  .end()
                  .eq(2)
                  .css('top', b.alpha.maxTop * (1 - this.color.value.a)))
              : ((b = this.options.slidersHorz),
                c
                  .eq(1)
                  .css('left', b.hue.maxLeft * (1 - this.color.value.h))
                  .end()
                  .eq(2)
                  .css('left', b.alpha.maxLeft * (1 - this.color.value.a))),
            c.eq(0).css({
            ...
            this.picker.find('.colorpicker-color, .colorpicker-color div').css('backgroundColor', this.color.toString(this.format, !0)),
            a
          );
      },
      ...
      keyup: function (a) {
        38 === a.keyCode ? (this.color.value.a < 1 && (this.color.value.a = Math.round(100 * (this.color.value.a + 0.01)) / 100), this.update(!0)) : 40 === a.keyCode ? (this.color.value.a > 0 && (this.color.value.a = Math.round(100 * (this.color.value.a - 0.01)) / 100), this.update(!0)) : ((this.color = this.createColor(this.input.val())), this.color.origFormat && this.options.format === !1 && (this.format = this.color.origFormat), this.getValue(!1) !== !1 && (this.updateData(), this.updateComponent(), this.updatePicker())), this.element.trigger({ type: 'changeColor', color: this.color, value: this.input.val() });
      },
    }),
    (a.colorpicker = d),
