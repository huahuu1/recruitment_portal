...
(function () {})(),
  (function () {
    ...
    (t.uniqueId = function (a) {
      ...
      (t.templateSettings = { evaluate: /<%([\s\S]+?)%>/g, interpolate: /<%=([\s\S]+?)%>/g }),
  ...
  (function (a) {
    ...
    function j(a, b, c, d) {
      (this.message = a), (this.line = b + 1), (this.col = c + 1), (this.pos = d + 1), (this.stack = Error().stack);
    }
    function k(a, b, c, d) {}
    function l(a, b, c) {
    ...
    function m(a) {
      ...
      function e(a, b) {
        ...
        if (a && !c) throw K;
        return c == '\n' ? ((P.newline_before = P.newline_before || !b), ++P.line, (P.col = 0)) : ++P.col, c;
      }
      function f() {
        return !P.peek();
      }
      ...
      function m(a, b, c) {
        P.regex_allowed = (a == 'operator' && !v(M, b)) || (a == 'keyword' && v(y, b)) || (a == 'punc' && v(G, b));
        var d = { type: a, value: b, line: P.tokline, col: P.tokcol, pos: P.tokpos, endpos: P.pos, nlb: P.newline_before };
        return c || ((d.comments_before = P.comments_before), (P.comments_before = [])), (P.newline_before = !1), d;
      }
      function n() {
        while (v(F, b())) e();
      }
      ...
      function q(a) {
        var b = !1,
          ...
          f = a == '.',
          g = o(function (g, h) {
            return g == 'x' || g == 'X' ? (e ? !1 : (e = !0)) : !!e || (g != 'E' && g != 'e') ? (g == '-' ? (c || (h == 0 && !a) ? !0 : !1) : g == '+' ? c : ((c = !1), g == '.' ? (!f && !e ? (f = !0) : !1) : d(g))) : b ? !1 : (b = c = !0);
          });
        a && (g = a + g);
        var h = i(g);
      ...
      function s(a) {
        ...
        for (; a > 0; --a) {
          ...
          isNaN(c) && p('Invalid hex-character pattern in string'), (b = (b << 4) | c);
        }
        return b;
      }
      function t() {
      ...
      function u() {
        ...
        var a = j('\n'),
          b;
        return a == -1 ? ((b = P.text.substr(P.pos)), (P.pos = P.text.length)) : ((b = P.text.substring(P.pos, a)), (P.pos = a)), m('comment1', b, !0);
      }
      function x() {
        return (
          e(),
          N('Unterminated multiline comment', function () {
            ...
            return (P.pos = a + 2), (P.line += b.split('\n').length - 1), (P.newline_before = b.indexOf('\n') >= 0), /^@cc_on/i.test(b) && (R('WARNING: at line ' + P.line), R('*** Found "conditional comment": ' + b), R('*** UglifyJS DISCARDS ALL COMMENTS.  This means your code might no longer work properly in Internet Explorer.')), m('comment2', b, !0);
          })
        );
      }
      function B() {
        ...
        while ((d = b()) != null)
          ...
          else d != 'u' && p('Expecting UnicodeEscapeSequence -- uXXXX'), (d = r()), h(d) || p('Unicode char: ' + d.charCodeAt(0) + ' is not valid in identifier'), (c += d), (a = !1);
        return c;
      }
      function C(a) {
      ...
      function L() {
        var a = B();
        return v(w, a) ? (v(E, a) ? m('operator', a) : v(z, a) ? m('atom', a) : m('keyword', a)) : m('name', a);
      }
      function N(a, b) {
        try {
          return b();
    ...
    function o(a, b, c) {
      ...
      function f() {
        return (jb.prev = jb.token), jb.peeked ? ((jb.token = jb.peeked), (jb.peeked = null)) : (jb.token = jb.input()), jb.token;
      }
      function g() {
        return jb.prev;
      }
      function h(a, b, c, d) {
        ...
        k(a, b != null ? b : e.tokline, c != null ? c : e.tokcol, d != null ? d : e.tokpos);
      }
      function i(a, b) {
        h(b, a.line, a.col);
      }
      function j(a) {
        a == null && (a = jb.token), i(a, 'Unexpected token: ' + a.type + ' (' + a.value + ')');
      }
      function o(a, b) {
        if (d(a, b)) return f();
      ...
      function D(a) {
        var b;
        return t() || (b = d('name') ? jb.token.value : null), b != null ? (f(), u(b, jb.labels) || h('Label ' + b + ' without matching loop or statement')) : jb.in_loop == 0 && h(a + ' not inside a loop or switch'), w(), x(a, b);
      }
      function E() {
        r('(');
        var a = null;
        if (!d('punc', ';')) {
          ...
          if (d('operator', 'in')) return a[0] == 'var' && a[1].length > 1 && h('Only one variable declaration allowed in for..in loop'), G(a);
        }
        return F(a);
      }
      function F(a) {
      ...
      function J() {
        ...
        return d('keyword', 'finally') && (f(), (c = I())), !b && !c && h('Missing catch/finally blocks'), x('try', a, b, c);
      }
      function K(a) {
        var b = [];
        for (;;) {
      ...
      function V() {
        var a = nb(!1),
          b;
        return d('punc', '(') ? (f(), (b = W(')'))) : (b = []), ab(x('new', a, b), !0);
      }
      function W(a, b, c) {
        var e = !0,
          g = [];
      ...
      function Y() {
        ...
        while (!d('punc', '}')) {
          ...
          var e = jb.token.type,
            g = Z();
          e != 'name' || (g != 'get' && g != 'set') || !!d('punc', ':') ? (r(':'), c.push([g, ob(!1)])) : c.push([$(), lb(!1), g]);
        }
        return f(), x('object', c);
      }
      function Z() {
      ...
      function ab(a, b) {
        return d('punc', '.') ? (f(), ab(x('dot', a, $()), b)) : d('punc', '[') ? (f(), ab(x('sub', a, q(ob, p(r, ']'))), b)) : b && d('punc', '(') ? (f(), ab(x('call', a, W(')')), !0)) : a;
      }
      function bb(a) {
        if (d('operator') && v(L, jb.token.value)) return cb('unary-prefix', q(jb.token.value, f), bb(a));
        var b = nb(a);
        while (d('operator') && v(M, jb.token.value) && !jb.token.nlb) (b = cb('unary-postfix', jb.token.value, b)), f();
        return b;
      }
      function cb(a, b, c) {
        return (b == '++' || b == '--') && !gb(c) && h('Invalid use of ' + b + ' operator'), x(a, b, c);
      }
      function db(a, b, c) {
      ...
      jb.token = f();
      var kb = A(function () {
          if (d('operator', '/') || d('operator', '/=')) (jb.peeked = null), (jb.token = jb.input(jb.token.value.substr(1)));
          switch (jb.token.type) {
            case 'num':
            case 'string':
            case 'regexp':
            ...
            case 'keyword':
              switch (q(jb.token.value, f)) {
                ...
                case 'if':
                  return H();
                case 'return':
                  return jb.in_function == 0 && h("'return' outside of function"), x('return', d('punc', ';') ? (f(), null) : t() ? null : q(ob, w));
                case 'switch':
                  return x('switch', y(), mb());
                case 'throw':
                  return jb.token.nlb && h("Illegal newline after 'throw'"), x('throw', q(ob, w));
                case 'try':
                  return J();
                case 'var':
                  return q(R, w);
        ...
        lb = function (a) {
          ...
          return (
            ...
            x(
              ...
              b,
              (function (a, b) {
                while (!d('punc', ')')) a ? (a = !1) : r(','), d('name') || j(), b.push(jb.token.value), f();
                return f(), b;
              })(!0, []),
              (function () {
                ++jb.in_function;
        ...
        mb = p(ib, function () {
          ...
          var a = [],
            b = null;
          while (!d('punc', '}')) d('eof') && j(), d('keyword', 'case') ? (f(), (b = []), a.push([ob(), b]), r(':')) : d('keyword', 'default') ? (f(), r(':'), (b = []), a.push([null, b])) : (b || j(), b.push(kb()));
          return f(), a;
        }),
        nb = A(function (a) {
          ...
          if (v(Q, jb.token.type)) {
            var b = jb.token.type == 'regexp' ? x('regexp', jb.token.value[0], jb.token.value[1]) : x(jb.token.type, jb.token.value);
            return ab(q(b, f), a);
          }
          j();
        }),
    ...
    var w = r(['break', 'case', 'catch', 'const', 'continue', 'debugger', 'default', 'delete', 'do', 'else', 'finally', 'for', 'function', 'if', 'in', 'instanceof', 'new', 'return', 'switch', 'throw', 'try', 'typeof', 'var', 'void', 'while', 'with']),
      x = r(['abstract', 'boolean', 'byte', 'char', 'class', 'double', 'enum', 'export', 'extends', 'final', 'float', 'goto', 'implements', 'import', 'int', 'interface', 'long', 'native', 'package', 'private', 'protected', 'public', 'short', 'static', 'super', 'synchronized', 'throws', 'transient', 'volatile']),
      ...
      C = /^0[0-7]+$/,
      D = /^\d*\.?\d*(?:e[+-]?\d*(?:\d\.?|\.?\d)\d*)?$/i,
      E = r(['in', 'instanceof', 'typeof', 'new', 'void', 'delete', '++', '--', '+', '-', '!', '~', '&', '|', '^', '*', '/', '%', '>>', '<<', '>>>', '<', '>', '<=', '>=', '==', '===', '!=', '!==', '?', '=', '+=', '-=', '/=', '*=', '%=', '>>=', '<<=', '>>>=', '|=', '^=', '&=', '&&', '||']),
      F = r(t('  \n\r\t\f​᠎             　')),
      G = r(t('[{}(,.;:')),
      H = r(t('[]{}(),;:')),
      I = r(t('gmsiy')),
  ...
  (function (a) {
    function b() {
      ...
      var f = {
          ...
          const: a,
          try: function (a, b, d) {
            return [this[0], I(a, c), b != null ? [b[0], I(b[1], c)] : null, d != null ? I(d, c) : null];
          },
          throw: function (a) {
            return [this[0], c(a)];
          },
        ...
        var c = k.with_walkers(
          {
            ...
            const: h('const'),
            try: function (a, b, c) {
              if (b != null) return [this[0], I(a, l), [e(b[0], 'catch'), I(b[1], l)], c != null ? I(c, l) : null];
            },
            name: function (a) {
              a == 'eval' && m.push(j), f(a);
            },
    ...
    function e(a, c) {
      function e(a, b) {
        return !c.toplevel && !m.parent ? a : c.except && A(a, c.except) ? a : m.get_mangled(a, b);
      }
      function f(a) {
        if (c.defines) return !m.has(a) && x(c.defines, a) ? c.defines[a] : null;
      }
      function g(a, b, d) {
        if (!c.no_functions) {
          var f = this[0] == 'defun',
            g;
          a && (f ? (a = e(a)) : d.scope.references(a) ? ((g = {}), !m.uses_eval && !m.uses_with ? (a = g[a] = m.next_mangled()) : (g[a] = a)) : (a = null));
        }
        return (
          (d = h(
            d.scope,
        ...
        k.with_walkers(
          {
            ...
            label: function (a, b) {
              return m.labels.refs[a] ? [this[0], m.labels.get_mangled(a, !0), l(b)] : l(b);
            },
            break: j,
            continue: j,
            var: i,
            ...
            try: function (a, b, c) {
              return [this[0], I(a, l), b != null ? [e(b[0]), I(b[1], l)] : null, c != null ? I(c, l) : null];
            },
            toplevel: function (a) {
              var b = this;
    ...
    function i(a) {
      return (a[0] == 'unary-prefix' && A(a[1], ['!', 'delete'])) || (a[0] == 'binary' && A(a[1], ['in', 'instanceof', '==', '!=', '===', '!==', '<', '<=', '>=', '>'])) || (a[0] == 'binary' && A(a[1], ['&&', '||']) && i(a[2]) && i(a[3])) || (a[0] == 'conditional' && i(a[2]) && i(a[3])) || (a[0] == 'assign' && a[1] === !0 && i(a[3])) || (a[0] == 'seq' && i(a[a.length - 1]));
    }
    function j(a) {
      return !a || (a[0] == 'block' && (!a[1] || a[1].length == 0));
    }
    function k(a) {
      return a[0] == 'string' || (a[0] == 'unary-prefix' && a[1] == 'typeof') || (a[0] == 'binary' && a[1] == '+' && (k(a[2]) || k(a[3])));
    }
    function l(a) {
      ...
      return f.with_walkers(
        {
          ...
          try: function (a, b, d) {
            return [this[0], c(a), b != null ? [b[0], c(b[1])] : null, d != null ? c(d) : null];
          },
        },
        function () {
          return g(a);
    ...
    function o(a) {
      function c(a, b) {
        ...
        var d = {},
          e = I(b.names, function (a, c) {
            return a != 'var' ? I.skip : b.references(c) ? ((d[c] = !0), [c]) : I.skip;
          });
        return (
          e.length > 0 &&
            (n(['block', a], function (a, b, c, f) {
              if (a[0] == 'assign' && a[1] === !0 && a[2][0] == 'name' && x(d, a[2][1])) {
      ...
      function e(a) {
        ...
        for (var c = a.length; --c >= 0; ) {
          var d = a[c];
          if (!d[1]) continue;
          (d = ['assign', !0, ['name', d[0]], d[1]]), b == null ? (b = d) : (b = ['seq', d, b]);
        }
        return b == null ? (g.parent()[0] == 'for-in' ? ['name', a[0][0]] : I.skip) : ['stat', b];
      }
      function f(a) {
      ...
      return g.with_walkers(
        {
          function: function (a, b, d) {
            for (var e = b.length; --e >= 0 && !d.scope.references(b[e]); ) b.pop();
            return d.scope.references(a) || (a = null), [this[0], a, b, c(d, d.scope)];
          },
          defun: function (a, b, d) {
    ...
    function p(a, c) {
      ...
      function e(a, b, c) {
        var e = function () {
          return a[0] == 'unary-prefix' && a[1] == '!' ? (c ? ['conditional', a[2], c, b] : ['binary', '||', a[2], b]) : c ? f(['conditional', a, b, c], ['conditional', d(a), c, b]) : ['binary', '&&', a, b];
        };
        return F(
          a,
          function (a, d) {
                ...
                _(a).forEach(function (a) {
                  d
                    ? a[0] == 'function' || a[0] == 'defun'
                      ? b.push(a)
                      : a[0] == 'var' || a[0] == 'const'
                      ? (c.no_warnings || E('Variables declared in unreachable code'),
                        (a[1] = I(a[1], function (a) {
                          return a[1] && !c.no_warnings && l(['assign', !0, ['name', a[0]], a[1]]), [a[0]];
                        })),
                        b.push(a))
                      : c.no_warnings || l(a)
                    : (b.push(a), A(a[0], ['return', 'throw', 'break', 'continue']) && (d = !0));
                }),
                b
              );
            })([])),
          c.make_seqs &&
            (a = (function (b, c) {
              return (
                ...
                b.length >= 2 && b[b.length - 2][0] == 'stat' && (b[b.length - 1][0] == 'return' || b[b.length - 1][0] == 'throw') && b[b.length - 1][1] && b.splice(b.length - 2, 2, [b[b.length - 1][0], ['seq', b[b.length - 2][1], b[b.length - 1][1]]]),
                b
              );
            })([])),
          a
      ...
      function o(a, b, c) {
        return F(
          a,
          function (a, d) {
            return d ? ((b = u(b)), l(c), b || ['block']) : ((c = u(c)), l(b), c || ['block']);
          },
          function () {
            return q(a, b, c);
          }
      ...
      function p(a, b, c) {
        var e = [['if', d(a), c]];
        return b[0] == 'block' ? b[1] && (e = e.concat(b[1])) : e.push(b), u(['block', e]);
      }
      function q(a, b, c) {
        (a = u(a)),
          (b = u(b)),
        ...
        var g = ['if', a, b, c];
        return b[0] == 'if' && j(b[3]) && j(c) ? (g = f(g, u(['if', ['binary', '&&', a, b[1]], b[2]]))) : b[0] == 'stat' ? (c ? (c[0] == 'stat' ? (g = f(g, ['stat', e(a, b[1], c[1])])) : h(c) && (g = p(a, b, c))) : (g = f(g, ['stat', e(a, b[1])]))) : c && b[0] == c[0] && (b[0] == 'return' || b[0] == 'throw') && b[1] && c[1] ? (g = f(g, [b[0], e(a, b[1], c[1])])) : c && h(b) ? ((g = [['if', a, b]]), c[0] == 'block' ? c[1] && (g = g.concat(c[1])) : g.push(c), (g = u(['block', g]))) : b && h(c) && (g = p(a, b, c)), g;
      }
      function r(a, b) {
      ...
      c = v(c, { make_seqs: !0, dead_code: !0, no_warnings: !1, keep_comps: !0 });
      var t = b(),
        u = t.walk;
      return t.with_walkers(
        {
          sub: function (a, b) {
            if (b[0] == 'string') {
              ...
              if (/^[1-9][0-9]*$/.test(c) || c === '0') return ['sub', u(a), ['num', parseInt(c, 10)]];
            }
          },
          if: o,
          toplevel: function (a) {
              ...
              function () {
                return (
                  (function () {
                    ...
                    var d = u(b),
                      e = u(c);
                    return d && d[0] == 'unary-prefix' && d[1] == '!' && d[2][0] == 'num' ? (b = ['num', +!d[2][1]]) : e && e[0] == 'unary-prefix' && e[1] == '!' && e[2][0] == 'num' && (c = ['num', +!e[2][1]]), ['binary', a, b, c];
                  })() || this
                );
              }
            );
          ...
          try: function (a, b, c) {
            return ['try', n(a), b != null ? [b[0], n(b[1])] : null, c != null ? n(c) : null];
          },
          'unary-prefix': function (a, b) {
            b = u(b);
          ...
          assign: function (a, b, c) {
            (b = u(b)), (c = u(c));
            var d = ['+', '-', '/', '*', '%', '>>', '<<', '>>>', '|', '^', '&'];
            return a === !0 && b[0] === 'name' && c[0] === 'binary' && ~d.indexOf(c[1]) && c[2][0] === 'name' && c[2][1] === b[1] ? [this[0], c[1], b, c[3]] : [this[0], a, b, c];
          },
        },
        function () {
    ...
    function q(a, b) {
      ...
      return (
        ...
        b && (a = r(a)),
        c > d ? "'" + a.replace(/\x27/g, "\\'") + "'" : '"' + a.replace(/\x22/g, '\\"') + '"'
      );
    }
    function r(a) {
    ...
    function s(a, c) {
      function d(a) {
        ...
        return c.inline_script && (b = b.replace(/<\x2fscript([>\/\t\n\f\r ])/gi, '<\\/script$1')), b;
      }
      function e(a) {
        return (a += ''), c.ascii_only && (a = r(a)), a;
      }
      function f(a) {
        return a == null && (a = ''), J && (a = u(' ', c.indent_start + K * c.indent_level) + a), a;
      }
      function g(a, b) {
        b == null && (b = 1), (K += b);
        try {
      ...
      function h(a) {
        ...
        for (var c = 0; c < a.length; ++c) {
          var d = a[c + 1];
          b.push(a[c]), d && ((/[a-z0-9_\x24]$/i.test(a[c] + '') && /^[a-z0-9_\x24]/i.test(d + '')) || (/[\+\-]$/.test(a[c] + '') && /^[\+\-]/.test(d + ''))) && b.push(' ');
        }
        return b.join('');
      }
      function i(a) {
      ...
      function m(a) {
        if (a[0] == 'function' || a[0] == 'object') {
          ...
          while (d) {
            ...
            if (((d[0] != 'seq' && d[0] != 'call' && d[0] != 'dot' && d[0] != 'sub' && d[0] != 'conditional') || d[1] !== c) && ((d[0] != 'binary' && d[0] != 'assign' && d[0] != 'unary-postfix') || d[2] !== c)) return !1;
            (c = d), (d = b.pop());
          }
        }
        return !x(G, a[0]);
      ...
      function p(a, b, c, d, f) {
        var g = d || 'function';
        return a && (g += ' ' + e(a)), (g += '(' + i(I(b, e)) + ')'), (g = h([g, E(c)])), !f && m(this) ? '(' + g + ')' : g;
      }
      function s(a) {
        switch (a[0]) {
          case 'with':
      ...
      function t(a, b) {
        for (var c = [], d = a.length - 1, e = 0; e <= d; ++e) {
          var g = a[e],
            h = S(g);
          h != ';' && (!J && e == d && !s(g) && (h = h.replace(/;+\s*$/, '')), c.push(h));
        }
        return b ? c : I(c, f);
      }
      function D(a) {
      ...
      c = v(c, { indent_start: 0, indent_level: 4, quote_keys: !1, space_colon: !1, beautify: !1, ascii_only: !1, inline_script: !1 });
      var J = !!c.beautify,
        K = 0,
        L = J ? '\n' : '',
        Q = J ? ' ' : '',
      ...
      return R.with_walkers(
        {
          ...
          try: function (a, b, c) {
            var d = ['try', E(a)];
            return b && d.push('catch', '(' + b[0] + ')', E(b[1])), c && d.push('finally', E(c)), h(d);
          },
          throw: function (a) {
            return h(['throw', S(a)]) + ';';
          },
          ...
          conditional: function (a, b, c) {
            return h([k(a, 'assign', 'seq', 'conditional'), '?', k(b, 'seq'), ':', k(c, 'seq')]);
          },
          assign: function (a, b, c) {
            return a && a !== !0 ? (a += '=') : (a = '='), h([S(b), a, k(c, 'seq')]);
          },
          dot: function (a) {
            var b = S(a),
              c = 1;
            a[0] == 'num' ? /\./.test(a[1]) || (b += '.') : m(a) && (b = '(' + b + ')');
          ...
          for: function (a, b, c, d) {
            var e = ['for'];
            (a = (a != null ? S(a) : '').replace(/;*\s*$/, ';' + Q)), (b = (b != null ? S(b) : '').replace(/;*\s*$/, ';' + Q)), (c = (c != null ? S(c) : '').replace(/;*\s*$/, ''));
            var f = a + b + c;
            return f == '; ; ' && (f = ';;'), e.push('(' + f + ')', S(d)), h(e);
          },
          'for-in': function (a, b, c, d) {
            return h(['for', '(' + (a ? S(a).replace(/;+$/, '') : S(b)), 'in', S(c) + ')', S(d)]);
          },
          while: function (a, b) {
          ...
          binary: function (a, b, d) {
            var e = S(b),
              f = S(d);
            if (A(b[0], ['assign', 'conditional', 'seq']) || (b[0] == 'binary' && B[a] > B[b[1]]) || (b[0] == 'function' && m(this))) e = '(' + e + ')';
            return A(d[0], ['assign', 'conditional', 'seq']) || (d[0] == 'binary' && B[a] >= B[d[1]] && (d[1] != a || !A(a, ['&&', '||', '*']))) ? (f = '(' + f + ')') : !J && c.inline_script && (a == '<' || a == '<<') && d[0] == 'regexp' && /^script/i.test(d[1]) && (f = ' ' + f), h([e, a, f]);
          },
          'unary-prefix': function (a, b) {
            var c = S(b);
            return b[0] == 'num' || (b[0] == 'unary-prefix' && !x(C, a + b[1])) || !m(b) || (c = '(' + c + ')'), a + (y.is_alphanumeric_char(a.charAt(0)) ? ' ' : '') + c;
          },
          'unary-postfix': function (a, b) {
            var c = S(b);
            return b[0] == 'num' || (b[0] == 'unary-postfix' && !x(C, a + b[1])) || !m(b) || (c = '(' + c + ')'), c + a;
          },
          sub: function (a, b) {
            var c = S(a);
            ...
            var e =
              ...
              g(function () {
                return I(a, function (a) {
                  if (a.length == 3) return f(p(a[0], a[1][2], a[1][3], a[2], !0));
                  var b = a[0],
                    e = k(a[1], 'seq');
                  return c.quote_keys ? (b = d(b)) : (typeof b == 'number' || (!J && +b + '' == b)) && parseFloat(b) >= 0 ? (b = n(+b)) : w(b) || (b = d(b)), f(h(J && c.space_colon ? [b, ':', e] : [b + ':', e]));
                }).join(',' + L);
              }) +
              L +
              f('}');
          ...
          array: function (a) {
            return a.length == 0
              ...
              : h([
                  ...
                  i(
                    I(a, function (b, c) {
                      return !J && b[0] == 'atom' && b[1] == 'undefined' ? (c === a.length - 1 ? ',' : '') : k(b, 'seq');
                    })
                  ),
                  ']',
                ]);
    ...
    function w(a) {
      return /^[a-z_$][a-z0-9_$]*$/i.test(a) && a != 'this' && !x(y.KEYWORDS_ATOM, a) && !x(y.RESERVED_WORDS, a) && !x(y.KEYWORDS, a);
    }
    function x(a, b) {
      return Object.prototype.hasOwnProperty.call(a, b);
    }
    ...
    c.prototype = {
      ...
      get_mangled: function (a, b) {
        ...
        var c = this.has(a);
        return c ? (x(c.mangled, a) ? c.mangled[a] : b ? c.set_mangle(a, c.next_mangled()) : a) : a;
      },
    ...
    var E = function () {},
      F = (function () {
        ...
        return function (c, d, e) {
          try {
            ...
            if (h === b) {
              if (c[0] != 'binary' || (c[1] != '===' && c[1] != '!==') || !((k(c[2]) && k(c[3])) || (i(c[2]) && i(c[3])))) {
                if (e && c[0] == 'binary' && (c[1] == '||' || c[1] == '&&'))
                  try {
                    var j = a(c[2]);
                    c = (c[1] == '&&' && (j ? c[3] : j)) || (c[1] == '||' && (j ? j : c[3])) || c;
                  } catch (l) {}
      ...
      G = y.array_to_hash(['name', 'array', 'object', 'string', 'dot', 'sub', 'call', 'regexp', 'defun']),
    ...
    (function () {
      ...
      (I = function (d, e, f) {
        function g() {
          ...
          g instanceof a ? ((g = g.v), g instanceof b ? i.push.apply(i, g.v) : i.push(g)) : g != c && (g instanceof b ? h.push.apply(h, g.v) : h.push(g));
        }
        var h = [],
          i = [],
          j;
      ...
      return e.with_walkers(
        {
          ...
          new: function (a, b) {
            if (a[0] == 'name') {
              if (a[1] == 'Array' && !i.has('Array')) return b.length != 1 ? ['array', b] : f(['call', ['name', 'Array'], b]);
              if (a[1] == 'Object' && !i.has('Object')) return b.length ? f(['call', ['name', 'Object'], b]) : ['object', []];
              if ((a[1] == 'RegExp' || a[1] == 'Function' || a[1] == 'Error') && !i.has(a[1])) return f(['call', ['name', a[1]], b]);
            }
          },
          call: function (a, b) {
            if (a[0] == 'dot' && a[2] == 'toString' && b.length == 0) return ['binary', '+', a[1], ['string', '']];
            if (a[0] == 'name') {
              if (a[1] == 'Array' && b.length != 1 && !i.has('Array')) return ['array', b];
              if (a[1] == 'Object' && !b.length && !i.has('Object')) return ['object', []];
              if (a[1] == 'String' && !i.has('String')) return ['binary', '+', b[0], ['string', '']];
            }
          },
        },
        function () {
    ...
    a.uglify = function (b, c) {
      ...
      function f(a) {
        ...
        if (k.show_copyright) {
          ...
          f = e();
          var h = null;
          while (/^comment/.test(f.type) && (!h || h == f.type)) c.push(f), (h = f.type), (f = e());
          b += d(c);
        }
        ...
        return (
          ...
          k.squeeze &&
            (l = g('squeeze', function () {
              return (l = j.ast_squeeze(l, { make_seqs: k.make_seqs, dead_code: k.dead_code, extra: k.extra })), k.unsafe && (l = j.ast_squeeze_more(l)), l;
            })),
          k.ast
      ...
      var k = {
          ...
          extra: !1,
          unsafe: !1,
          beautify_options: { indent_level: 4, indent_start: 0, quote_keys: !1, space_colon: !1 },
          output: !0,
        },
        l = c,
        m;
