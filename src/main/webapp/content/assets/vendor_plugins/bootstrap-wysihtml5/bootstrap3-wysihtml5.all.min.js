...
Object.defineProperty &&
  ...
  (wysihtml5 = { version: '0.4.15', commands: {}, dom: {}, quirks: {}, toolbar: {}, lang: {}, selection: {}, views: {}, INVISIBLE_SPACE: '﻿', EMPTY_FUNCTION: function () {}, ELEMENT_NODE: 1, TEXT_NODE: 3, BACKSPACE_KEY: 8, ENTER_KEY: 13, ESCAPE_KEY: 27, SPACE_KEY: 32, DELETE_KEY: 46 }),
  (function (a, b) {
    ...
    var r,
      ...
      F = d(c),
      G = {},
      H = { version: '1.3alpha.20140804', initialized: !1, supported: !0, util: { isHostMethod: a, isHostObject: b, isHostProperty: c, areHostMethods: D, areHostObjects: E, areHostProperties: F, isTextRange: e, getBody: f }, features: {}, modules: G, config: { alertOnFail: !0, alertOnWarn: !1, preferTextRange: !1, autoInitialize: typeof rangyAutoInitialize == y ? !0 : rangyAutoInitialize } };
    return (
      (H.fail = i),
      (H.warn = j),
      {}.hasOwnProperty
        ? (H.util.extend = function (a, b, c) {
            var d, e, f;
      ...
      (function () {
        ...
        try {
          1 == a.call(c.childNodes, 0)[0].nodeType &&
            (b = function (b) {
              return a.call(b, 0);
            });
        } catch (d) {}
      ...
      typeof window == y
        ? (i('No window found'), void 0)
        : typeof document == y
        ? (i('No document found'), void 0)
        : (a(document, 'addEventListener') && document.addEventListener('DOMContentLoaded', v, !1),
          r(window, 'load', v),
          H.createCoreModule('DomUtil', [], function (a, b) {
            ...
            J.areHostMethods(document, ['createDocumentFragment', 'createElement', 'createTextNode']) || b.fail('document missing a Node creation method'),
              ...
              typeof window.getComputedStyle != I
                ? (H = function (a, b) {
                    return p(a).getComputedStyle(a, null)[b];
                  })
                : typeof document.documentElement.currentStyle != I
                ? (H = function (a, b) {
              ...
              bb.extend(a.rangePrototype, {
                ...
                toString: function () {
                  ...
                  return (
                    y(this),
                    (a = this.startContainer),
                    a === this.endContainer && eb(a)
                      ? 3 == a.nodeType || 4 == a.nodeType
                ...
                getBookmark: function (b) {
                  var d,
                    ...
                    g = c(this),
                    h = a.createRange(g);
                  return (b = b || ab.getBody(g)), h.selectNodeContents(b), (d = this.intersection(h)), (e = 0), (f = 0), d && (h.setEnd(d.startContainer, d.startOffset), (e = ('' + h).length), (f = e + ('' + d).length)), { start: e, end: f, containerNode: b };
                },
              ...
              !(function () {
                ...
                (f.setStartBefore = g('setStartBefore', 'setEndBefore')),
                  ...
                  (f.compareBoundaryPoints =
                    -1 == i.compareBoundaryPoints(i.START_TO_END, j) && 1 == i.compareBoundaryPoints(i.END_TO_START, j)
                      ? function (a, b) {
                  ...
                  r.removeChild(m),
                  (r = null),
                  l.isHostMethod(i, 'createContextualFragment') &&
                    (f.createContextualFragment = function (a) {
              ...
              a.features.implementsTextRange &&
                ...
                (g = function (a, b, c, d, e) {
                  var f,
                    ...
                    x,
                    y = a.duplicate();
                  if ((y.collapse(c), (f = y.parentElement()), k.isOrIsAncestorOf(b, f) || (f = b), !f.canHaveHTML)) return (g = new m(f.parentNode, k.getNodeIndex(f))), { boundaryPosition: g, nodeInfo: { nodeIndex: g.offset, containerElement: g.node } };
          ...
          H.createCoreModule('WrappedSelection', ['DomRange', 'WrappedRange'], function (a, b) {
            ...
            if (
              ...
              (M = A.getBody),
              (N = D.rangesEqual),
              (O = C(window, 'getSelection')),
              (P = B.isHostObject(document, 'selection')),
              (J.implementsWinGetSelection = O),
              (J.implementsDocSelection = P),
              (Q = P && (!O || a.config.preferTextRange)),
              Q
                ? ((H = f),
              ...
              (a.getNativeSelection = H),
              (R = H()),
              (S = a.createNativeRange(document)),
              (T = M(document)),
              (U = B.areHostProperties(R, ['anchorNode', 'focusNode', 'anchorOffset', 'focusOffset'])),
              (J.selectionHasAnchorAndFocus = U),
              (V = C(R, 'extend')),
              (J.selectionHasExtend = V),
              (W = typeof R.rangeCount == z),
              ...
              (Z = V
                ...
                : null),
              B.areHostMethods(R, ['addRange', 'getRangeAt', 'removeAllRanges']) &&
                typeof R.rangeCount == z &&
              ...
              ($ = !1),
              T && C(T, 'createControlRange') && ((_ = T.createControlRange()), B.areHostProperties(_, ['item', 'add']) && ($ = !0)),
              (J.implementsControlRange = $),
              (I = U
                ? function (a) {
              ...
              (cb = function (a) {
                var b, c, e;
                return a && a instanceof r ? (a.refresh(), a) : ((a = d(a, 'getNativeSelection')), (b = t(a)), (c = H(a)), (e = P ? f(a) : null), b ? ((b.nativeSelection = c), (b.docSelection = e), b.refresh()) : ((b = new r(c, e, a)), bb.push({ win: a, selection: b })), b);
              }),
              (a.getSelection = cb),
              ...
              (db = r.prototype),
              !Q && U && B.areHostMethods(R, ['removeAllRanges', 'addRange']))
            )
            ...
            else if (C(R, 'getRangeAt') && typeof R.rangeCount == z)
              fb = function (b) {
            ...
            (db.refresh = function (a) {
              ...
              J.implementsTextRange &&
                (db.getNativeTextRange = function () {
                  var c, d;
  ...
  (function (a, b) {
    ...
    a.createModule('SaveRestore', ['WrappedRange'], function (a, b) {
      ...
      var o = a.dom,
        p = '﻿';
      a.util.extend(a, { saveRange: g, restoreRange: h, saveRanges: i, restoreRanges: k, saveSelection: j, restoreSelection: l, removeMarkerElement: m, removeMarkers: n });
    });
  }, this),
  (Base = function () {}),
      ...
      return {
        ...
        remove: function () {
          var d = a.dom.domNode(b).next({ ignoreBlankTexts: !0 }),
            e = a.dom.domNode(b).prev({ ignoreBlankTexts: !0 });
  ...
  (wysihtml5.dom.parse = function (a, b) {
    ...
    function l(a, b) {
      var c,
        ...
        i = wysihtml5.lang
          .object(h)
          .merge(wysihtml5.lang.object(b || {}).clone())
          .get(),
        l = {},
        m = wysihtml5.dom.getAttributes(a);
      for (c in i)
        if (/\*$/.test(c)) for (e = j(c.slice(0, -1), m), f = 0, g = e.length; g > f; f++) (d = k(e[f], m[e[f]], i[c], a.nodeName)), d !== !1 && (l[e[f]] = d);
    ...
    var p = { 1: f, 3: n, 8: o },
      ...
      x = {
        ...
        align_text: (function () {
          var a = { left: 'wysiwyg-text-align-left', right: 'wysiwyg-text-align-right', center: 'wysiwyg-text-align-center', justify: 'wysiwyg-text-align-justify' };
          return function (b) {
            return a[(b + '').toLowerCase()];
          };
        })(),
        ...
        size_font: (function () {
          var a = { 1: 'wysiwyg-font-size-xx-small', 2: 'wysiwyg-font-size-small', 3: 'wysiwyg-font-size-medium', 4: 'wysiwyg-font-size-large', 5: 'wysiwyg-font-size-x-large', 6: 'wysiwyg-font-size-xx-large', 7: 'wysiwyg-font-size-xx-large', '-': 'wysiwyg-font-size-smaller', '+': 'wysiwyg-font-size-larger' };
          return function (b) {
            return a[(b + '').charAt(0)];
          };
        })(),
    ...
    function e(a, e) {
      if (a.nodeName.match(/^(MENU|UL|OL)$/)) {
        var f,
          ...
          n = wysihtml5.dom.domNode(a).prev({ ignoreBlankTexts: !0 });
        if (e)
    ...
    a.dom.Sandbox = Base.extend({
      ...
      _createIframe: function () {
        ...
        return (
          ...
          a.dom.setAttributes({ security: 'restricted', allowtransparency: 'true', frameborder: 0, width: 0, height: 0, marginwidth: 0, marginheight: 0 }).on(d),
    ...
    (i.prototype = {
      ...
      removeRow: function () {
        var a,
          b,
          c,
          e = g.getParentElement(this.cell, { nodeName: ['TR'] });
        if (e) {
  ...
  (wysihtml5.quirks.cleanPastedHTML = (function () {
    var a = function (a) {
      ...
      b = function (b, c) {
        var d,
          e,
          f = wysihtml5.lang.object(b).clone(!0);
    ...
    return function (a, d) {
      var e,
        ...
        g = b(c(d.rules, a) || {}, f);
      return (e = wysihtml5.dom.parse(a, { rules: g, cleanUp: !0, context: d.referenceNode.ownerDocument, uneditableClass: d.uneditableClass, clearInternals: !0, unjoinNbsps: !0 })), e;
    };
  })()),
  ...
  (wysihtml5.quirks.tableCellsSelection = function (a, b) {
    function c() {
      return (
        k.observe(a, 'mousedown', function (a) {
    ...
    function g(a) {
      var c,
        d = null,
        g = k.getParentElement(a.target, { nodeName: ['TD', 'TH'] });
    ...
    a.Selection = Base.extend({
      ...
      scrollIntoView: function () {
        var c,
          ...
          g = (d._wysihtml5ScrollIntoViewElement =
            d._wysihtml5ScrollIntoViewElement ||
            (function () {
      ...
      (s.prototype = {
        ...
        getMatchingAncestor: function (a) {
          var b = this.getAncestorWithClass(a),
            c = !1;
          return b ? this.cssStyle && (c = 'class') : ((b = this.getAncestorWithStyle(a)), b && (c = 'style')), { element: b, type: c };
        },
        ...
        applyToRange: function (b) {
          var c, d, e, f, g, h;
          for (d = b.length; d--; ) {
            if (((c = b[d].getNodes([a.TEXT_NODE])), !c.length))
              try {
        ...
        isAppliedToRange: function (b) {
          var c,
            ...
            j = 'full';
          for (e = b.length; e--; ) {
            if (((d = b[e].getNodes([a.TEXT_NODE])), !d.length)) return (c = this.getMatchingAncestor(b[e].startContainer).element), c ? { elements: [c], coverage: j } : !1;
  ...
  (function (a) {
    ...
    a.commands.foreColorStyle = {
      exec: function (c, d, e) {
        var f,
          g = a.quirks.styleParser.parseColor('object' == typeof e ? 'color:' + e.color : 'color:' + e, 'color');
  ...
  (function (a) {
    ...
    a.commands.bgColorStyle = {
      exec: function (c, d, e) {
        var f,
          g = a.quirks.styleParser.parseColor('object' == typeof e ? 'background-color:' + e.color : 'background-color:' + e, 'background-color');
    ...
    a.commands.formatBlock = {
      exec: function (f, g, m, n, o, p, q) {
        var r,
          ...
          y = x ? 'DIV' : 'P';
        return (
          (m = 'string' == typeof m ? m.toUpperCase() : m),
          w.length
            ? (f.selection.executeAndRestoreRangy(function () {
                var b, c, f;
                for (b = w.length; b--; ) {
              ...
              void 0)
            : (((null !== m && !a.lang.array(l).contains(m)) ||
                ((r = f.selection.findNodesInSelection(l).concat(f.selection.getSelectedOwnNodes())),
                f.selection.executeAndRestoreRangy(function () {
                ...
                !t)) &&
                h(f, { nodeName: m || y, className: n || null, cssStyle: p || null }),
              void 0)
        );
      },
      state: function (b, c, d, e, f, g, h) {
        var i,
          ...
          n = [];
        for (d = 'string' == typeof d ? d.toUpperCase() : d, j = 0, l = m.length; l > j; j++) (i = k.getParentElement(m[j], { nodeName: d, className: e, classRegExp: f, cssStyle: g, styleRegExp: h })), i && -1 == a.lang.array(n).indexOf(i) && n.push(i);
  ...
  (function (a) {
    ...
    a.commands.formatInline = {
      exec: function (a, b, d, e, f, g, h, i, j) {
        ...
        return l && 0 != l.length
          ? (a.selection.getSelection().removeAllRanges(),
            c(d, e, f, g, h, a.element).toggleRange(l),
            i
              ? j || a.cleanUp()
              : (k.setStart(l[0].startContainer, l[0].startOffset),
                k.setEnd(l[l.length - 1].endContainer, l[l.length - 1].endOffset),
                a.selection.setSelection(k),
                a.selection.executeAndRestore(
                  function () {
                    j || a.cleanUp();
                  },
                  !0,
      ...
      execWithToggle: function (b, c, d, e, f, g, h) {
        var i,
          j = this;
        this.state(b, c, d, e, f, g, h) && b.selection.isCollapsed() && !b.selection.caretIsLastInSelection() && !b.selection.caretIsFirstInSelection()
          ? ((i = j.state(b, c, d, e, f)[0]),
            b.selection.executeAndRestoreRangy(function () {
              i.parentNode;
              b.selection.selectNode(i, !0), a.commands.formatInline.exec(b, c, d, e, f, g, h, !0, !0);
            }))
          : this.state(b, c, d, e, f, g, h) && !b.selection.isCollapsed()
          ? b.selection.executeAndRestoreRangy(function () {
    ...
    a.commands.insertBlockQuote = {
      ...
      state: function (b) {
        var c = b.selection.getSelectedNode(),
          d = a.dom.getParentElement(c, { nodeName: 'BLOCKQUOTE' }, !1, b.element);
        return d ? d : !1;
      },
    };
  })(wysihtml5),
    ...
    a.commands.insertImage = {
      ...
      state: function (c) {
        var d,
          ...
          f,
          g = c.doc;
        return a.dom.hasElementWithTagName(g, b)
          ? ((d = c.selection.getSelectedNode()),
            d
              ? d.nodeName === b
                ? d
                : d.nodeType !== a.ELEMENT_NODE
                ? !1
                : ((e = c.selection.getText()),
                  (e = a.lang.string(e).trim()),
                  e
                    ? !1
                    : ((f = c.selection.getNodes(a.ELEMENT_NODE, function (a) {
    ...
    var b = function (a, b) {
      ...
      c = function (c, d, e) {
        var f,
          g,
          h = { el: null, other: !1 };
        return c && ((f = a.dom.getParentElement(c, { nodeName: 'LI' })), (g = 'UL' === d ? 'OL' : 'UL'), b(c, d) ? (h.el = c) : b(c, g) ? (h = { el: c, other: !0 }) : f && (b(f.parentNode, d) ? (h.el = f.parentNode) : b(f.parentNode, g) && (h = { el: f.parentNode, other: !0 }))), h.el && !e.element.contains(h.el) && (h.el = null), h;
      },
      d = function (b, c, d) {
        var e,
          g = 'UL' === c ? 'OL' : 'UL';
  ...
  (wysihtml5.commands.indentList = {
    ...
    tryToPushLiLevel: function (a, b) {
      var c,
        ...
        h = !1;
      return (
        b.executeAndRestoreRangy(function () {
        ...
        b.selection.executeAndRestoreRangy(function () {
          ...
          for (j = a.length; j--; )
            if (((f = a[j]), f.parentNode && ((c = f.parentNode), 'OL' === c.tagName || 'UL' === c.tagName))) {
              if (((h = !0), (d = wysihtml5.dom.getParentElement(c.parentNode, { nodeName: ['OL', 'UL'] }, !1, b.element)), (e = wysihtml5.dom.getParentElement(c.parentNode, { nodeName: ['LI'] }, !1, b.element)), d && e)) f.nextSibling && ((g = i.getAfterList(c, f)), f.appendChild(g)), d.insertBefore(f, e.nextSibling);
              else {
    ...
    a.views.Composer = a.views.View.extend({
      ...
      _initContentEditableArea: function () {
        ...
        this.config.noTextarea
          ...
          : ((this.sandbox = new b.ContentEditableArea(function () {
              a._create();
            })),
      ...
      _create: function () {
        ...
        (this.doc = this.sandbox.getDocument()),
          ...
          this.config.noTextarea ||
            (!this.textarea.element.hasAttribute('autofocus') && document.querySelector(':focus') != this.textarea.element) ||
            c.isIos() ||
            setTimeout(function () {
              f.focus(!0);
            }, 100),
          ...
          this.config.autoLink &&
            ((!i || (i && h)) &&
              (this.parent.on('newword:composer', function () {
                b.getTextContent(g.element).match(b.autoLink.URL_REG_EXP) &&
                  g.selection.executeAndRestore(function (c, d) {
                    var e,
            ...
            (d = this.sandbox.getDocument().getElementsByTagName('a')),
            (e = b.autoLink.URL_REG_EXP),
            (f = function (c) {
            ...
            b.observe(this.element, 'keydown', function (a) {
              if (d.length) {
                var c,
                  ...
                  i = b.getParentElement(h, { nodeName: 'A' }, 4);
                i &&
                  ((c = f(i)),
                  setTimeout(function () {
                    var a = f(i);
      ...
      _initLineBreaking: function () {
        ...
        this.config.useLineBreaks ||
          b.observe(this.element, ['focus', 'keydown'], function () {
            if (e.isEmpty()) {
          ...
          b.observe(this.element, 'keydown', function (c) {
            var h,
              i = c.keyCode;
            if (!c.shiftKey && (i === a.ENTER_KEY || i === a.BACKSPACE_KEY))
              return (
                (h = b.getParentElement(e.selection.getSelectedNode(), { nodeName: f }, 4)),
                h
                  ? (setTimeout(function () {
                      var c,
                    ...
                    void 0)
                  : (e.config.useLineBreaks && i === a.ENTER_KEY && !a.browser.insertsLineBreaksOnReturn() && (c.preventDefault(), e.commands.exec('insertLineBreak')), void 0)
              );
          });
      },
    });
    ...
    var b = a.dom,
      ...
      i = function (a) {
        if (a.setActive)
          ...
          b.setStyles({ position: 'absolute', top: '-99999px', left: '-99999px', WebkitUserSelect: 'none' }).on(a), a.focus(), b.setStyles(i).on(a), d.scrollTo && d.scrollTo(h, g);
        }
      };
  ...
  (function (a) {
    ...
    a.views.Composer.prototype.observe = function () {
      ...
      b.observe(k, 'DOMNodeRemoved', function () {
        ...
        c.supportsMutationEvents() ||
          (e = setInterval(function () {
            b.contains(document.documentElement, k) || (clearInterval(e), i.parent.fire('destroy:composer'));
          }, 250)),
        b.observe(m, o, function () {
          setTimeout(function () {
            i.parent.fire('interaction').fire('interaction:composer');
          }, 0);
        }),
        this.config.handleTables &&
          (!this.tableClickHandle &&
            this.doc.execCommand &&
            a.browser.supportsCommand(this.doc, 'enableObjectResizing') &&
            a.browser.supportsCommand(this.doc, 'enableInlineTableEditing') &&
            (this.sandbox.getIframe
              ? (this.tableClickHandle = b.observe(k, ['focus', 'mouseup', 'mouseover'], function () {
          ...
          (this.tableSelection = a.quirks.tableCellsSelection(l, i.parent))),
        b.observe(m, 'focus', function (a) {
        ...
        c.canSelectImagesInContentEditable() ||
          b.observe(l, 'mousedown', function (b) {
            var c = b.target,
        ...
        c.canSelectImagesInContentEditable() ||
          b.observe(l, 'drop', function () {
            setTimeout(function () {
              i.selection.getSelection().removeAllRanges();
            }, 0);
          }),
        c.hasHistoryIssue() &&
          c.supportsSelectionModify() &&
        ...
        b.observe(l, 'keydown', function (b) {
          ...
          !d ||
            'IMG' !== d.nodeName ||
            (e !== a.BACKSPACE_KEY && e !== a.DELETE_KEY) ||
            ((c = d.parentNode),
            c.removeChild(d),
        ...
        !this.config.contentEditableMode &&
          c.hasIframeFocusIssue() &&
          (b.observe(k, 'focus', function () {
            setTimeout(function () {
    ...
    a.Editor = a.lang.Dispatcher.extend({
      ...
      parse: function (b, c) {
        var d = this.config.contentEditableMode ? document : this.composer ? this.composer.sandbox.getDocument() : null,
          e = this.config.parser(b, { rules: this.config.parserRules, cleanUp: this.config.cleanUp, context: d, uneditableClass: this.config.uneditableContainerClassname, clearInternals: c });
        return 'object' == typeof b && a.quirks.redraw(b), e;
      },
      _initParser: function () {
        var b,
          c = this;
        a.browser.supportsModenPaste()
          ? this.on('paste:composer', function (d) {
              d.preventDefault(), (b = a.dom.getPastedHtml(d)), b && c._cleanAndPaste(b);
            })
          : this.on('beforepaste:composer', function (b) {
              b.preventDefault(),
                a.dom.getPastedHtmlWithDiv(c.composer, function (a) {
                  a && c._cleanAndPaste(a);
                });
            });
      },
      _cleanAndPaste: function (b) {
        var c = a.quirks.cleanPastedHTML(b, { referenceNode: this.composer.element, rules: this.config.pasteParserRulesets || [{ set: this.config.parserRules }], uneditableClass: this.config.uneditableContainerClassname });
        ...
        if (!this._observed) {
          for (
            e = this,
              ...
              b.delegate(this.container, '[data-wysihtml5-dialog-action=cancel]', 'click', function (a) {
                e.fire('cancel'), e.hide(), a.preventDefault(), a.stopPropagation();
              }),
              g = this.container.querySelectorAll(d),
              h = 0,
              i = g.length,
              j = function () {
  ...
  (function (a) {
    ...
    a.toolbar.Speech = function (g, h) {
      ...
      return a.browser.supportsSpeechApiOn(l)
        ? ((i = g.editor.textarea.element.getAttribute('lang')),
          i && (f.lang = i),
          ...
          b.insert(j).into(h),
          b.setStyles(e).on(l),
          b.setAttributes(f).on(l),
          b.setStyles(d).on(j),
          b.setStyles(c).on(h),
          (k = 'onwebkitspeechchange' in l ? 'webkitspeechchange' : 'speechchange'),
          b.observe(l, k, function () {
  ...
  (function (a) {
    ...
    a.toolbar.Toolbar = Base.extend({
      ...
      _observe: function () {
        for (var a = this, b = this.editor, d = this.container, e = this.commandLinks.concat(this.actionLinks), g = e.length, h = 0; g > h; h++) 'A' === e[h].nodeName ? f.setAttributes({ href: 'javascript:;', unselectable: 'on' }).on(e[h]) : f.setAttributes({ unselectable: 'on' }).on(e[h]);
        f.delegate(d, '[data-wysihtml5-command], [data-wysihtml5-action]', 'mousedown', function (a) {
          ...
          this.editor.config.handleTables &&
            (b.on('tableselect:composer', function () {
    ...
    var a = (function () {
      ...
      d = (function (a, b) {
          ...
          a.registerHelper('helperMissing', function (a) {
            ...
            a.registerHelper('each', function (a, b) {
              ...
              if ((i(a) && (a = a.call(this)), b.data && (c = m(b.data)), a && 'object' == typeof a))
                if (h(a)) for (d = a.length; d > j; j++) c && ((c.index = j), (c.first = 0 === j), (c.last = j === a.length - 1)), (k += f(a[j], { data: c }));
                else for (e in a) a.hasOwnProperty(e) && (c && ((c.key = e), (c.index = j), (c.first = 0 === j)), (k += f(a[e], { data: c })), j++);
        ...
        return (
          ...
          (g = { 1: '<= 1.0.rc.2', 2: '== 1.0.0-rc.3', 3: '== 1.0.0-rc.4', 4: '>= 1.0.0' }),
      ...
      e = (function (a, b, c) {
        ...
        function e(a, b) {
          ...
          var c = function (a, c, d, e, f, g) {
              ...
              if (null != i) return i;
              if (b.compile) return (h = { helpers: e, partials: f, data: g }), (f[c] = b.compile(a, { data: void 0 !== g }, b)), f[c](d, h);
    ...
    var c = function (a, b) {
      ...
      (g.prototype = {
        ...
        loadParserRules: function () {
          'string' === a.type(this.config.parserRules) &&
            a.ajax({
              dataType: 'json',
            ...
            this.config.pasteParserRulesets &&
              'string' === a.type(this.config.pasteParserRulesets) &&
              a.ajax({
                dataType: 'json',
        ...
        syncBootstrapDialogEvents: function () {
          var b = this;
          a
            .map(this.toolbar.commandMapping, function (a) {
              return [a];
            })
            .filter(function (a) {
              return a.dialog;
        ...
        createToolbar: function (b, c) {
          ...
          return (
            j.find('a[data-wysihtml5-command="formatBlock"]').click(function (b) {
        ...
        (d = a.fn.wysihtml5.defaultOptions = { toolbar: { 'font-styles': !0, color: !1, emphasis: { small: !0 }, blockquote: !0, lists: !0, html: !1, link: !0, image: !0, smallmodals: !1 }, useLineBreaks: !1, parserRules: { classes: { 'wysiwyg-color-silver': 1, 'wysiwyg-color-gray': 1, 'wysiwyg-color-white': 1, 'wysiwyg-color-maroon': 1, 'wysiwyg-color-red': 1, 'wysiwyg-color-purple': 1, 'wysiwyg-color-fuchsia': 1, 'wysiwyg-color-green': 1, 'wysiwyg-color-lime': 1, 'wysiwyg-color-olive': 1, 'wysiwyg-color-yellow': 1, 'wysiwyg-color-navy': 1, 'wysiwyg-color-blue': 1, 'wysiwyg-color-teal': 1, 'wysiwyg-color-aqua': 1, 'wysiwyg-color-orange': 1 }, tags: { b: {}, i: {}, strong: {}, em: {}, p: {}, br: {}, ol: {}, ul: {}, li: {}, h1: {}, h2: {}, h3: {}, h4: {}, h5: {}, h6: {}, blockquote: {}, u: 1, img: { check_attributes: { width: 'numbers', alt: 'alt', src: 'url', height: 'numbers' } }, a: { check_attributes: { href: 'url' }, set_attributes: { target: '_blank', rel: 'nofollow' } }, span: 1, div: 1, small: 1, code: 1, pre: 1 } }, locale: 'en', shortcuts: { 83: 'small', 75: 'createLink' } }),
        void 0 === a.fn.wysihtml5.defaultOptionsCache && (a.fn.wysihtml5.defaultOptionsCache = a.extend(!0, {}, a.fn.wysihtml5.defaultOptions)),
