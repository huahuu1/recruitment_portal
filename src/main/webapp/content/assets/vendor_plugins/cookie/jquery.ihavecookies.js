...
(function ($) {
  ...
  $.fn.ihavecookies = function (options, event) {
    ...
    if (!myCookie || !myCookiePrefs || event == 'reinit') {
      ...
      /*      var cookieMessage = '<div id="gdpr-cookie-message" class="d-flex align-items-center justify-content-center"><div><h4>' + settings.title + '</h4><p>' + settings.message + ' <a href="' + settings.link + '">' + settings.moreInfoLabel + '</a><div id="gdpr-cookie-types" style="display:none;"><h5>' + settings.cookieTypesTitle + '</h5><ul>' + cookieTypes + '</ul></div></div><p><button id="gdpr-cookie-accept" type="button" class="btn btn-danger nowrap">' + settings.acceptBtnLabel + '</button></p></div>';
      setTimeout(function () {
