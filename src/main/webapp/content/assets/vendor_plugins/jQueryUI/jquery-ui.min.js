            ...
            menufocus: function (t, i) {
              ...
              return this.isNewMenu && ((this.isNewMenu = !1), t.originalEvent && /^mouse/.test(t.originalEvent.type))
                ? (this.menu.blur(),
                  ...
                  void 0)
                : ((n = i.item.data('ui-autocomplete-item')), !1 !== this._trigger('focus', t, { item: n }) && t.originalEvent && /^key/.test(t.originalEvent.type) && this._value(n.value), (s = i.item.attr('aria-label') || n.value), s && e.trim(s).length && (this.liveRegion.children().hide(), e('<div>').text(s).appendTo(this.liveRegion)), void 0);
            },
  ...
  (e.effects = { effect: {} }),
    ...
    e.widget('ui.spinner', {
      ...
      _draw: function () {
        ...
        this.element.attr('role', 'spinbutton'), (this.buttons = e.find('.ui-spinner-button').attr('tabIndex', -1).button().removeClass('ui-corner-all')), this.buttons.height() > Math.ceil(0.5 * e.height()) && e.height() > 0 && e.height(e.height()), this.options.disabled && this.disable();
      },
      _keydown: function (t) {
        var i = this.options,
          s = e.ui.keyCode;
