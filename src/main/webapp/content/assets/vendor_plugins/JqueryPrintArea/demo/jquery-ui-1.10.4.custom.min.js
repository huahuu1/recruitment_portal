  ...
  t.widget('ui.draggable', t.ui.mouse, {
    ...
    _mouseStop: function (e) {
      ...
      return (
        ...
        'original' !== this.options.helper || t.contains(this.element[0].ownerDocument, this.element[0])
        ...
        _position: function () {
          ...
          i
            ? (('string' == typeof i || ('object' == typeof i && '0' in i)) &&
                ...
                (i = { my: a[0] + (0 > s[0] ? s[0] : '+' + s[0]) + ' ' + a[1] + (0 > s[1] ? s[1] : '+' + s[1]), at: a.join(' ') })),
        ...
        ? (this.isLastItem() ||
            (this._hasScroll()
              ? ((s = this.active.offset().top),
                ...
                this.focus(e, i))
              : this.focus(e, this.activeMenu.children('.ui-menu-item')[this.active ? 'last' : 'first']())),
          undefined)
  ...
  t.widget('ui.progressbar', {
    ...
    _refreshValue: function () {
      ...
      this.valueDiv
        ...
        this.indeterminate ? (this.element.removeAttr('aria-valuenow'), this.overlayDiv || (this.overlayDiv = t("<div class='ui-progressbar-overlay'></div>").appendTo(this.valueDiv))) : (this.element.attr({ 'aria-valuemax': this.options.max, 'aria-valuenow': e }), this.overlayDiv && (this.overlayDiv.remove(), (this.overlayDiv = null))),
    ...
    _open: function (i, s, n) {
      ...
      if (n) {
        ...
        s.is('[title]') && (i && 'mouseover' === i.type ? s.attr('title', '') : s.removeAttr('title')),
          ...
          this.options.track && i && /^mouse/.test(i.type) ? (this._on(this.document, { mousemove: o }), o(i)) : a.position(t.extend({ of: s }, this.options.position)),
          a.hide(),
...
(function (t) {
  t.effects.effect.bounce = function (e, i) {
    ...
    h && ((n = { opacity: 0 }), (n[v] = (_ ? '-=' : '+=') + d), o.animate(n, g, m)),
      o.queue(function () {
      ...
      for (l = m.top + a * _, c = a - (u - 1) / 2, o = 0; d > o; o++)
        (r = m.left + o * v),
          ...
          p
            ...
            .appendTo('body')
            .wrap('<div></div>')
            .css({ position: 'absolute', visibility: 'visible', left: -o * v, top: -a * _ })
            .parent()
            .addClass('ui-effects-explode')
            .css({ position: 'absolute', overflow: 'hidden', width: v, height: _, left: r + (g ? h * v : 0), top: l + (g ? c * _ : 0), opacity: g ? 0 : 1 })
            .animate({ left: r + (g ? 0 : h * v), top: l + (g ? 0 : c * _), opacity: g ? 1 : 0 }, e.duration || 500, e.easing, s);
  };
})(jQuery);
(function (t) {
  ...
  t.effects.effect.transfer = function (e, i) {
    var s = t(this),
      ...
      d = t("<div class='ui-effects-transfer'></div>")
        ...
        .css({ top: u.top - r, left: u.left - l, height: s.innerHeight(), width: s.innerWidth(), position: a ? 'fixed' : 'absolute' })
