...
(function (e) {
  ...
  ace.define('ace/mode/lua/luaparse', ['require', 'exports', 'module'], function (e, t, n) {
    (function (e, n, r) {
      ...
      function yt(e) {
        n.locations && (this.loc = { start: { line: e.line, column: e.range[0] - e.lineStart }, end: { line: 0, column: 0 } }), n.ranges && (this.range = [e.range[0], 0]);
      }
      function bt() {
        mt && vt.push(gt());
      }
      ...
      var d = (e.errors = { unexpected: "Unexpected %1 '%2' near '%3'", expected: "'%1' expected near '%2'", expectedToken: "%1 expected near '%2'", unfinishedString: "unfinished string near '%1'", malformedNumber: "malformed number near '%1'" }),
        v = (e.ast = {
          ...
          literal: function (e, t, n) {
            return (e = e === o ? 'StringLiteral' : e === f ? 'NumericLiteral' : e === c ? 'BooleanLiteral' : e === h ? 'NilLiteral' : 'VarargLiteral'), { type: e, value: t, raw: n };
          },
  ...
  ace.define('ace/mode/lua_worker', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/lua/luaparse'], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
