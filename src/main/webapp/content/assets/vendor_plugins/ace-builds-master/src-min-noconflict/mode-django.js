  ...
  ace.define('ace/mode/django', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html', 'ace/mode/html_highlight_rules', 'ace/mode/text_highlight_rules'], function (e, t, n) {
    ...
    var a = function () {
      ...
      for (var e in this.$rules)
        this.$rules[e].unshift({ token: 'comment.line', regex: '\\{#.*?#\\}' }, { token: 'comment.block', regex: '\\{\\%\\s*comment\\s*\\%\\}', merge: !0, next: 'django-comment' }, { token: 'constant.language', regex: '\\{\\{', next: 'django-start' }, { token: 'constant.language', regex: '\\{\\%', next: 'django-tag' }),
