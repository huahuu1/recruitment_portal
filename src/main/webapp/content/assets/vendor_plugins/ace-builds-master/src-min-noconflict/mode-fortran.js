ace.define('ace/mode/fortran_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (e, t, n) {
  'use strict';
  var r = e('../lib/oop'),
    ...
    s = function () {
      var e = 'call|case|contains|continue|cycle|do|else|elseif|end|enddo|endif|function|if|implicit|in|include|inout|intent|module|none|only|out|print|program|return|select|status|stop|subroutine|return|then|use|while|write|CALL|CASE|CONTAINS|CONTINUE|CYCLE|DO|ELSE|ELSEIF|END|ENDDO|ENDIF|FUNCTION|IF|IMPLICIT|IN|INCLUDE|INOUT|INTENT|MODULE|NONE|ONLY|OUT|PRINT|PROGRAM|RETURN|SELECT|STATUS|STOP|SUBROUTINE|RETURN|THEN|USE|WHILE|WRITE',
        ...
        o = this.createKeywordMapper({ 'invalid.deprecated': 'debugger', 'support.function': r, 'constant.language': n, keyword: e, 'keyword.operator': t, 'storage.type': i, 'storage.modifier': s }, 'identifier'),
      ...
      this.$rules = {
        start: [
          ...
          { token: 'keyword', regex: '#\\s*(?:include|import|define|undef|INCLUDE|IMPORT|DEFINE|UNDEF)\\b' },
          { token: 'keyword', regex: '#\\s*(?:endif|ifdef|else|elseif|ifndef|ENDIF|IFDEF|ELSE|ELSEIF|IFNDEF)\\b' },
        ...
        qqstring3: [{ token: 'constant.language.escape', regex: b }, { token: 'string', regex: '"{3}', next: 'start' }, { defaultToken: 'string' }],
        qstring3: [{ token: 'constant.language.escape', regex: b }, { token: 'string', regex: '"{3}', next: 'start' }, { defaultToken: 'string' }],
        qqstring: [{ token: 'constant.language.escape', regex: b }, { token: 'string', regex: '\\\\$', next: 'qqstring' }, { token: 'string', regex: '"|$', next: 'start' }, { defaultToken: 'string' }],
        qstring: [{ token: 'constant.language.escape', regex: b }, { token: 'string', regex: '\\\\$', next: 'qstring' }, { token: 'string', regex: "'|$", next: 'start' }, { defaultToken: 'string' }],
      };
    };
  ...
  ace.define('ace/mode/fortran', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/fortran_highlight_rules', 'ace/mode/folding/cstyle', 'ace/range'], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      i = e('./text').Mode,
