  ...
  ace.define('ace/mode/scad_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], function (e, t, n) {
    ...
    var r = e('../lib/oop'),
      ...
      u = function () {
        ...
        (this.$rules = {
          start: [{ token: 'comment', regex: '\\/\\/.*$' }, s.getStartRule('start'), { token: 'comment', regex: '\\/\\*', next: 'comment' }, { token: 'string', regex: '["](?:(?:\\\\.)|(?:[^"\\\\]))*?["]' }, { token: 'string', regex: '["].*\\\\$', next: 'qqstring' }, { token: 'string', regex: "['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']" }, { token: 'string', regex: "['].*\\\\$", next: 'qstring' }, { token: 'constant.numeric', regex: '0[xX][0-9a-fA-F]+\\b' }, { token: 'constant.numeric', regex: '[+-]?\\d+(?:(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)?\\b' }, { token: 'constant', regex: '<[a-zA-Z0-9.]+>' }, { token: 'keyword', regex: '(?:use|include)' }, { token: e, regex: '[a-zA-Z_$][a-zA-Z0-9_$]*\\b' }, { token: 'keyword.operator', regex: '!|\\$|%|&|\\*|\\-\\-|\\-|\\+\\+|\\+|~|==|=|!=|<=|>=|<<=|>>=|>>>=|<>|<|>|!|&&|\\|\\||\\?\\:|\\*=|%=|\\+=|\\-=|&=|\\^=|\\b(?:in|new|delete|typeof|void)' }, { token: 'paren.lparen', regex: '[[({]' }, { token: 'paren.rparen', regex: '[\\])}]' }, { token: 'text', regex: '\\s+' }],
