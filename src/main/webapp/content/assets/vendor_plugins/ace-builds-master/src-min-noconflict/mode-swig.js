ace.define('ace/mode/css_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules'], function (e, t, n) {
  ...
  var r = e('../lib/oop'),
    ...
    d = function () {
      ...
      (this.$rules = { start: [{ token: 'comment', regex: '\\/\\*', push: 'comment' }, { token: 'paren.lparen', regex: '\\{', push: 'ruleset' }, { token: 'string', regex: '@.*?{', push: 'media' }, { token: 'keyword', regex: '#[a-z0-9-_]+' }, { token: 'variable', regex: '\\.[a-z0-9-_]+' }, { token: 'string', regex: ':[a-z0-9-_]+' }, { token: 'constant', regex: '[a-z0-9-_]+' }, { caseInsensitive: !0 }], media: [{ token: 'comment', regex: '\\/\\*', push: 'comment' }, { token: 'paren.lparen', regex: '\\{', push: 'ruleset' }, { token: 'string', regex: '\\}', next: 'pop' }, { token: 'keyword', regex: '#[a-z0-9-_]+' }, { token: 'variable', regex: '\\.[a-z0-9-_]+' }, { token: 'string', regex: ':[a-z0-9-_]+' }, { token: 'constant', regex: '[a-z0-9-_]+' }, { caseInsensitive: !0 }], comment: [{ token: 'comment', regex: '\\*\\/', next: 'pop' }, { defaultToken: 'comment' }], ruleset: [{ token: 'paren.rparen', regex: '\\}', next: 'pop' }, { token: 'comment', regex: '\\/\\*', push: 'comment' }, { token: 'string', regex: '["](?:(?:\\\\.)|(?:[^"\\\\]))*?["]' }, { token: 'string', regex: "['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']" }, { token: ['constant.numeric', 'keyword'], regex: '(' + c + ')(ch|cm|deg|em|ex|fr|gd|grad|Hz|in|kHz|mm|ms|pc|pt|px|rad|rem|s|turn|vh|vm|vw|%)' }, { token: 'constant.numeric', regex: c }, { token: 'constant.numeric', regex: '#[a-f0-9]{6}' }, { token: 'constant.numeric', regex: '#[a-f0-9]{3}' }, { token: ['punctuation', 'entity.other.attribute-name.pseudo-element.css'], regex: h }, { token: ['punctuation', 'entity.other.attribute-name.pseudo-class.css'], regex: p }, { token: ['support.function', 'string', 'support.function'], regex: '(url\\()(.*)(\\))' }, { token: e, regex: '\\-?[a-zA-Z_][a-zA-Z0-9_\\-]*' }, { caseInsensitive: !0 }] }), this.normalizeRules();
    };
    ...
    function a() {
      ...
      (this.$rules.jsx = [n, t, { include: 'reference' }, { defaultToken: 'string' }]),
        (this.$rules.jsxAttributes = [
          ...
          { token: 'string.attribute-value.xml', regex: "'", stateName: 'jsx_attr_q', push: [{ token: 'string.attribute-value.xml', regex: "'", next: 'pop' }, n, { include: 'reference' }, { defaultToken: 'string.attribute-value.xml' }] },
          { token: 'string.attribute-value.xml', regex: '"', stateName: 'jsx_attr_qq', push: [n, { token: 'string.attribute-value.xml', regex: '"', next: 'pop' }, { include: 'reference' }, { defaultToken: 'string.attribute-value.xml' }] },
        ]),
    ...
    var r = e('../lib/oop'),
      ...
      u = function (e) {
        ...
        this.$rules = {
          ...
          start: [i.getStartRule('doc-start'), { token: 'comment', regex: '\\/\\*', next: 'comment_regex_allowed' }, { token: 'comment', regex: '\\/\\/', next: 'line_comment_regex_allowed' }, { token: 'string.regexp', regex: '\\/', next: 'regex' }, { token: 'text', regex: '\\s+|^$', next: 'start' }, { token: 'empty', regex: '', next: 'no_regex' }],
          ...
          comment_regex_allowed: [i.getTagRule(), { token: 'comment', regex: '\\*\\/', next: 'start' }, { defaultToken: 'comment', caseInsensitive: !0 }],
          ...
          line_comment: [i.getTagRule(), { token: 'comment', regex: '$|^', next: 'no_regex' }, { defaultToken: 'comment', caseInsensitive: !0 }],
          qqstring: [{ token: 'constant.language.escape', regex: r }, { token: 'string', regex: '\\\\$', next: 'qqstring' }, { token: 'string', regex: '"|$', next: 'no_regex' }, { defaultToken: 'string' }],
          qstring: [{ token: 'constant.language.escape', regex: r }, { token: 'string', regex: '\\\\$', next: 'qstring' }, { token: 'string', regex: "'|$", next: 'no_regex' }, { defaultToken: 'string' }],
        };
        if (!e || !e.noES6)
  ...
  ace.define('ace/mode/xml_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (e, t, n) {
    ...
    var r = e('../lib/oop'),
      ...
      s = function (e) {
        ...
        (this.$rules = {
          start: [{ token: 'string.cdata.xml', regex: '<\\!\\[CDATA\\[', next: 'cdata' }, { token: ['punctuation.xml-decl.xml', 'keyword.xml-decl.xml'], regex: '(<\\?)(xml)(?=[\\s])', next: 'xml_decl', caseInsensitive: !0 }, { token: ['punctuation.instruction.xml', 'keyword.instruction.xml'], regex: '(<\\?)(' + t + ')', next: 'processing_instruction' }, { token: 'comment.xml', regex: '<\\!--', next: 'comment' }, { token: ['xml-pe.doctype.xml', 'xml-pe.doctype.xml'], regex: '(<\\!)(DOCTYPE)(?=[\\s])', next: 'doctype', caseInsensitive: !0 }, { include: 'tag' }, { token: 'text.end-tag-open.xml', regex: '</' }, { token: 'text.tag-open.xml', regex: '<' }, { include: 'reference' }, { defaultToken: 'text.xml' }],
          xml_decl: [{ token: 'entity.other.attribute-name.decl-attribute-name.xml', regex: '(?:' + t + ':)?' + t + '' }, { token: 'keyword.operator.decl-attribute-equals.xml', regex: '=' }, { include: 'whitespace' }, { include: 'string' }, { token: 'punctuation.xml-decl.xml', regex: '\\?>', next: 'start' }],
          ...
          attributes: [{ token: 'entity.other.attribute-name.xml', regex: '(?:' + t + ':)?' + t + '' }, { token: 'keyword.operator.attribute-equals.xml', regex: '=' }, { include: 'tag_whitespace' }, { include: 'attribute_value' }],
          attribute_value: [
    ...
    var r = e('../lib/oop'),
      ...
      f = function () {
        u.call(this),
          ...
          this.embedTagRules(new o({ noJSX: !0 }).getRules(), 'js-', 'script'),
          this.constructor === f && this.normalizeRules();
      };
    r.inherits(f, u), (t.HtmlHighlightRules = f);
  }),
  ace.define('ace/mode/swig', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/html_highlight_rules', 'ace/mode/text_highlight_rules'], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      i = e('../lib/lang'),
      ...
      u = function () {
        s.call(this);
        var e = 'autoescape|block|else|elif|extends|filter|for|if|import|include|macro|parent|raw|set|spaceless';
        e = e + '|end' + e.replace(/\|/g, '|end');
        var t = 'addslashes|capitalize|date|default|escape|first|groupBy|join|json|last|lower|raw|replace|reverse|safe|sort|striptags|title|uniq|upper|url_encode|url_decode',
          n = 'first|last|index|index0|revindex|revindex0|key',
          r = 'null|none|true|false|loop',
          i = 'in|is|and|or|not|as|with|only',
          o = this.createKeywordMapper({ 'keyword.control.swig': e, 'support.function.swig': t + '|' + n, 'keyword.operator.swig': i, 'constant.language.swig': r }, 'identifier');
        for (var u in this.$rules) this.$rules[u].unshift({ token: 'variable.other.readwrite.local.swig', regex: '\\{\\{-?', push: 'swig-start' }, { token: 'meta.tag.swig', regex: '\\{%-?', push: 'swig-start' }, { token: 'comment.block.swig', regex: '\\{#-?', push: 'swig-comment' });
        (this.$rules['swig-comment'] = [{ token: 'comment.block.swig', regex: '.*-?#}', next: 'pop' }]),
          (this.$rules['swig-start'] = [
            { token: 'variable.other.readwrite.local.swig', regex: '-?\\}\\}', next: 'pop' },
            { token: 'meta.tag.swig', regex: '-?%\\}', next: 'pop' },
            { token: 'string', regex: "'", next: 'swig-qstring' },
            { token: 'string', regex: '"', next: 'swig-qqstring' },
          ...
          (this.$rules['swig-qqstring'] = [{ token: 'constant.language.escape', regex: /\\[\\"$#ntr]|#{[^"}]*}/ }, { token: 'string', regex: '"', next: 'swig-start' }, { defaultToken: 'string' }]),
          (this.$rules['swig-qstring'] = [{ token: 'constant.language.escape', regex: /\\[\\'ntr]}/ }, { token: 'string', regex: "'", next: 'swig-start' }, { defaultToken: 'string' }]),
          this.normalizeRules();
      };
    r.inherits(u, o), (t.SwigHighlightRules = u);
  });
