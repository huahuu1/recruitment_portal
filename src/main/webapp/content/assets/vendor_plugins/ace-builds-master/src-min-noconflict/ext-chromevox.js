ace.define('ace/ext/chromevox', ['require', 'exports', 'module', 'ace/editor', 'ace/config'], function (e, t, n) {
  ...
  var i = { rate: 0.8, pitch: 0.4, volume: 0.9 },
    s = { rate: 1, pitch: 0.5, volume: 0.9 },
    o = { rate: 0.8, pitch: 0.8, volume: 0.9 },
    u = { rate: 0.8, pitch: 0.3, volume: 0.9 },
    a = { rate: 0.8, pitch: 0.7, volume: 0.9 },
    f = { rate: 0.8, pitch: 0.8, volume: 0.9 },
    l = { punctuationEcho: 'none', relativePitch: -0.6 },
    c = 'ALERT_NONMODAL',
    h = 'ALERT_MODAL',
    p = 'INVALID_KEYPRESS',
    d = 'insertMode',
    ...
    g = { SPEAK_ANNOT: 'annots', SPEAK_ALL_ANNOTS: 'all_annots', TOGGLE_LOCATION: 'toggle_location', SPEAK_MODE: 'mode', SPEAK_ROW_COL: 'row_col', TOGGLE_DISPLACEMENT: 'toggle_displacement', FOCUS_TEXT: 'focus_text' },
    y = 'CONTROL + SHIFT ';
  r.editor = null;
  var b = null,
    w = {},
    ...
    F = function (e) {
      var t = r.editor.getSession().getLine(e),
        n = /^\s*$/;
    ...
    X = function (e, t) {
      var n = O(t),
        r = n.substring(e.column, t.column);
    ...
    Q = function (e) {
      switch (e.action) {
        case 'remove':
          cvox.Api.speak(e.text, 0, l), (x = !0);
          break;
        case 'insert':
          cvox.Api.speak(e.text, 0), (x = !0);
      }
    },
    G = function (e) {
      var t = e.row,
    ...
    Z = function (e) {
      var t = r.editor.getSession().getAnnotations(),
        n = t.filter(G);
    ...
    vt = function (e, t) {
      (r.editor = t), t.getSession().selection.on('changeCursor', J), t.getSession().selection.on('changeSelection', K), t.getSession().on('change', Q), t.getSession().on('changeAnnotation', Z), t.on('changeStatus', ft), t.on('findSearchBox', ht), t.container.addEventListener('keydown', at), (b = t.selection.getCursor());
    },
    mt = function (e) {
      vt(null, e),
