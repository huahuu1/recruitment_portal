ace.define('ace/ext/searchbox', ['require', 'exports', 'module', 'ace/lib/dom', 'ace/lib/lang', 'ace/lib/event', 'ace/keyboard/hash_handler', 'ace/lib/keys'], function (e, t, n) {
  ...
  (function () {
    (this.setEditor = function (e) {
      ...
      (this.find = function (e, t, n) {
        var i = this.editor.find(this.searchInput.value, { skipCurrent: e, backwards: t, wrap: !0, regExp: this.regExpOption.checked, caseSensitive: this.caseSensitiveOption.checked, wholeWord: this.wholeWordOption.checked, preventScroll: n }),
          s = !i && this.searchInput.value;
        r.setCssClass(this.searchBox, 'ace_nomatch', s), this.editor._emit('findSearchBox', { match: !s }), this.highlight();
      }),
      ...
      (this.findAll = function () {
        var e = this.editor.findAll(this.searchInput.value, { regExp: this.regExpOption.checked, caseSensitive: this.caseSensitiveOption.checked, wholeWord: this.wholeWordOption.checked }),
  ...
  ace.define('ace/ext/old_ie', ['require', 'exports', 'module', 'ace/lib/useragent', 'ace/tokenizer', 'ace/ext/searchbox', 'ace/mode/text'], function (require, exports, module) {
    ...
    var MAX_TOKEN_COUNT = 1e3,
      ...
      TokenizerModule = require('../tokenizer');
    ...
    (TokenizerModule.Tokenizer_orig = TokenizerModule.Tokenizer),
      ...
      patch(TokenizerModule, 'Tokenizer', 'ruleRegExps.push(adjustedregex);\n', function (e) {
      ...
      patch(require('../mode/text').Mode.prototype, 'getTokenizer', /Tokenizer/, 'TokenizerModule.Tokenizer'),
      (useragent.isOldIE = !0);
  });
(function () {
