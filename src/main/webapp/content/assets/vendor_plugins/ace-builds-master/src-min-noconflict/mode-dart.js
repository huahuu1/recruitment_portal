  ...
  ace.define('ace/mode/c_cpp_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], function (e, t, n) {
    ...
    var r = e('../lib/oop'),
      ...
      u = function () {
        ...
        (this.$rules = {
          start: [{ token: 'comment', regex: '//$', next: 'start' }, { token: 'comment', regex: '//', next: 'singleLineComment' }, i.getStartRule('doc-start'), { token: 'comment', regex: '\\/\\*', next: 'comment' }, { token: 'string', regex: "'(?:" + f + "|.)?'" }, { token: 'string.start', regex: '"', stateName: 'qqstring', next: [{ token: 'string', regex: /\\\s*$/, next: 'qqstring' }, { token: 'constant.language.escape', regex: f }, { token: 'constant.language.escape', regex: /%[^'"\\]/ }, { token: 'string.end', regex: '"|$', next: 'start' }, { defaultToken: 'string' }] }, { token: 'string.start', regex: 'R"\\(', stateName: 'rawString', next: [{ token: 'string.end', regex: '\\)"', next: 'start' }, { defaultToken: 'string' }] }, { token: 'constant.numeric', regex: '0[xX][0-9a-fA-F]+(L|l|UL|ul|u|U|F|f|ll|LL|ull|ULL)?\\b' }, { token: 'constant.numeric', regex: '[+-]?\\d+(?:(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)?(L|l|UL|ul|u|U|F|f|ll|LL|ull|ULL)?\\b' }, { token: 'keyword', regex: '#\\s*(?:include|import|pragma|line|define|undef)\\b', next: 'directive' }, { token: 'keyword', regex: '#\\s*(?:endif|if|ifdef|else|elif|ifndef)\\b' }, { token: 'support.function.C99.c', regex: o }, { token: u, regex: '[a-zA-Z_$][a-zA-Z0-9_$]*' }, { token: 'keyword.operator', regex: /--|\+\+|<<=|>>=|>>>=|<>|&&|\|\||\?:|[*%\/+\-&\^|~!<>=]=?/ }, { token: 'punctuation.operator', regex: '\\?|\\:|\\,|\\;|\\.' }, { token: 'paren.lparen', regex: '[[({]' }, { token: 'paren.rparen', regex: '[\\])}]' }, { token: 'text', regex: '\\s+' }],
          comment: [{ token: 'comment', regex: '\\*\\/', next: 'start' }, { defaultToken: 'comment' }],
          singleLineComment: [{ token: 'comment', regex: /\\$/, next: 'singleLineComment' }, { token: 'comment', regex: /$/, next: 'start' }, { defaultToken: 'comment' }],
          directive: [
    ...
    var r = e('../lib/oop'),
      ...
      o = function () {
        var e = 'true|false|null',
          ...
          u = this.createKeywordMapper({ 'constant.language.dart': e, 'variable.language.dart': t, 'keyword.control.dart': n, 'keyword.declaration.dart': r, 'storage.modifier.dart': s, 'storage.type.primitive.dart': o }, 'identifier'),
          a = { defaultToken: 'string' };
        (this.$rules = { start: [{ token: 'comment', regex: /\/\/.*$/ }, i.getStartRule('doc-start'), { token: 'comment', regex: /\/\*/, next: 'comment' }, { token: ['meta.preprocessor.script.dart'], regex: '^(#!.*)$' }, { token: 'keyword.other.import.dart', regex: '(?:\\b)(?:library|import|export|part|of|show|hide)(?:\\b)' }, { token: ['keyword.other.import.dart', 'text'], regex: '(?:\\b)(prefix)(\\s*:)' }, { regex: '\\bas\\b', token: 'keyword.cast.dart' }, { regex: '\\?|:', token: 'keyword.control.ternary.dart' }, { regex: '(?:\\b)(is\\!?)(?:\\b)', token: ['keyword.operator.dart'] }, { regex: '(<<|>>>?|~|\\^|\\||&)', token: ['keyword.operator.bitwise.dart'] }, { regex: '((?:&|\\^|\\||<<|>>>?)=)', token: ['keyword.operator.assignment.bitwise.dart'] }, { regex: '(===?|!==?|<=?|>=?)', token: ['keyword.operator.comparison.dart'] }, { regex: '((?:[+*/%-]|\\~)=)', token: ['keyword.operator.assignment.arithmetic.dart'] }, { regex: '=', token: 'keyword.operator.assignment.dart' }, { token: 'string', regex: "'''", next: 'qdoc' }, { token: 'string', regex: '"""', next: 'qqdoc' }, { token: 'string', regex: "'", next: 'qstring' }, { token: 'string', regex: '"', next: 'qqstring' }, { regex: '(\\-\\-|\\+\\+)', token: ['keyword.operator.increment-decrement.dart'] }, { regex: '(\\-|\\+|\\*|\\/|\\~\\/|%)', token: ['keyword.operator.arithmetic.dart'] }, { regex: '(!|&&|\\|\\|)', token: ['keyword.operator.logical.dart'] }, { token: 'constant.numeric', regex: '0[xX][0-9a-fA-F]+\\b' }, { token: 'constant.numeric', regex: '[+-]?\\d+(?:(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)?\\b' }, { token: u, regex: '[a-zA-Z_$][a-zA-Z0-9_$]*\\b' }], comment: [{ token: 'comment', regex: '\\*\\/', next: 'start' }, { defaultToken: 'comment' }], qdoc: [{ token: 'string', regex: ".*?'''", next: 'start' }, a], qqdoc: [{ token: 'string', regex: '.*?"""', next: 'start' }, a], qstring: [{ token: 'string', regex: "[^\\\\']*(?:\\\\.[^\\\\']*)*'", next: 'start' }, a], qqstring: [{ token: 'string', regex: '[^\\\\"]*(?:\\\\.[^\\\\"]*)*"', next: 'start' }, a] }), this.embedRules(i, 'doc-', [i.getEndRule('start')]);
      };
