    ...
    var r = e('../lib/oop'),
      ...
      s = function () {
        var e = 'and|as|assert|break|class|continue|def|del|elif|else|except|exec|finally|for|from|global|if|import|in|is|lambda|not|or|pass|print|raise|return|try|while|with|yield',
          ...
          r = this.createKeywordMapper({ 'invalid.deprecated': 'debugger', 'support.function': n, 'constant.language': t, keyword: e }, 'identifier'),
        ...
        this.$rules = {
          ...
          qqstring3: [{ token: 'constant.language.escape', regex: m }, { token: 'string', regex: '"{3}', next: 'start' }, { defaultToken: 'string' }],
          qstring3: [{ token: 'constant.language.escape', regex: m }, { token: 'string', regex: "'{3}", next: 'start' }, { defaultToken: 'string' }],
          qqstring: [{ token: 'constant.language.escape', regex: m }, { token: 'string', regex: '\\\\$', next: 'qqstring' }, { token: 'string', regex: '"|$', next: 'start' }, { defaultToken: 'string' }],
          qstring: [{ token: 'constant.language.escape', regex: m }, { token: 'string', regex: '\\\\$', next: 'qstring' }, { token: 'string', regex: "'|$", next: 'start' }, { defaultToken: 'string' }],
        };
      };
    ...
    var r = e('../lib/oop'),
      ...
      s = function () {
        this.$rules = {
          ...
          string: [{ token: 'constant.language.escape', regex: /\\(?:x[0-9a-fA-F]{2}|u[0-9a-fA-F]{4}|["\\\/bfnrt])/ }, { token: 'string', regex: '"|$', next: 'start' }, { defaultToken: 'string' }],
  ...
  ace.define('ace/mode/pgsql_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules', 'ace/mode/perl_highlight_rules', 'ace/mode/python_highlight_rules', 'ace/mode/json_highlight_rules', 'ace/mode/javascript_highlight_rules'], function (e, t, n) {
    var r = e('../lib/oop'),
      ...
      c = function () {
        ...
        (this.$rules = {
          start: [{ token: 'comment', regex: '--.*$' }, s.getStartRule('doc-start'), { token: 'comment', regex: '\\/\\*', next: 'comment' }, { token: 'keyword.statementBegin', regex: '^[a-zA-Z]+', next: 'statement' }, { token: 'support.buildin', regex: '^\\\\[\\S]+.*$' }],
          statement: [
            { token: 'comment', regex: '--.*$' },
          ...
          this.embedRules(u, 'perl-', [{ token: 'string', regex: '\\$perl\\$', next: 'statement' }]),
          this.embedRules(a, 'python-', [{ token: 'string', regex: '\\$python\\$', next: 'statement' }]),
          this.embedRules(f, 'json-', [{ token: 'string', regex: '\\$json\\$', next: 'statement' }]),
