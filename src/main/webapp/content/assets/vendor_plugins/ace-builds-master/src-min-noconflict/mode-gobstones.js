ace.define('ace/mode/doc_comment_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (e, t, n) {
  ...
  ace.define('ace/mode/gobstones_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      i = e('./doc_comment_highlight_rules').DocCommentHighlightRules,
      s = e('./text_highlight_rules').TextHighlightRules,
      o = function () {
        var e = 'program|procedure|function|interactive|if|then|else|switch|repeat|while|foreach|in|not|div|mod|Skip|return',
          ...
          r = 'Verde|Rojo|Azul|Negro|Norte|Sur|Este|Oeste',
          s = this.createKeywordMapper({ keyword: e, 'constant.language': t, 'support.function': n, 'support.type': r }, 'identifier');
        (this.$rules = { start: [{ token: 'comment', regex: '\\/\\/.*$' }, { token: 'comment', regex: '\\-\\-.*$' }, { token: 'comment', regex: '#.*$' }, i.getStartRule('doc-start'), { token: 'comment', regex: '\\/\\*', next: 'comment' }, { token: 'string', regex: '["](?:(?:\\\\.)|(?:[^"\\\\]))*?["]' }, { token: 'string', regex: "['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']" }, { token: 'constant.numeric', regex: /0(?:[xX][0-9a-fA-F][0-9a-fA-F_]*|[bB][01][01_]*)[LlSsDdFfYy]?\b/ }, { token: 'constant.numeric', regex: /[+-]?\d[\d_]*(?:(?:\.[\d_]*)?(?:[eE][+-]?[\d_]+)?)?[LlSsDdFfYy]?\b/ }, { token: 'constant.language.boolean', regex: '(?:True|False)\\b' }, { token: 'keyword.operator', regex: ':=|\\.\\.|,|;|\\|\\||\\/\\/|\\+|\\-|\\^|\\*|>|<|>=|=>|==|&&' }, { token: s, regex: '[a-zA-Z_$][a-zA-Z0-9_$]*\\b' }, { token: 'lparen', regex: '[[({]' }, { token: 'rparen', regex: '[\\])}]' }, { token: 'text', regex: '\\s+' }], comment: [{ token: 'comment', regex: '\\*\\/', next: 'start' }, { defaultToken: 'comment' }] }), this.embedRules(i, 'doc-', [i.getEndRule('start')]);
      };
    r.inherits(o, s), (t.GobstonesHighlightRules = o);
  }),
  ace.define('ace/mode/gobstones', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/javascript', 'ace/mode/gobstones_highlight_rules'], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      i = e('./javascript').Mode,
      s = e('./gobstones_highlight_rules').GobstonesHighlightRules,
      o = function () {
