ace.define('ace/theme/textmate', ['require', 'exports', 'module', 'ace/lib/dom'], function (e, t, n) {
  ...
  ace.define('ace/ext/textarea', ['require', 'exports', 'module', 'ace/lib/event', 'ace/lib/useragent', 'ace/lib/net', 'ace/ace', 'ace/theme/textmate'], function (e, t, n) {
    'use strict';
    function a(e, t) {
    ...
    function h(e, n, i) {
      ...
      var s = null,
        o = { mode: 'Mode:', wrap: 'Soft Wrap:', theme: 'Theme:', fontSize: 'Font Size:', showGutter: 'Display Gutter:', keybindings: 'Keyboard', showPrintMargin: 'Show Print Margin:', useSoftTabs: 'Use Soft Tabs:', showInvisibles: 'Show Invisibles' },
        u = { mode: { text: 'Plain', javascript: 'JavaScript', xml: 'XML', html: 'HTML', css: 'CSS', scss: 'SCSS', python: 'Python', php: 'PHP', java: 'Java', ruby: 'Ruby', c_cpp: 'C/C++', coffee: 'CoffeeScript', json: 'json', perl: 'Perl', clojure: 'Clojure', ocaml: 'OCaml', csharp: 'C#', haxe: 'haXe', svg: 'SVG', textile: 'Textile', groovy: 'Groovy', liquid: 'Liquid', Scala: 'Scala' }, theme: { clouds: 'Clouds', clouds_midnight: 'Clouds Midnight', cobalt: 'Cobalt', crimson_editor: 'Crimson Editor', dawn: 'Dawn', gob: 'Green on Black', eclipse: 'Eclipse', idle_fingers: 'Idle Fingers', kr_theme: 'Kr Theme', merbivore: 'Merbivore', merbivore_soft: 'Merbivore Soft', mono_industrial: 'Mono Industrial', monokai: 'Monokai', pastel_on_dark: 'Pastel On Dark', solarized_dark: 'Solarized Dark', solarized_light: 'Solarized Light', textmate: 'Textmate', twilight: 'Twilight', vibrant_ink: 'Vibrant Ink' }, showGutter: s, fontSize: { '10px': '10px', '11px': '11px', '12px': '12px', '14px': '14px', '16px': '16px' }, wrap: { off: 'Off', 40: '40', 80: '80', free: 'Free' }, keybindings: { ace: 'ace', vim: 'vim', emacs: 'emacs' }, showPrintMargin: s, useSoftTabs: s, showInvisibles: s },
        a = [];
    ...
    (t.transformTextarea = function (e, n) {
      ...
      var v = document.createElement('div'),
        m = { top: '0px', left: '20%', right: '0px', bottom: '0px', position: 'absolute', padding: '5px', zIndex: 100, color: 'white', display: 'none', overflow: 'auto', fontSize: '14px', boxShadow: '-5px 2px 3px gray' };
      ...
      return (
        ...
        r.addListener(d, 'mousedown', function (e) {
          ...
          r.capture(
            d,
            function (e) {
              (u.style.width = e.clientX - t.left + n + 'px'), (u.style.height = e.clientY - t.top + i + 'px'), g.resize();
            },
            function () {}
          );
        }),
