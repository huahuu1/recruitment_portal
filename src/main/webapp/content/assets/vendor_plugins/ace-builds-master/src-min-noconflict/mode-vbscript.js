  ...
  var r = e('../lib/oop'),
    ...
    s = function () {
      ...
      this.$rules = {
        ...
        state_4: [{ token: ['meta.odd-tab.spaces', 'meta.even-tab.spaces'], regex: '(  )(  )?' }, { token: 'meta.leading-space', regex: '(?=[^ ])', next: 'start' }, { defaultToken: 'meta.leading-space' }],
        comment: [{ token: 'comment.line.apostrophe.asp', regex: '$|(?=(?:%>))', next: 'start' }, { defaultToken: 'comment.line.apostrophe.asp' }],
        string: [{ token: 'constant.character.escape.apostrophe.asp', regex: '""' }, { token: 'string.quoted.double.asp', regex: '"', next: 'start' }, { defaultToken: 'string.quoted.double.asp' }],
      };
    };
  r.inherits(s, i), (t.VBScriptHighlightRules = s);
}),
  ace.define('ace/mode/vbscript', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/vbscript_highlight_rules'], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      i = e('./text').Mode,
