ace.define('ace/keyboard/vim', ['require', 'exports', 'module', 'ace/range', 'ace/lib/event_emitter', 'ace/lib/dom', 'ace/lib/oop', 'ace/lib/keys', 'ace/lib/event', 'ace/search', 'ace/lib/useragent', 'ace/search_highlight', 'ace/commands/multi_select_commands', 'ace/mode/text', 'ace/multi_select'], function (e, t, n) {
  ...
  function x(e) {
    e.setOption('disableInput', !0), e.setOption('showCursorWhenSelecting', !1), v.signal(e, 'vim-mode-change', { mode: 'normal' }), e.on('cursorActivity', Jn), tt(e), v.on(e.getInputField(), 'paste', M(e));
  }
  function T(e) {
    e.setOption('disableInput', !1), e.off('cursorActivity', Jn), v.off(e.getInputField(), 'paste', M(e)), (e.state.vim = null);
  }
  function N(e, t) {
    this == v.keyMap.vim && v.rmClass(e.getWrapperElement(), 'cm-fat-cursor'), (!t || t.attach != C) && T(e, !1);
  }
  function C(e, t) {
    this == v.keyMap.vim && v.addClass(e.getWrapperElement(), 'cm-fat-cursor'), (!t || t.attach != C) && x(e);
  }
  function k(e, t) {
  ...
  function O(e) {
    ...
    return r ? (X(n) && (t[t.length - 1] = n.toLowerCase()), '<' + t.join('-') + '>') : !1;
  }
  function M(e) {
    var t = e.state.vim;
    return (
      t.onPasteFn ||
        (t.onPasteFn = function () {
          t.insertMode || (e.setCursor(St(e.getCursor(), 0, 1)), yt.enterInsertMode(e, {}, t));
        }),
      t.onPasteFn
    );
  }
  ...
  function et() {
    (this.latestRegister = undefined), (this.isPlaying = !1), (this.isRecording = !1), (this.replaySearchQueries = []), (this.onRecordingDone = undefined), (this.lastInsertModeChanges = Z());
  }
  function tt(e) {
    return e.state.vim || (e.state.vim = { inputState: new ot(), lastEditInputState: undefined, lastEditActionCommand: undefined, lastHPos: -1, lastHSPos: -1, lastMotion: null, marks: {}, fakeCursor: null, insertMode: !1, insertModeRepeat: undefined, visualMode: !1, visualLine: !1, visualBlock: !1, lastSelection: null, lastPastedText: null, sel: {}, options: {} }), e.state.vim;
  }
  function rt() {
    nt = { searchQuery: null, searchIsReversed: !1, lastSubstituteReplacePart: undefined, jumpList: Y(), macroModeState: new et(), lastChararacterSearch: { increment: 0, forward: !0, selectedCharacter: '' }, registerController: new lt({}), searchHistoryController: new ct({}), exCommandHistoryController: new ct({}) };
    for (var e in J) {
      var t = J[e];
  ...
  function lt(e) {
    (this.registers = e), (this.unnamedRegister = e['"'] = new at()), (e['.'] = new at()), (e[':'] = new at()), (e['/'] = new at());
  }
  function ct() {
  ...
  function St(e, t, n) {
    return typeof t == 'object' && ((n = t.ch), (t = t.line)), E(e.line + t, e.ch + n);
  }
  function xt(e, t) {
  ...
  function Tt(e, t, n, r) {
    ...
    for (var u = 0; u < t.length; u++) {
      var a = t[u];
      if ((n == 'insert' && a.context != 'insert') || (a.context && a.context != n) || (r.operator && a.type == 'action') || !(i = Nt(e, a.keys))) continue;
  ...
  function Mt(e, t) {
    return arguments.length > 2 && (t = Mt.apply(undefined, Array.prototype.slice.call(arguments, 1))), Ot(e, t) ? e : t;
  }
  function _t(e, t) {
    return arguments.length > 2 && (t = _t.apply(undefined, Array.prototype.slice.call(arguments, 1))), Ot(e, t) ? t : e;
  }
  function Dt(e, t, n) {
    var r = Ot(e, t),
      i = Ot(t, n);
      ...
      i = function () {
        ...
        if (i) {
          ...
          var h = n.anchorMark.find(),
            ...
            d = p.line - h.line,
            v = p.ch - h.ch;
          (r = { line: r.line + d, ch: d ? r.ch : v + r.ch }), n.visualLine && ((t = E(t.line, 0)), (r = E(r.line, Pt(e, r.line)))), e.setSelection(t, r);
        }
        return [t, r];
      };
  ...
  function Ut(e, t) {
    var n = t.sel.anchor,
      r = t.sel.head;
    t.lastPastedText && ((r = e.posFromIndex(e.indexFromPos(n) + t.lastPastedText.length)), (t.lastPastedText = null)), (t.lastSelection = { anchorMark: e.setBookmark(n), headMark: e.setBookmark(r), anchor: Lt(n), head: Lt(r), visualMode: t.visualMode, visualLine: t.visualLine, visualBlock: t.visualBlock });
  }
  function zt(e, t, n) {
    var r = e.state.vim.sel,
      ...
      s = r.anchor,
      o;
    return Ot(n, t) && ((o = n), (n = t), (t = o)), Ot(i, s) ? ((i = Mt(t, i)), (s = _t(s, n))) : ((s = Mt(t, s)), (i = _t(i, n)), (i = St(i, 0, -1)), i.ch == -1 && i.line != e.firstLine() && (i = E(i.line - 1, Pt(e, i.line - 1)))), [s, i];
  }
  function Wt(e, t, n) {
    var r = e.state.vim;
    t = t || r.sel;
  ...
  function Xt(e, t, n, r) {
    ...
    if (n == 'char') {
      ...
      return (i = St(t.head, 0, o)), (s = St(t.anchor, 0, u)), { ranges: [{ anchor: s, head: i }], primary: 0 };
    }
    if (n == 'line') {
    ...
    if (n == 'block') {
      var f = Math.min(s.line, i.line),
        ...
        d = i.line == f ? 0 : p - 1,
        v = [];
      for (var m = 0; m < p; m++) v.push({ anchor: E(f + m, l), head: E(f + m, h) });
      return { ranges: v, primary: d };
    }
  }
  function Vt(e) {
    var t = e.getCursor('head');
    return e.getSelection().length == 1 && (t = Mt(t, e.getCursor('anchor'))), t;
  }
  function $t(e, t) {
    var n = e.state.vim;
    t !== !1 && e.setCursor(wt(e, n.sel.head)), Ut(e, n), (n.visualMode = !1), (n.visualLine = !1), (n.visualBlock = !1), v.signal(e, 'vim-mode-change', { mode: 'normal' }), n.fakeCursor && n.fakeCursor.clear();
  }
  function Jt(e, t, n) {
    ...
    if (/\n\s*$/.test(r)) {
      ...
      i.pop();
      var s;
      for (var s = i.pop(); i.length > 0 && s && V(s); s = i.pop()) n.line--, (n.ch = 0);
  ...
  function Zt(e, t) {
    (nt.lastChararacterSearch.increment = e), (nt.lastChararacterSearch.forward = t.forward), (nt.lastChararacterSearch.selectedCharacter = t.selectedCharacter);
  }
  function nn(e, t, n, r) {
    var i = Lt(e.getCursor()),
      ...
      a = i.line,
      f = e.getLine(a),
      l = { lineText: f, nextCh: f.charAt(u), lastCh: null, index: u, symb: r, reverseSymb: (n ? { ')': '(', '}': '{' } : { '(': ')', '{': '}' })[r], forward: n, depth: 0, curMoveThrough: !1 },
      c = en[r];
    if (!c) return i;
    var h = tn[c].init,
      p = tn[c].isComplete;
  ...
  function sn(e, t, n, r, i, s) {
    ...
    var h = u.length != n,
      p = u[0],
      d = u.pop();
    return r && !i ? (!h && (p.from != o.ch || p.line != o.line) && (d = u.pop()), E(d.line, d.from)) : r && i ? E(d.line, d.to - 1) : !r && i ? (!h && (p.to != o.ch || p.line != o.line) && (d = u.pop()), E(d.line, d.to)) : E(d.line, d.from);
  }
  function on(e, t, n, r) {
    var i = e.getCursor(),
      s = i.ch,
  ...
  function cn(e, t, n, r) {
    var i = t,
      ...
      l = f === a ? 1 : 0;
    (s = e.scanForBracket(E(i.line, i.ch + l), -1, null, { bracketRegex: u })), (o = e.scanForBracket(E(i.line, i.ch + l), 1, null, { bracketRegex: u }));
  ...
  function hn(e, t, n, r) {
    ...
    return !u || !a ? { start: i, end: i } : (r && (--u, ++a), { start: E(i.line, u), end: E(i.line, a) });
  }
  function pn() {}
  function dn(e) {
    var t = e.state.vim;
  ...
  function vn(e, t, n, r, i) {
    e.openDialog ? e.openDialog(t, r, { bottom: !0, value: i.value, onKeyDown: i.onKeyDown, onKeyUp: i.onKeyUp, selectValueOnOpen: !1 }) : r(prompt(n, ''));
  }
  function mn(e) {
    var t = gn(e) || [];
    if (!t.length) return [];
  ...
  function wn(e) {
    ...
    for (var r = -1; r < e.length; r++) {
      var i = e.charAt(r) || '',
        s = e.charAt(r + 1) || '';
      bn[i + s] ? (n.push(bn[i + s]), r++) : t ? (n.push(i), (t = !1)) : i === '\\' ? ((t = !0), W(s) || s === '$' ? n.push('$') : s !== '/' && s !== '\\' && n.push('\\')) : (i === '$' && n.push('$'), n.push(i), s === '/' && n.push('\\'));
    }
    return n.join('');
  }
  function Sn(e) {
  ...
  function Tn(e, t) {
    e.openNotification ? e.openNotification('<span style="color: red">' + t + '</span>', { bottom: !0, duration: 5e3 }) : alert(t);
  }
  function Nn(e, t) {
    var n = '';
  ...
  function Mn(e, t) {
    var n = dn(e),
      r = n.getOverlay();
    if (!r || t != r.query) r && e.removeOverlay(r), (r = On(t)), e.addOverlay(r), e.showMatchesOnScrollbar && (n.getScrollbarAnnotate() && n.getScrollbarAnnotate().clear(), n.setScrollbarAnnotate(e.showMatchesOnScrollbar(t))), n.setOverlay(r);
  }
  function _n(e, t, n, r) {
    return (
      r === undefined && (r = 1),
  ...
  function Dn(e) {
    var t = dn(e);
    e.removeOverlay(dn(e).getOverlay()), t.setOverlay(null), t.getScrollbarAnnotate() && (t.getScrollbarAnnotate().clear(), t.setScrollbarAnnotate(null));
  }
  function Pn(e, t, n) {
    return typeof e != 'number' && (e = e.line), t instanceof Array ? $(e, t) : n ? e >= t && e <= n : e == t;
  }
  function Hn(e) {
  ...
  function In(e, t, n, r, i, s, o, u, a) {
    ...
    kn(e, { prefix: 'replace with <strong>' + u + '</strong> (y/n/a/q/l)', onKeyDown: m });
  }
  function qn(e) {
    var t = e.state.vim,
      n = nt.macroModeState,
  ...
  function zn(e, t, n, r) {
    ...
    if (r == ':') {
      i.keyBuffer[0] && Fn.processCommand(e, i.keyBuffer[0]), (n.isPlaying = !1);
      return;
    }
    var s = i.keyBuffer,
      o = 0;
    ...
    for (var u = 0; u < s.length; u++) {
      ...
      while (a) {
        ...
        if (t.insertMode) {
          ...
          (nt.macroModeState.lastInsertModeChanges.changes = c), er(e, c, 1), qn(e);
        }
      }
    }
    n.isPlaying = !1;
    ...
    if (!n.isPlaying)
      while (t) {
        ...
        if (t.origin == '+input' || t.origin == 'paste' || t.origin === undefined) {
          var i = t.text.join('\n');
          r.maybeReset && ((r.changes = []), (r.maybeReset = !1)), r.changes.push(i);
        }
        t = t.next;
      }
  }
  ...
  function Qn(e, t) {
    var n = e.getCursor('anchor'),
      r = e.getCursor('head');
    t.visualMode && !e.somethingSelected() ? $t(e, !1) : !t.visualMode && !t.insertMode && e.somethingSelected() && ((t.visualMode = !0), (t.visualLine = !1), v.signal(e, 'vim-mode-change', { mode: 'visual' }));
    if (t.visualMode) {
      var i = Ot(r, n) ? 0 : -1,
        s = Ot(r, n) ? -1 : 0;
      (r = St(r, 0, i)), (n = St(n, 0, s)), (t.sel = { anchor: n, head: r }), an(e, t, '<', Mt(r, n)), an(e, t, '>', _t(r, n));
  ...
  function Yn(e) {
    function i() {
      return n.maybeReset && ((n.changes = []), (n.maybeReset = !1)), n.changes.push(new Gn(r)), !0;
    }
  ...
  function er(e, t, n, r) {
    ...
    if (o) {
      ...
      It(e, s, f.line + 1), (n = e.listSelections().length), e.setCursor(s);
    }
    for (var l = 0; l < n; l++) {
      o && e.setCursor(St(s, l, 0));
      for (var c = 0; c < t.length; c++) {
        var h = t[c];
        if (h instanceof Gn) v.lookupKey(h.keyName, 'vim-insert', i);
        else {
          var p = e.getCursor(),
            d = p;
          r && !/\n/.test(h) && (d = St(p, 0, h.length)), e.replaceRange(h, p, d);
        }
      }
    }
  ...
  function nr(e, t, n) {
    t.length > 1 && t[0] == 'n' && (t = t.replace('numpad', '')), (t = tr[t] || t);
    var r = '';
  ...
  function ir(e) {
    ...
    return (
      Object.keys(e).forEach(function (n) {
        var r = e[n];
        Array.isArray(r) ? (r = r.slice()) : r && typeof r == 'object' && r.constructor != Object && (r = ir(r)), (t[n] = r);
      }),
      e.sel && (t.sel = { head: e.sel.head && Lt(e.sel.head), anchor: e.sel.anchor && Lt(e.sel.anchor) }),
      t
    );
  }
  function sr(e, t, n) {
    ...
    else if (s || !e.ace.inMultiSelectMode || e.ace.inVirtualSelectionMode) r = S.handleKey(e, t, n);
    else {
      var o = ir(i);
      e.operation(function () {
        e.ace.forEachSelection(function () {
          ...
          var s = e.getCursor('head'),
            ...
            a = Ot(s, u) ? 0 : -1,
            f = Ot(s, u) ? -1 : 0;
          (s = St(s, 0, a)), (u = St(u, 0, f)), (e.state.vim.sel.head = s), (e.state.vim.sel.anchor = u), (r = rr(e, t, n)), (i.$desiredColumn = e.state.vim.lastHPos == -1 ? null : e.state.vim.lastHPos), e.virtualSelectionMode() && (e.state.vim = ir(o));
        }),
    ...
    function () {
      u.implement(v.prototype, s),
        ...
        (this.onChange = function (e) {
          ...
          n.changeHandlers || (n.changeHandlers = this._eventRegistry.change && this._eventRegistry.change.slice());
          if (this.virtualSelectionMode()) return;
          n.lastChange ? (n.lastChange.next = n.lastChange = t) : (n.lastChange = n.change = t), this.$updateMarkers(e);
        }),
        ...
        (this.setCursor = function (e, t) {
          typeof e == 'object' && ((t = e.ch), (e = e.line)), this.ace.inVirtualSelectionMode || this.ace.exitMultiSelectMode(), this.ace.session.unfold({ row: e, column: t }), this.ace.selection.moveTo(e, t);
        }),
      ...
      var t = { indentWithTabs: 'useSoftTabs', indentUnit: 'tabSize', tabSize: 'tabSize', firstLineNumber: 'firstLineNumber', readOnly: 'readOnly' };
  ...
  var b = [
      ...
      { keys: 'Y', type: 'operatorMotion', operator: 'yank', motion: 'moveToEol', motionArgs: { inclusive: !0 }, context: 'normal' },
      ...
      { keys: 'R', type: 'action', action: 'enterInsertMode', isEdit: !0, actionArgs: { replace: !0 } },
    ...
    w = [{ name: 'colorscheme', shortName: 'colo' }, { name: 'map' }, { name: 'imap', shortName: 'im' }, { name: 'nmap', shortName: 'nm' }, { name: 'vmap', shortName: 'vm' }, { name: 'unmap' }, { name: 'write', shortName: 'w' }, { name: 'undo', shortName: 'u' }, { name: 'redo', shortName: 'red' }, { name: 'set', shortName: 'se' }, { name: 'set', shortName: 'se' }, { name: 'setlocal', shortName: 'setl' }, { name: 'setglobal', shortName: 'setg' }, { name: 'sort', shortName: 'sor' }, { name: 'substitute', shortName: 's', possiblyAsync: !0 }, { name: 'nohlsearch', shortName: 'noh' }, { name: 'delmarks', shortName: 'delm' }, { name: 'registers', shortName: 'reg', excludeFromCommandHistory: !0 }, { name: 'global', shortName: 'g' }],
    E = v.Pos,
    S = function () {
      return st;
    };
  ...
  var Y = function () {
    ...
    Z = function (e) {
      return e ? { changes: e.changes, expectCursorActivityForChange: e.expectCursorActivityForChange } : { changes: [], expectCursorActivityForChange: !1 };
    };
  et.prototype = {
  ...
  var nt,
    ...
    st = {
      ...
      defineEx: function (e, t, n) {
        if (!t) t = e;
        else if (e.indexOf(t) !== 0) throw new Error('(Vim.defineEx) "' + t + '" is not a prefix of "' + e + '", command not registered');
        (jn[e] = n), (Fn.commandMap_[t] = { name: e, shortName: t, type: 'api' });
      },
      ...
      findKey: function (e, t, n) {
        ...
        function s() {
          if (t == '<Esc>') return ut(e), r.visualMode ? $t(e) : r.insertMode && qn(e), !0;
        }
        function o(n) {
          var r;
            ...
            : function () {
                ...
                return e.operation(function () {
                  ...
                  try {
                    ...
                    throw ((e.state.vim = undefined), tt(e), v.Vim.suppressErrorLogging || console.log(t), t);
                  }
                  return !0;
                });
              }
  ...
  (ot.prototype.pushRepeatDigit = function (e) {
    ...
    (lt.prototype = {
      pushText: function (e, t, n, r, i) {
        ...
        if (!s) {
          switch (t) {
            ...
            case 'delete':
            case 'change':
              n.indexOf('\n') == -1 ? (this.registers['-'] = new at(n, r)) : (this.shiftNumericRegisters_(), (this.registers[1] = new at(n, r)));
          }
      ...
      getRegister: function (e) {
        return this.isValidRegister(e) ? ((e = e.toLowerCase()), this.registers[e] || (this.registers[e] = new at()), this.registers[e]) : this.unnamedRegister;
      },
  ...
  var ht = {
      ...
      processMotion: function (e, t, n) {
        (t.inputState.motion = n.motion), (t.inputState.motionArgs = Et(n.motionArgs)), this.evalInput(e, t);
      },
      processOperator: function (e, t, n) {
        ...
        (r.operator = n.operator), (r.operatorArgs = Et(n.operatorArgs)), t.visualMode && this.evalInput(e, t);
      },
      ...
      processAction: function (e, t, n) {
        var r = t.inputState,
          ...
          s = !!i,
          o = Et(n.actionArgs) || {};
        r.selectedCharacter && (o.selectedCharacter = r.selectedCharacter), n.operator && this.processOperator(e, t, n), n.motion && this.processMotion(e, t, n), (n.motion || n.operator) && this.evalInput(e, t), (o.repeat = i || 1), (o.repeatIsExplicit = s), (o.registerName = r.registerName), ut(e), (t.lastMotion = null), n.isEdit && this.recordLastEdit(t, r, n), yt[n.action](e, o, t);
      },
      processSearch: function (e, t, n) {
        function a(r, i, s) {
          nt.searchHistoryController.pushInput(r), nt.searchHistoryController.reset();
          try {
            An(e, r, i, s);
          } catch (o) {
          ...
          ht.processMotion(e, t, { type: 'motion', motion: 'findNext', motionArgs: { forward: !0, toJumplist: n.searchArgs.toJumplist } });
        }
        function f(t) {
        ...
        function l(t, n, i) {
          var s = v.keyName(t),
            o;
          s == 'Up' || s == 'Down' ? ((o = s == 'Up' ? !0 : !1), (n = nt.searchHistoryController.nextMatch(n, o) || ''), i(n)) : s != 'Left' && s != 'Right' && s != 'Ctrl' && s != 'Alt' && s != 'Shift' && nt.searchHistoryController.reset();
          var a;
          try {
            a = An(e, n, !0, !0);
          } catch (t) {}
          a ? e.scrollIntoView(_n(e, !r, a), 30) : (Dn(e), e.scrollTo(u.left, u.top));
        }
        function c(t, n, r) {
          var i = v.keyName(t);
          i == 'Esc' || i == 'Ctrl-C' || i == 'Ctrl-[' || (i == 'Backspace' && n == '') ? (nt.searchHistoryController.pushInput(n), nt.searchHistoryController.reset(), An(e, o), Dn(e), e.scrollTo(u.left, u.top), v.e_stop(t), ut(e), r(), e.focus()) : i == 'Ctrl-U' && (v.e_stop(t), r(''));
        }
        ...
        switch (n.searchArgs.querySrc) {
          case 'prompt':
            ...
            if (h.isPlaying) {
              ...
              a(p, !0, !1);
            } else kn(e, { onClose: f, prefix: s, desc: Cn, onKeyUp: l, onKeyDown: c });
            break;
          case 'wordUnderCursor':
            ...
            m && i ? (p = '\\b' + p + '\\b') : (p = Bt(p)), (nt.jumpList.cachedCursor = e.getCursor()), e.setCursor(d.start), a(p, !0, !1);
        }
      },
      processEx: function (e, t, n) {
        function r(t) {
          nt.exCommandHistoryController.pushInput(t), nt.exCommandHistoryController.reset(), Fn.processCommand(e, t);
        }
        function i(t, n, r) {
          var i = v.keyName(t),
            s;
          if (i == 'Esc' || i == 'Ctrl-C' || i == 'Ctrl-[' || (i == 'Backspace' && n == '')) nt.exCommandHistoryController.pushInput(n), nt.exCommandHistoryController.reset(), v.e_stop(t), ut(e), r(), e.focus();
          i == 'Up' || i == 'Down' ? ((s = i == 'Up' ? !0 : !1), (n = nt.exCommandHistoryController.nextMatch(n, s) || ''), r(n)) : i == 'Ctrl-U' ? (v.e_stop(t), r('')) : i != 'Left' && i != 'Right' && i != 'Ctrl' && i != 'Alt' && i != 'Shift' && nt.exCommandHistoryController.reset();
        }
        n.type == 'keyToEx' ? Fn.processCommand(e, n.exArgs.input) : t.visualMode ? kn(e, { onClose: r, prefix: ':', value: "'<,'>", onKeyDown: i }) : kn(e, { onClose: r, prefix: ':', onKeyDown: i });
      },
      evalInput: function (e, t) {
        ...
        n.selectedCharacter && (i.selectedCharacter = o.selectedCharacter = n.selectedCharacter), (i.repeat = v), ut(e);
        if (r) {
          var m = pt[r](e, f, i, t);
          t.lastMotion = pt[r];
          if (!m) return;
          ...
          m instanceof Array ? ((d = m[0]), (p = m[1])) : (p = m), p || (p = Lt(f));
          if (t.visualMode) {
            if (!t.visualBlock || p.ch !== Infinity) p = wt(e, p, t.visualBlock);
            d && (d = wt(e, d, !0)), (d = d || h), (a.anchor = d), (a.head = p), Wt(e), an(e, t, '<', Ot(d, p) ? d : p), an(e, t, '>', Ot(d, p) ? p : d);
        ...
        if (s) {
          if (o.lastSel) {
            ...
            b.visualLine ? (p = E(h.line + w, h.ch)) : b.visualBlock ? (p = E(h.line + w, h.ch + S)) : b.head.line == b.anchor.line ? (p = E(h.line, h.ch + S)) : (p = E(h.line + w, h.ch)), (t.visualMode = !0), (t.visualLine = b.visualLine), (t.visualBlock = b.visualBlock), (a = t.sel = { anchor: d, head: p }), Wt(e);
          } else t.visualMode && (o.lastSel = { anchor: Lt(a.anchor), head: Lt(a.head), visualBlock: t.visualBlock, visualLine: t.visualLine });
          var x, T, N, C, k;
          if (t.visualMode) {
            (x = Mt(a.head, a.anchor)), (T = _t(a.head, a.anchor)), (N = t.visualLine || o.linewise), (C = t.visualBlock ? 'block' : N ? 'line' : 'char'), (k = Xt(e, { anchor: x, head: T }, C));
            if (N) {
              var L = k.ranges;
              if (C == 'block') for (var A = 0; A < L.length; A++) L[A].head.ch = Pt(e, L[A].head.line);
            ...
            (N = i.linewise || o.linewise), N ? Kt(e, x, T) : i.forward && Jt(e, x, T), (C = 'char');
            var M = !i.inclusive || N;
    ...
    pt = {
      ...
      moveByLines: function (e, t, n, r) {
        ...
        return l && (n.forward ? u > l.start.row && (u = l.end.row + 1) : (u = l.start.row)), n.toFirstChar && ((s = Qt(e.getLine(u))), (r.lastHPos = s)), (r.lastHSPos = e.charCoords(E(u, s), 'div').left), E(u, s);
      },
      ...
      moveToColumn: function (e, t, n, r) {
        var i = n.repeat;
        return (r.lastHPos = i - 1), (r.lastHSPos = e.charCoords(t, 'div').left), un(e, i);
      },
      ...
      moveToLineOrEdgeOfDocument: function (e, t, n) {
        ...
        return n.repeatIsExplicit && (r = n.repeat - e.getOption('firstLineNumber')), E(r, Qt(e.getLine(r)));
      },
    ...
    mt = {
      change: function (e, t, n) {
        ...
        if (!s.visualMode) {
          ...
          if (a.motion == 'moveByWords' && !V(i)) {
            var f = /\s+$/.exec(i);
            f && a.motionArgs && a.motionArgs.forward && ((u = St(u, 0, -f[0].length)), (i = i.slice(0, -f[0].length)));
          }
        ...
        nt.registerController.pushText(t.registerName, 'change', i, t.linewise, n.length > 1), yt.enterInsertMode(e, { head: r }, e.state.vim);
      },
      delete: function (e, t, n) {
        ...
        if (!s.visualBlock) {
          var o = n[0].anchor,
            u = n[0].head;
          t.linewise && u.line != e.firstLine() && o.line == e.lastLine() && o.line == u.line - 1 && (o.line == e.firstLine() ? (o.ch = 0) : (o = E(o.line - 1, Pt(e, o.line - 1)))), (i = e.getRange(o, u)), e.replaceRange('', o, u), (r = o), t.linewise && (r = pt.moveToFirstNonWhiteSpaceCharacter(e, o));
        } else {
          i = e.getSelection();
          var a = vt('', n.length);
          e.replaceSelections(a), (r = n[0].anchor);
        }
        return nt.registerController.pushText(t.registerName, 'delete', i, t.linewise, s.visualBlock), wt(e, r);
      },
      ...
      changeCase: function (e, t, n, r, i) {
        ...
        return e.replaceSelections(o), t.shouldMoveCursor ? i : !e.state.vim.visualMode && t.linewise && n[0].anchor.line + 1 == n[0].head.line ? pt.moveToFirstNonWhiteSpaceCharacter(e, r) : t.linewise ? r : Mt(n[0].anchor, n[0].head);
      },
      yank: function (e, t, n, r) {
        var i = e.state.vim,
          s = e.getSelection(),
          o = i.visualMode ? Mt(i.sel.anchor, i.sel.head, n[0].head, n[0].anchor) : r;
        return nt.registerController.pushText(t.registerName, 'yank', s, t.linewise, i.visualBlock), o;
      },
    },
    yt = {
      ...
      enterInsertMode: function (e, t, n) {
        ...
        else if (r == 'firstNonBlank') s = pt.moveToFirstNonWhiteSpaceCharacter(e, s);
        else if (r == 'startOfSelectedArea') n.visualBlock ? ((s = E(Math.min(i.head.line, i.anchor.line), Math.min(i.head.ch, i.anchor.ch))), (o = Math.abs(i.head.line - i.anchor.line) + 1)) : i.head.line < i.anchor.line ? (s = i.head) : (s = E(i.anchor.line, 0));
        else if (r == 'endOfSelectedArea') n.visualBlock ? ((s = E(Math.min(i.head.line, i.anchor.line), Math.max(i.head.ch + 1, i.anchor.ch))), (o = Math.abs(i.head.line - i.anchor.line) + 1)) : i.head.line >= i.anchor.line ? (s = St(i.head, 0, 1)) : (s = E(i.anchor.line, 0));
        else if (r == 'inplace' && n.visualMode) return;
        e.setOption('keyMap', 'vim-insert'), e.setOption('disableInput', !1), t && t.replace ? (e.toggleOverwrite(!0), e.setOption('keyMap', 'vim-replace'), v.signal(e, 'vim-mode-change', { mode: 'replace' })) : (e.setOption('keyMap', 'vim-insert'), v.signal(e, 'vim-mode-change', { mode: 'insert' })), nt.macroModeState.isPlaying || (e.on('change', $n), v.on(e.getInputField(), 'keydown', Yn)), n.visualMode && $t(e), It(e, s, o);
      },
      toggleVisualMode: function (e, t, n) {
        var r = t.repeat,
          i = e.getCursor(),
          s;
        n.visualMode ? (n.visualLine ^ t.linewise || n.visualBlock ^ t.blockwise ? ((n.visualLine = !!t.linewise), (n.visualBlock = !!t.blockwise), v.signal(e, 'vim-mode-change', { mode: 'visual', subMode: n.visualLine ? 'linewise' : n.visualBlock ? 'blockwise' : '' }), Wt(e)) : $t(e)) : ((n.visualMode = !0), (n.visualLine = !!t.linewise), (n.visualBlock = !!t.blockwise), (s = wt(e, E(i.line, i.ch + r - 1), !0)), (n.sel = { anchor: i, head: s }), v.signal(e, 'vim-mode-change', { mode: 'visual', subMode: n.visualLine ? 'linewise' : n.visualBlock ? 'blockwise' : '' }), Wt(e), an(e, n, '<', Mt(i, s)), an(e, n, '>', _t(i, s)));
      },
      reselectLastSelection: function (e, t, n) {
        ...
        if (r) {
          var i = r.anchorMark.find(),
            s = r.headMark.find();
          if (!i || !s) return;
          (n.sel = { anchor: i, head: s }), (n.visualMode = !0), (n.visualLine = r.visualLine), (n.visualBlock = r.visualBlock), Wt(e), an(e, n, '<', Mt(i, s)), an(e, n, '>', _t(i, s)), v.signal(e, 'vim-mode-change', { mode: 'visual', subMode: n.visualLine ? 'linewise' : n.visualBlock ? 'blockwise' : '' });
        }
      },
      ...
      newLineAndEnterInsertMode: function (e, t, n) {
        ...
        if (r.line === e.firstLine() && !t.after) e.replaceRange('\n', E(e.firstLine(), 0)), e.setCursor(e.firstLine(), 0);
        else {
          (r.line = t.after ? r.line : r.line - 1), (r.ch = Pt(e, r.line)), e.setCursor(r);
      ...
      paste: function (e, t, n) {
        ...
        var p = i.linewise,
          d = i.blockwise;
        if (p && !d) n.visualMode ? (s = n.visualLine ? s.slice(0, -1) : '\n' + s.slice(0, s.length - 1) + '\n') : t.after ? ((s = '\n' + s.slice(0, s.length - 1)), (r.ch = Pt(e, r.line))) : (r.ch = 0);
        else {
          if (d) {
            s = s.split('\n');
        ...
        if (n.visualMode) {
          ...
          n.lastSelection && (y = n.lastSelection.headMark.find()), nt.registerController.unnamedRegister.setText(x), d ? (e.replaceSelections(N), (S = E(w.line + s.length - 1, w.ch)), e.setCursor(w), Ft(e, S), e.replaceSelections(s), (m = w)) : n.visualBlock ? (e.replaceSelections(N), e.setCursor(w), e.replaceRange(s, w, w), (m = w)) : (e.replaceRange(s, w, S), (m = e.posFromIndex(e.indexFromPos(w) + s.length - 1))), y && (n.lastSelection.headMark = e.setBookmark(y)), p && (m.ch = 0);
        } else if (d) {
          e.setCursor(r);
          ...
          e.setCursor(r), Ft(e, E(r.line + s.length - 1, r.ch)), e.replaceSelections(s), (m = r);
        } else e.replaceRange(s, r), p && t.after ? (m = E(r.line + 1, Qt(e.getLine(r.line + 1)))) : p && !t.after ? (m = E(r.line, Qt(e.getLine(r.line)))) : !p && t.after ? ((g = e.indexFromPos(r)), (m = e.posFromIndex(g + s.length - 1))) : ((g = e.indexFromPos(r)), (m = e.posFromIndex(g + s.length)));
        n.visualMode && $t(e, !1), e.setCursor(m);
      },
      undo: function (e, t) {
        e.operation(function () {
          kt(e, v.commands.undo, t.repeat)(), e.setCursor(e.getCursor('anchor'));
        });
      },
      redo: function (e, t) {
      ...
      replace: function (e, t, n) {
        ...
        if (n.visualMode) (i = e.getCursor('start')), (o = e.getCursor('end'));
          ...
          var a = e.getLine(i.line);
          (s = i.ch + t.repeat), s > a.length && (s = a.length), (o = E(i.line, s));
        }
        if (r == '\n') n.visualMode || e.replaceRange('', i, o), (v.commands.newlineAndIndentContinueComment || v.commands.newlineAndIndent)(e);
          ...
          n.visualMode ? ((i = Ot(u[0].anchor, u[0].head) ? u[0].anchor : u[0].head), e.setCursor(i), $t(e, !1)) : e.setCursor(St(o, 0, -1));
        }
      },
      incrementNumberToken: function (e, t) {
        ...
        var l = t.increase ? 1 : -1,
          ...
          h = E(n.line, o),
          p = E(n.line, u);
        (a = c.toString()), e.replaceRange(a, h, p), e.setCursor(E(n.line, o + a.length - 1));
      },
      repeatLastEdit: function (e, t, n) {
        var r = n.lastEditInputState;
        if (!r) return;
        var i = t.repeat;
        i && t.repeatIsExplicit ? (n.lastEditInputState.repeatOverride = i) : (i = n.lastEditInputState.repeatOverride || i), Zn(e, n, i, !1);
      },
      exitInsertMode: qn,
    },
    en = { '(': 'bracket', ')': 'bracket', '{': 'bracket', '}': 'bracket', '[': 'section', ']': 'section', '*': 'comment', '/': 'comment', m: 'method', M: 'method', '#': 'preprocess' },
    tn = {
      bracket: {
  ...
  var jn = {
      ...
      move: function (e, t) {
        ht.processCommand(e, e.state.vim, { type: 'motion', motion: 'moveToLineOrEdgeOfDocument', motionArgs: { forward: !1, explicitRepeat: !0, linewise: !0 }, repeatOverride: t.line + 1 });
      },
      set: function (e, t) {
        var n = t.args,
          r = t.setCfg || {};
      ...
      sort: function (e, t) {
        ...
        if (i) {
          var w = h,
            S;
          h = [];
          for (var y = 0; y < w.length; y++) w[y] != S && h.push(w[y]), (S = w[y]);
        }
      ...
      substitute: function (e, t) {
        ...
        var n = t.argString,
          ...
          f = !1,
          l = !1;
        if (r.length) (i = r[0]), (s = r[1]), s !== undefined && (G('pcre') ? (s = Sn(s)) : (s = wn(s)), (nt.lastSubstituteReplacePart = s)), (o = r[2] ? r[2].split(' ') : []);
        else if (n && n.length) {
  ...
  (v.keyMap.vim = { attach: C, detach: N, call: k }),
    ...
    (v.keyMap['vim-replace'] = { Backspace: 'goCharLeft', fallthrough: ['vim-insert'], attach: C, detach: N, call: k }),
    rt(),
    (v.Vim = S()),
    (S = v.Vim);
  var tr = { return: 'CR', backspace: 'BS', delete: 'Del', esc: 'Esc', left: 'Left', right: 'Right', up: 'Up', down: 'Down', space: 'Space', home: 'Home', end: 'End', pageup: 'PageUp', pagedown: 'PageDown', enter: 'CR' },
  ...
  t.handler = {
    ...
    handleKeyboard: function (e, t, n, r, i) {
      ...
      if (t == -1 || t & 1 || (t === 0 && n.length > 1)) {
        ...
        var l = sr(o, f, 'user');
        (u = or(o)), l && u.status != null ? (u.status += f) : u.status == null && (u.status = ''), o._signal('changeStatus');
        if (!l && (t != -1 || a)) return;
    ...
    attach: function (e) {
      ...
      (e.state.cm = t),
        ...
        t.on('vim-command-done', function () {
          ...
          (or(t).status = null), t.ace._signal('changeStatus'), t.ace.session.markUndoGroup();
        }),
        ...
        t.on('vim-mode-change', function () {
          if (t.virtualSelectionMode()) return;
          t.ace.renderer.setStyle('normal-mode', !or(t).insertMode), t._signal('changeStatus');
        }),
  ...
  S.defineOption(
    ...
    b.push({ keys: 'zc', type: 'action', action: 'fold', actionArgs: { open: !1 } }, { keys: 'zC', type: 'action', action: 'fold', actionArgs: { open: !1, all: !0 } }, { keys: 'zo', type: 'action', action: 'fold', actionArgs: { open: !0 } }, { keys: 'zO', type: 'action', action: 'fold', actionArgs: { open: !0, all: !0 } }, { keys: 'za', type: 'action', action: 'fold', actionArgs: { toggle: !0 } }, { keys: 'zA', type: 'action', action: 'fold', actionArgs: { toggle: !0, all: !0 } }, { keys: 'zf', type: 'action', action: 'fold', actionArgs: { open: !0, all: !0 } }, { keys: 'zd', type: 'action', action: 'fold', actionArgs: { open: !0, all: !0 } }, { keys: '<C-A-k>', type: 'action', action: 'aceCommand', actionArgs: { name: 'addCursorAbove' } }, { keys: '<C-A-j>', type: 'action', action: 'aceCommand', actionArgs: { name: 'addCursorBelow' } }, { keys: '<C-A-S-k>', type: 'action', action: 'aceCommand', actionArgs: { name: 'addCursorAboveSkipCurrent' } }, { keys: '<C-A-S-j>', type: 'action', action: 'aceCommand', actionArgs: { name: 'addCursorBelowSkipCurrent' } }, { keys: '<C-A-h>', type: 'action', action: 'aceCommand', actionArgs: { name: 'selectMoreBefore' } }, { keys: '<C-A-l>', type: 'action', action: 'aceCommand', actionArgs: { name: 'selectMoreAfter' } }, { keys: '<C-A-S-h>', type: 'action', action: 'aceCommand', actionArgs: { name: 'selectNextBefore' } }, { keys: '<C-A-S-l>', type: 'action', action: 'aceCommand', actionArgs: { name: 'selectNextAfter' } }),
    (yt.aceCommand = function (e, t, n) {
      (e.vimCmd = t), e.ace.inVirtualSelectionMode ? e.ace.on('beforeEndOperation', ar) : ar(null, e.ace);
    }),
