ace.define('ace/mode/eiffel_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (e, t, n) {
  'use strict';
  var r = e('../lib/oop'),
    ...
    s = function () {
      var e = 'across|agent|alias|all|attached|as|assign|attribute|check|class|convert|create|debug|deferred|detachable|do|else|elseif|end|ensure|expanded|export|external|feature|from|frozen|if|inherit|inspect|invariant|like|local|loop|not|note|obsolete|old|once|Precursor|redefine|rename|require|rescue|retry|select|separate|some|then|undefine|until|variant|when',
        ...
        r = 'True|False',
        i = 'Current|Result',
        s = this.createKeywordMapper({ 'constant.language': n, 'constant.language.boolean': r, 'variable.language': i, 'keyword.operator': t, keyword: e }, 'identifier', !0),
        o = /(?:[^"%\b\f\v]|%[A-DFHLNQR-V%'"()<>]|%\/(?:0[xX][\da-fA-F](?:_*[\da-fA-F])*|0[cC][0-7](?:_*[0-7])*|0[bB][01](?:_*[01])*|\d(?:_*\d)*)\/)+?/;
      this.$rules = {
        start: [
          { token: 'string.quoted.other', regex: /"\[/, next: 'aligned_verbatim_string' },
          { token: 'string.quoted.other', regex: /"\{/, next: 'non-aligned_verbatim_string' },
          { token: 'string.quoted.double', regex: /"(?:[^%\b\f\n\r\v]|%[A-DFHLNQR-V%'"()<>]|%\/(?:0[xX][\da-fA-F](?:_*[\da-fA-F])*|0[cC][0-7](?:_*[0-7])*|0[bB][01](?:_*[01])*|\d(?:_*\d)*)\/)*?"/ },
          { token: 'comment.line.double-dash', regex: /--.*/ },
          { token: 'constant.character', regex: /'(?:[^%\b\f\n\r\t\v]|%[A-DFHLNQR-V%'"()<>]|%\/(?:0[xX][\da-fA-F](?:_*[\da-fA-F])*|0[cC][0-7](?:_*[0-7])*|0[bB][01](?:_*[01])*|\d(?:_*\d)*)\/)'/ },
          { token: 'constant.numeric', regex: /\b0(?:[xX][\da-fA-F](?:_*[\da-fA-F])*|[cC][0-7](?:_*[0-7])*|[bB][01](?:_*[01])*)\b/ },
          { token: 'constant.numeric', regex: /(?:\d(?:_*\d)*)?\.(?:(?:\d(?:_*\d)*)?[eE][+-]?)?\d(?:_*\d)*|\d(?:_*\d)*\.?/ },
  ...
  ace.define('ace/mode/eiffel', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/eiffel_highlight_rules'], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      i = e('./text').Mode,
