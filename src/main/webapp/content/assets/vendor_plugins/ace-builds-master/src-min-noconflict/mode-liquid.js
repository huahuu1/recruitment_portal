ace.define('ace/mode/css_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules'], function (e, t, n) {
    ...
    var r = e('../lib/oop'),
      ...
      o = function () {
        ...
        var e = 'date|capitalize|downcase|upcase|first|last|join|sort|map|size|escape|escape_once|strip_html|strip_newlines|newline_to_br|replace|replace_first|truncate|truncatewords|prepend|append|minus|plus|times|divided_by|split',
          ...
          n = 'forloop|tablerowloop',
          r = 'assign',
          i = this.createKeywordMapper({ 'variable.language': n, keyword: t, 'support.function': e, 'keyword.definition': r }, 'identifier');
  ...
  ace.define('ace/mode/liquid', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/liquid_highlight_rules', 'ace/mode/matching_brace_outdent'], function (e, t, n) {
    var r = e('../lib/oop'),
      i = e('./text').Mode,
      s = e('./liquid_highlight_rules').LiquidHighlightRules,
