ace.define('ace/mode/elm_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (e, t, n) {
  'use strict';
  var r = e('../lib/oop'),
    ...
    s = function () {
      ...
      (this.$rules = {
        start: [
          ...
          { regex: /0(?:[xX][0-9A-Fa-f]+|[oO][0-7]+)|\d+(\.\d+)?([eE][-+]?\d*)?/, token: 'constant.numeric' },
          { token: 'comment', regex: '--.*' },
          { token: 'keyword', regex: /\.\.|\||:|=|\\|"|->|<-|\u2192/ },
        ...
        blockComment: [{ regex: '{-', token: 'comment.start', push: 'blockComment' }, { regex: '-}', token: 'comment.end', next: 'pop' }, { defaultToken: 'comment' }],
        docComment: [{ regex: '{-', token: 'comment.start', push: 'docComment' }, { regex: '-}', token: 'comment.end', next: 'pop' }, { defaultToken: 'doc.comment' }],
        string: [{ token: 'constant.language.escape', regex: t }, { token: 'text', regex: /\\(\s|$)/, next: 'stringGap' }, { token: 'string.end', regex: '"', next: 'start' }, { defaultToken: 'string' }],
        stringGap: [
  ...
  ace.define('ace/mode/elm', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/elm_highlight_rules', 'ace/mode/folding/cstyle'], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      i = e('./text').Mode,
