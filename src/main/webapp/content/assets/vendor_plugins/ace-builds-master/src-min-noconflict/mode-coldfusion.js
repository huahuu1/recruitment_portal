  ...
  ace.define('ace/mode/coldfusion_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/javascript_highlight_rules', 'ace/mode/html_highlight_rules'], function (e, t, n) {
    ...
    var r = e('../lib/oop'),
      ...
      o = function () {
        ...
        this.embedRules({ cfmlComment: [{ regex: '<!---', token: 'comment.start', push: 'cfmlComment' }, { regex: '--->', token: 'comment.end', next: 'pop' }, { defaultToken: 'comment' }] }, '', [{ regex: '<!---', token: 'comment.start', push: 'cfmlComment' }], ['comment', 'start', 'tag_whitespace', 'cdata'].concat(e)), (this.$rules.cfTag = [{ include: 'attributes' }, { token: 'meta.tag.punctuation.tag-close.xml', regex: '/?>', next: 'pop' }]);
        var t = {
          token: function (e, t) {
        ...
        e.forEach(function (e) {
          ...
          this.embedTagRules(new i({ jsx: !1 }).getRules(), 'cfjs-', 'cfscript'),
          this.normalizeRules();
      };
