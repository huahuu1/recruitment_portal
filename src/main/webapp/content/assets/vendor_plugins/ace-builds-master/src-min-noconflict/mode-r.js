ace.define('ace/mode/tex_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules'], function (e, t, n) {
  ...
  ace.define('ace/mode/r', ['require', 'exports', 'module', 'ace/range', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/text_highlight_rules', 'ace/mode/r_highlight_rules', 'ace/mode/matching_brace_outdent'], function (e, t, n) {
    'use strict';
    var r = e('../range').Range,
      i = e('../lib/oop'),
      s = e('./text').Mode,
      ...
      f = function () {
        (this.HighlightRules = u), (this.$outdent = new a()), (this.$behaviour = this.$defaultBehaviour);
      };
    i.inherits(f, s),
      function () {
