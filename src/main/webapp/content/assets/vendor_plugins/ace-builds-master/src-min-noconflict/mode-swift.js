ace.define('ace/mode/doc_comment_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (e, t, n) {
      ...
      u = function () {
        function t(e, t) {
          var n = t.nestable || t.interpolation,
            ...
            o = [t.escape && { regex: t.escape, token: 'character.escape' }, t.interpolation && { token: 'paren.quasi.start', regex: i.escapeRegExp(t.interpolation.lead + t.interpolation.open), push: r }, t.error && { regex: t.error, token: 'error.invalid' }, { regex: e + (t.multiline ? '' : '|$'), token: 'string.end', next: n ? 'pop' : 'start' }, { defaultToken: 'string' }].filter(Boolean);
          n ? (s.push = o) : (s.next = o);
  ...
  ace.define('ace/mode/swift', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/swift_highlight_rules', 'ace/mode/behaviour/cstyle', 'ace/mode/folding/cstyle'], function (e, t, n) {
    ...
    r.inherits(a, i),
      function () {
        (this.lineCommentStart = '//'), (this.blockComment = { start: '/*', end: '*/', nestable: !0 }), (this.$id = 'ace/mode/swift');
      }.call(a.prototype),
      (t.Mode = a);
  });
