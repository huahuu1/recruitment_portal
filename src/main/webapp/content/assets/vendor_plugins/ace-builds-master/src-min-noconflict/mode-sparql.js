ace.define('ace/mode/sparql_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (e, t, n) {
  'use strict';
  var r = e('../lib/oop'),
    ...
    s = function () {
      (this.$rules = {
        ...
        '#qnames': [{ token: 'entity.name.other.qname.sparql', regex: /(?:[a-zA-Z][-_a-zA-Z0-9]*)?:(?:[_a-zA-Z][-_a-zA-Z0-9]*)?/ }],
        '#rdf-schema-types': [{ token: 'support.type.datatype.rdf.schema.sparql', regex: /rdfs?:[a-zA-Z]+|(?:^|\s)a(?:\s|$)/ }],
        '#relative-urls': [{ token: 'string.quoted.other.relative.url.sparql', regex: /</, push: [{ token: 'string.quoted.other.relative.url.sparql', regex: />/, next: 'pop' }, { defaultToken: 'string.quoted.other.relative.url.sparql' }] }],
        '#string-datatype-suffixes': [{ token: 'keyword.operator.datatype.suffix.sparql', regex: /\^\^/ }],
        '#string-language-suffixes': [{ token: ['keyword.operator.language.suffix.sparql', 'constant.language.suffix.sparql'], regex: /(?!")(@)([a-z]+(?:\-[a-z0-9]+)*)/ }],
        '#strings': [
          { token: 'string.quoted.triple.sparql', regex: /"""/, push: [{ token: 'string.quoted.triple.sparql', regex: /"""/, next: 'pop' }, { defaultToken: 'string.quoted.triple.sparql' }] },
          { token: 'string.quoted.double.sparql', regex: /"/, push: [{ token: 'string.quoted.double.sparql', regex: /"/, next: 'pop' }, { token: 'invalid.string.newline', regex: /$/ }, { token: 'constant.character.escape.sparql', regex: /\\./ }, { defaultToken: 'string.quoted.double.sparql' }] },
        ],
  ...
  (s.metaData = { fileTypes: ['rq', 'sparql'], name: 'SPARQL', scopeName: 'source.sparql' }), r.inherits(s, i), (t.SPARQLHighlightRules = s);
}),
  ...
  ace.define('ace/mode/sparql', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/sparql_highlight_rules', 'ace/mode/folding/cstyle'], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      i = e('./text').Mode,
