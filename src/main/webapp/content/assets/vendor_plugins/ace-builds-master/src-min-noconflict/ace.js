(function () {
      ...
      c = function (e, t) {
        ...
        var L = !1,
          ...
          _ = function (e, n) {
            ...
            M(e, s)
              ? (i.isIOS && ((d = n), (c.value = '\n aa' + s + 'a a\n'), c.setSelectionRange(4, 4 + s.length), (p = { value: s })), n ? t.onCut() : t.onCopy(), i.isIOS || r.preventDefault(e))
              : ((p = !0),
                (c.value = s),
                c.select(),
                setTimeout(function () {
        ...
        var B = function (e) {
          ...
          F = function (e) {
            ...
            (k = function (i) {
              ...
              e.type == 'compositionend' && n.range && t.selection.setRange(n.range);
        ...
        r.addListener(c, 'compositionstart', B),
          ...
          (this.onContextMenu = function (e) {
            (L = !0), x(t.selection.isEmpty()), t._emit('nativecontextmenu', { target: t, domEvent: e }), this.moveToMouse(e, !0);
          }),
    ...
    var r = e('../lib/event'),
      ...
      l = function (e, t) {
        function w(e) {
          if (p) return;
          p = !0;
          if (T) (t = 0), (r = e ? 0 : n.value.length - 1);
          else
            var t = e ? 2 : 1,
              r = 2;
          try {
        ...
        var N = !1,
          C = function (e) {
            T && ((e = T(e)), (T = null)), h ? (w(), e && t.onPaste(e), (h = !1)) : e == l.charAt(0) ? (N ? t.execCommand('del', { source: 'ace' }) : t.execCommand('backspace', { source: 'ace' })) : (e.substring(0, 2) == l ? (e = e.substr(2)) : e.charAt(0) == l.charAt(0) ? (e = e.substr(1)) : e.charAt(e.length - 1) == l.charAt(0) && (e = e.slice(0, -1)), e.charAt(e.length - 1) == l.charAt(0) && (e = e.slice(0, -1)), e && t.onTextInput(e)), N && (N = !1);
          },
          k = function (e) {
            if (p) return;
            var t = n.value;
        ...
        r.addCommandKeyListener(n, t.onCommandKey.bind(t)),
          r.addListener(n, 'select', x),
          r.addListener(n, 'input', k),
          r.addListener(n, 'cut', O),
          r.addListener(n, 'copy', M),
        ...
        r.addListener(n, 'compositionstart', D),
          i.isGecko
          ...
          r.addListener(n, 'compositionend', H),
          (this.getElement = function () {
            return n;
          }),
          (this.setReadOnly = function (e) {
          ...
          (this.onContextMenu = function (e) {
            (N = !0), w(t.selection.isEmpty()), t._emit('nativecontextmenu', { target: t, domEvent: e }), this.moveToMouse(e, !0);
          }),
        ...
        r.addListener(n, 'mouseup', I),
          r.addListener(n, 'mousedown', function (e) {
            e.preventDefault(), F();
          }),
          r.addListener(t.renderer.scroller, 'contextmenu', I),
          r.addListener(n, 'contextmenu', I);
      };
    t.TextInput = l;
  }),
  ...
  ace.define('ace/mouse/mouse_handler', ['require', 'exports', 'module', 'ace/lib/event', 'ace/lib/useragent', 'ace/mouse/default_handlers', 'ace/mouse/default_gutter_handler', 'ace/mouse/mouse_event', 'ace/mouse/dragdrop_handler', 'ace/config'], function (e, t, n) {
    ...
    var r = e('../lib/event'),
      ...
      l = function (e) {
        ...
        r.addListener(f, 'mousedown', this.onMouseEvent.bind(this, 'guttermousedown')),
          ...
          i.isIE && e.renderer.scrollBarV && (r.addListener(e.renderer.scrollBarV.element, 'mousedown', n), r.addListener(e.renderer.scrollBarH.element, 'mousedown', n)),
    ...
    (function () {
      ...
      f.defineOptions(l.prototype, 'mouseHandler', { scrollSpeed: { initialValue: 2 }, dragDelay: { initialValue: i.isMac ? 150 : 0 }, dragEnabled: { initialValue: !0 }, focusTimout: { initialValue: 0 }, tooltipFollowsMouse: { initialValue: !0 } }),
      (t.MouseHandler = l));
  }),
      ...
      s = function (e) {
        ...
        for (var t in this.states) {
          ...
          for (var a = 0; a < n.length; a++) {
            ...
            Array.isArray(f.token) ? (f.token.length == 1 || c == 1 ? (f.token = f.token[0]) : c - 1 != f.token.length ? (this.reportError("number of classes and regexp groups doesn't match", { rule: f, groupCount: c - 1 }), (f.token = f.token[0])) : ((f.tokenArray = f.token), (f.token = null), (f.onMatch = this.$arrayTokens))) : typeof f.token == 'function' && !f.onMatch && (c > 1 ? (f.onMatch = this.$applyToken) : (f.onMatch = f.token)),
              c > 1 &&
                (/\\\d/.test(f.regex)
      ...
      (this.normalizeRules = function () {
        function i(s) {
          ...
          for (var u = 0; u < o.length; u++) {
            var a = o[u],
              f = null;
            Array.isArray(a) && ((f = a), (a = {})), !a.regex && a.start && ((a.regex = a.start), a.next || (a.next = []), a.next.push({ defaultToken: a.token }, { token: a.token + '.end', regex: a.end || a.start, next: 'pop' }), (a.token = a.token + '.start'), (a.push = !0));
            var l = a.next || a.push;
      ...
      d = function (e) {
        this.add('braces', 'insertion', function (t, n, r, i, s) {
          ...
          if (s == '{') {
            ...
            if (d.isSaneInsertion(r, i)) return /[\]\}\)]/.test(a[u.column]) || r.inMultiSelectMode || (e && e.braces) ? (d.recordAutoInsert(r, i, '}'), { text: '{}', selection: [1, 1] }) : (d.recordMaybeInsert(r, i, '{'), { text: '{', selection: [1, 1] });
          } else if (s == '}') {
            h(r);
            var v = a.substring(u.column, u.column + 1);
            if (v == '}') {
              var m = i.$findOpeningBracket('}', { column: u.column + 1, row: u.row });
              if (m !== null && d.isAutoInsertedClosing(u, a, s)) return d.popAutoInsertedClosing(), { text: '', selection: [1, 1] };
            }
          } else {
            if (s == '\n' || s == '\r\n') {
              h(r);
          ...
          this.add('parens', 'insertion', function (e, t, n, r, i) {
            if (i == '(') {
              ...
              if (f == ')') {
                ...
                if (l !== null && d.isAutoInsertedClosing(u, a, i)) return d.popAutoInsertedClosing(), { text: '', selection: [1, 1] };
              }
            }
          }),
      ...
      function () {
        ...
        r.implement(this, o),
          ...
          (this.onChange = function (e) {
            ...
            !this.$fromUndo && this.$undoManager && !e.ignore && (this.$deltasDoc.push(e), t && t.length != 0 && this.$deltasFold.push({ action: 'removeFolds', folds: t }), this.$informUndoManager.schedule()), this.bgTokenizer && this.bgTokenizer.$updateOnChange(e), this._signal('change', e);
          }),
          (this.setValue = function (e) {
          ...
          (this.addMarker = function (e, t, n, r) {
            var i = this.$markerId++,
              s = { range: e, type: n || 'line', renderer: typeof n == 'function' ? n : null, clazz: t, inFront: !!r, id: i };
          ...
          (this.setWrapLimitRange = function (e, t) {
            if (this.$wrapLimitRange.min !== e || this.$wrapLimitRange.max !== t) (this.$wrapLimitRange = { min: e, max: t }), (this.$modified = !0), this.$useWrapMode && this._signal('changeWrapMode');
          }),
              ...
              (f = this.getFoldLine(l, f)),
                f
                  ? ((a = []),
                    ...
                    (l = f.end.row + 1))
                  : ((a = this.$getDisplayTokens(r[l])), (s[l] = this.$computeWrapSplits(a, o, i)), l++);
          });
        var e = 1,
          t = 2,
          n = 3,
        ...
        r.implement(this, s),
          ...
          (this.toggleRecording = function (e) {
            ...
            return (
              ...
              this.recording
                ? (this.macro.pop(), this.removeEventListener('exec', this.$addCommandToMacro), this.macro.length || (this.macro = this.oldMacro), (this.recording = !1))
  ...
  ace.define('ace/commands/default_commands', ['require', 'exports', 'module', 'ace/lib/lang', 'ace/config', 'ace/range'], function (e, t, n) {
    ...
    t.commands = [
      ...
      { name: 'passKeysToBrowser', bindKey: o(null, null), exec: function () {}, passEvent: !0, readOnly: !0 },
    ...
    var r = e('./lib/oop'),
      ...
      b = function (e, t) {
        ...
        (this.container = n),
          ...
          typeof document == 'object' && ((this.textInput = new u(e.getTextAreaContainer(), this)), (this.renderer.textarea = this.textInput.getElement()), (this.$mouseHandler = new a(this)), new f(this)),
      ...
      function () {
        r.implement(this, d),
          ...
          (this.revealRange = function (e, t) {
            ...
            this.renderer.scrollSelectionIntoView(e.start, e.end, 0.5), t !== !1 && this.renderer.animateScrolling(n);
          }),
          (this.undo = function () {
  ...
  ace.define('ace/undomanager', ['require', 'exports', 'module'], function (e, t, n) {
    ...
    (function () {
      function e(e) {
        return { action: e.action, start: e.start, end: e.end, lines: e.lines.length == 1 ? null : e.lines, text: e.lines.length == 1 ? e.lines[0] : null };
      }
      function t(e) {
    ...
    (function () {
      (this.CHANGE_CURSOR = 1),
        ...
        (this.$updateCachedSize = function (e, t, n, r) {
          ...
          var i = 0,
            s = this.$size,
            o = { width: s.width, height: s.height, scrollerHeight: s.scrollerHeight, scrollerWidth: s.scrollerWidth };
        ...
        (this.$computeLayerConfig = function () {
          ...
          return (this.layerConfig = { width: s, padding: this.$padding, firstRow: m, firstRowScreen: y, lastRow: g, lineHeight: w, characterWidth: this.characterWidth, minHeight: l, maxHeight: i, offset: f, gutterOffset: w ? Math.max(0, Math.ceil((f + t.height - t.scrollerHeight) / w)) : 0, height: this.$size.scrollerHeight }), S;
        }),
  ...
  ace.define('ace/worker/worker_client', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/net', 'ace/lib/event_emitter', 'ace/config'], function (e, t, n) {
    ...
    var r = e('../lib/oop'),
      ...
      f = function (t, n, r, i, s) {
        ...
        (this.$worker = a(i)), s && this.send('importScripts', s), this.$worker.postMessage({ init: !0, tlns: f, module: n, classname: r }), (this.callbackId = 1), (this.callbacks = {}), (this.$worker.onmessage = this.onMessage);
      };
    (function () {
      r.implement(this, s),
      ...
      (this.updateSelectionMarkers = function () {
        ...
        (this.selectMore = function (e, t, n) {
          ...
          var o = r.getTextRange(s),
            u = h(r, o, e);
          u && ((u.cursor = e == -1 ? u.start : u.end), (this.$blockScrolling += 1), this.session.unfold(u), this.multiSelect.addRange(u), (this.$blockScrolling -= 1), this.renderer.scrollCursorIntoView(null, 0.5)), t && this.multiSelect.substractPoint(s.cursor);
        }),
