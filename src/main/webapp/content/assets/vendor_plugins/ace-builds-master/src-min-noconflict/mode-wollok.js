ace.define('ace/mode/doc_comment_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (e, t, n) {
  ...
  ace.define('ace/mode/wollok_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], function (e, t, n) {
    ...
    var r = e('../lib/oop'),
      ...
      s = e('./text_highlight_rules').TextHighlightRules,
      o = function () {
        var e = 'test|package|inherits|false|import|else|or|class|and|not|native|override|program|this|try|val|var|catch|object|super|throw|if|null|return|true|new|method',
        ...
        (this.$rules = {
          start: [{ token: 'comment', regex: '\\/\\/.*$' }, i.getStartRule('doc-start'), { token: 'comment', regex: '\\/\\*', next: 'comment' }, { token: 'string', regex: '["](?:(?:\\\\.)|(?:[^"\\\\]))*?["]' }, { token: 'string', regex: "['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']" }, { token: 'constant.numeric', regex: /0(?:[xX][0-9a-fA-F][0-9a-fA-F_]*|[bB][01][01_]*)[LlSsDdFfYy]?\b/ }, { token: 'constant.numeric', regex: /[+-]?\d[\d_]*(?:(?:\.[\d_]*)?(?:[eE][+-]?[\d_]+)?)?[LlSsDdFfYy]?\b/ }, { token: 'constant.language.boolean', regex: '(?:true|false)\\b' }, { token: r, regex: '[a-zA-Z_$][a-zA-Z0-9_$]*\\b' }, { token: 'keyword.operator', regex: '===|&&|\\*=|\\.\\.|\\*\\*|#|!|%|\\*|\\?:|\\+|\\/|,|\\+=|\\-|\\.\\.<|!==|:|\\/=|\\?\\.|\\+\\+|>|=|<|>=|=>|==|\\]|\\[|\\-=|\\->|\\||\\-\\-|<>|!=|%=|\\|' }, { token: 'lparen', regex: '[[({]' }, { token: 'rparen', regex: '[\\])}]' }, { token: 'text', regex: '\\s+' }],
          comment: [
