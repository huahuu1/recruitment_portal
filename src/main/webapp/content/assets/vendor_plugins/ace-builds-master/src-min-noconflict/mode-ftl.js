    ...
    var r = e('../lib/oop'),
      ...
      o = function () {
        ...
        this.$rules = {
          ...
          qstring: [{ token: 'constant.character.escape', regex: '\\\\[nrtvef\\\\"$]' }, { token: 'string', regex: /['"]/, next: 'start' }, { defaultToken: 'string' }],
        };
      };
    r.inherits(o, s);
    var u = function () {
      ...
      var e = 'assign|attempt|break|case|compress|default|elseif|else|escape|fallback|function|flush|ftl|global|if|import|include|list|local|lt|macro|nested|noescape|noparse|nt|recover|recurse|return|rt|setting|stop|switch|t|visit',
        t = [
          ...
          { token: 'keyword.other', regex: '</?@[a-zA-Z\\.]+', push: 'ftl-start' },
        ],
        n = [
      ...
      this.embedRules(o, 'ftl-', n, ['start']), this.addRules({ 'ftl-dcomment': [{ token: 'comment', regex: '-->', next: 'pop' }, { defaultToken: 'comment' }] }), this.normalizeRules();
    };
    r.inherits(u, i), (t.FtlHighlightRules = u);
  }),
  ace.define('ace/mode/ftl', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/ftl_highlight_rules'], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      i = e('./text').Mode,
