ace.define('ace/mode/scheme_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (e, t, n) {
  ...
  var r = e('../lib/oop'),
    ...
    s = function () {
      var e = 'case|do|let|loop|if|else|when',
        ...
        i = this.createKeywordMapper({ 'keyword.control': e, 'keyword.operator': t, 'constant.language': n, 'support.function': r }, 'identifier', !0);
      this.$rules = {
        start: [
          { token: 'comment', regex: ';.*$' },
  ...
  ace.define('ace/mode/scheme', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/scheme_highlight_rules', 'ace/mode/matching_parens_outdent'], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      i = e('./text').Mode,
