    ...
    var r = e('../lib/oop'),
      ...
      s = function () {
        var e = 'break|do|else|elseif|end|for|function|if|in|local|repeat|return|then|until|while|or|and|not',
          ...
          s = this.createKeywordMapper({ keyword: e, 'support.function': n, 'keyword.deprecated': i, 'constant.library': r, 'constant.language': t, 'variable.language': 'self' }, 'identifier'),
          o = '(?:(?:[1-9]\\d*)|(?:0))',
          u = '(?:0[xX][\\dA-Fa-f]+)',
          a = '(?:' + o + '|' + u + ')',
          f = '(?:\\.\\d+)',
      ...
      function () {
        (this.foldingStartMarker = /\b(function|then|do|repeat)\b|{\s*$|(\[=*\[)/),
          ...
          (this.luaBlock = function (e, t, n) {
            var r = new o(e, t, n),
              i = { function: 1, do: 1, then: 1, elseif: -1, end: -1, repeat: 1, until: -1 },
              u = r.getCurrentToken();
            ...
            var a = u.value,
              ...
              l = i[a];
            if (!l) return;
            var c = l === -1 ? r.getCurrentTokenColumn() : e.getLine(t).length,
              h = t;
        ...
        (this.getNextLineIndent = function (e, t, r) {
          ...
          (this.autoOutdent = function (e, t, r) {
            var i = t.getLine(r - 1),
              ...
              o = this.getTokenizer().getLineTokens(i, 'start').tokens,
              a = t.getTabString().length,
              f = s + a * n(o),
              l = this.$getIndent(t.getLine(r)).length;
            if (l <= f) return;
            t.outdentRows(new u(r, 0, r + 2, 0));
          }),
          (this.createWorker = function (e) {
