ace.define('ace/mode/matching_brace_outdent', ['require', 'exports', 'module', 'ace/range'], function (e, t, n) {
  ...
  ace.define('ace/mode/livescript', ['require', 'exports', 'module', 'ace/tokenizer', 'ace/mode/matching_brace_outdent', 'ace/mode/text'], function (e, t, n) {
    function u(e, t) {
      function n() {}
    ...
    (r = '(?![\\d\\s])[$\\w\\xAA-\\uFFDC](?:(?!\\s)[$\\w\\xAA-\\uFFDC]|-[A-Za-z])*'),
      (t.Mode = i = (function (t) {
        ...
        var n,
          ...
          s = o;
        return (
          (n = RegExp('(?:[({[=:]|[-~]>|\\b(?:e(?:lse|xport)|d(?:o|efault)|t(?:ry|hen)|finally|import(?:\\s*all)?|const|var|let|new|catch(?:\\s*' + r + ')?))\\s*$')),
      ...
      (i.Rules = {
        ...
        heregex: [{ token: 'string.regex', regex: '.*?//[gimy$?]{0,4}', next: 'start' }, { token: 'string.regex', regex: '\\s*#{' }, { token: 'comment.regex', regex: '\\s+(?:#.*)?' }, { defaultToken: 'string.regex' }],
        key: [
          { token: 'keyword.operator', regex: '[.?@!]+' },
