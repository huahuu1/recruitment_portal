      ...
      function () {
        (this.attach = function (e) {
          ...
          s.call(this, t.iSearchCommands, e.commands.platform),
            (this.$commandExecHandler = e.commands.addEventListener('exec', function (t) {
              if (!t.command.isIncrementalSearchCommand) return n.deactivate();
              t.stopPropagation(), t.preventDefault();
              var r = e.session.getScrollTop(),
                i = t.command.exec(n, t.args || {});
              return e.renderer.scrollCursorIntoView(null, 0.5), e.renderer.animateScrolling(r), i;
            }));
        }),
  ...
  ace.define('ace/keyboard/emacs', ['require', 'exports', 'module', 'ace/lib/dom', 'ace/incremental_search', 'ace/commands/incremental_search_commands', 'ace/keyboard/hash_handler', 'ace/lib/keys'], function (e, t, n) {
    ...
    var i = e('../commands/incremental_search_commands'),
      s = function (e, t) {
        var n = this.scroller.getBoundingClientRect(),
          r = Math.floor((e + this.scrollLeft - n.left - this.$padding) / this.characterWidth),
    ...
    (t.handler.attach = function (e) {
      u || ((u = !0), r.importCssString('            .emacs-mode .ace_cursor{                border: 1px rgba(50,250,50,0.8) solid!important;                -moz-box-sizing: border-box!important;                -webkit-box-sizing: border-box!important;                box-sizing: border-box!important;                background-color: rgba(0,250,0,0.9);                opacity: 0.5;            }            .emacs-mode .ace_hidden-cursors .ace_cursor{                opacity: 1;                background-color: transparent;            }            .emacs-mode .ace_overwrite-cursors .ace_cursor {                opacity: 1;                background-color: transparent;                border-width: 0 0 2px 2px !important;            }            .emacs-mode .ace_text-layer {                z-index: 4            }            .emacs-mode .ace_cursor-layer {                z-index: 2            }', 'emacsMode')),
        ...
        (f = e.session.$useEmacsStyleLineStart),
        ...
        e.on('click', c),
        e.on('changeSession', l),
        (e.renderer.screenToTextCoordinates = s),
        e.setStyle('emacs-mode'),
        e.commands.addCommands(v),
    ...
    var l = function (e) {
      ...
      h = e('../lib/keys').KEY_MODS,
      p = { C: 'ctrl', S: 'shift', M: 'alt', CMD: 'command' },
      d = ['C-S-M-CMD', 'S-M-CMD', 'C-M-CMD', 'C-S-CMD', 'C-S-M', 'M-CMD', 'S-CMD', 'S-M', 'C-CMD', 'C-M', 'C-S', 'CMD', 'M', 'S', 'C'];
      ...
      t.handler.addCommands({
        recenterTopBottom: function (e) {
          var t = e.renderer,
            ...
            i = t.scrollTop;
          Math.abs(n.top - i) < 2 ? (i = n.top - r) : Math.abs(n.top - i - r * 0.5) < 2 ? (i = n.top) : (i = n.top - r * 0.5), e.session.setScrollTop(i);
        },
