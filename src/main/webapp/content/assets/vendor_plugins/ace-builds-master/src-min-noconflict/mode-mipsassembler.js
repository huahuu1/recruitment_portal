ace.define('ace/mode/mipsassembler_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (e, t, n) {
  'use strict';
  var r = e('../lib/oop'),
    i = e('./text_highlight_rules').TextHighlightRules,
    s = function () {
      (this.$rules = {
        start: [{ token: 'string.start', regex: '"', next: 'qstring' }],
        qstring: [
          { token: 'escape', regex: /\\./ },
  ...
  (s.metaData = r.inherits(s, i)), (t.mipsassemblerHighlightRules = s);
}),
  ...
  ace.define('ace/mode/mipsassembler', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/mipsassembler_highlight_rules', 'ace/mode/folding/cstyle'], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      i = e('./text').Mode,
      s = e('./mipsassembler_highlight_rules').HighlightRules,
