ace.define('ace/ext/menu_tools/element_generator', ['require', 'exports', 'module'], function (e, t, n) {
  ...
  ace.define('ace/ext/menu_tools/get_set_functions', ['require', 'exports', 'module'], function (e, t, n) {
    ...
    n.exports.getSetFunctions = function (t) {
      var n = [],
        ...
        i = [],
        s = ['setOption', 'setUndoManager', 'setDocument', 'setValue', 'setBreakpoints', 'setScrollTop', 'setScrollLeft', 'setSelectionStyle', 'setWrapLimitRange'];
      return (
  ...
  ace.define('ace/ext/menu_tools/generate_settings_menu', ['require', 'exports', 'module', 'ace/ext/menu_tools/element_generator', 'ace/ext/menu_tools/add_editor_menu_options', 'ace/ext/menu_tools/get_set_functions', 'ace/ace'], function (e, t, n) {
    'use strict';
    ...
    n.exports.generateSettingsMenu = function (n) {
      ...
      function a() {
        ...
        var n = t.appendChild(document.createElement('div')),
          r = e('../../ace').version;
        return (n.style.padding = '1em'), (n.textContent = 'Ace version ' + r), t;
      }
      function f(e, t, i, s) {
        var o,
              ...
              o.addEventListener('change', function (t) {
                try {
                  n.menuOptions[t.target.id].forEach(function (e) {
                    e.textContent !== t.target.textContent && delete e.selected;
                  }),
      ...
      function c(e) {
        ...
        if (n.menuOptions[t] !== undefined) o.push(l(t, r, i, u));
          ...
          try {
            (s = r[u]()), typeof s == 'object' && (s = s.$id), o.push(f(r, i, t, s));
          } catch (a) {}
      }
      var o = [];
      return (
  ...
  ace.define('ace/ext/menu_tools/overlay_page', ['require', 'exports', 'module', 'ace/lib/dom'], function (e, t, n) {
    ...
    r.importCssString(i),
      (n.exports.overlayPage = function (t, n, i, s, o, u) {
        ...
        (a.style.cssText = 'margin: 0; padding: 0; position: fixed; top:0; bottom:0; left:0; right:0;z-index: 9990; background-color: rgba(0, 0, 0, 0.3);'),
