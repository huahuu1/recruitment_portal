    ...
    (function () {
      ...
      (function () {
        ...
        var Properties = {
          ...
          'animation-direction': { multi: 'normal | reverse | alternate | alternate-reverse', comma: !0 },
          ...
          '-moz-animation-direction': { multi: 'normal | reverse | alternate | alternate-reverse', comma: !0 },
          ...
          '-ms-animation-direction': { multi: 'normal | reverse | alternate | alternate-reverse', comma: !0 },
          ...
          '-webkit-animation-direction': { multi: 'normal | reverse | alternate | alternate-reverse', comma: !0 },
          ...
          '-o-animation-direction': { multi: 'normal | reverse | alternate | alternate-reverse', comma: !0 },
      ...
      return (
        ...
        (r.verify = function (t, r) {
          var s = 0,
            ...
            u,
            a,
            f = new parserlib.css.Parser({ starHack: !0, ieFilters: !0, underscoreHack: !0, strict: !1 });
    ...
    (Reporter.prototype = {
      ...
      CSSLint.addRule({
        ...
        init: function (e, t) {
          ...
          var n = this,
            r = { border: 1, 'border-left': 1, 'border-right': 1, padding: 1, 'padding-left': 1, 'padding-right': 1 },
            i = { border: 1, 'border-bottom': 1, 'border-top': 1, padding: 1, 'padding-bottom': 1, 'padding-top': 1 },
            s,
            o = !1;
      ...
      CSSLint.addRule({
        ...
        init: function (e, t) {
          ...
          var n = this,
            r = { display: 1, float: 'none', height: 1, width: 1, margin: 1, 'margin-left': 1, 'margin-right': 1, 'margin-bottom': 1, 'margin-top': 1, padding: 1, 'padding-left': 1, 'padding-right': 1, 'padding-bottom': 1, 'padding-top': 1, 'vertical-align': 1 },
            i;
      ...
      CSSLint.addRule({
        ...
        init: function (e, t) {
          ...
          var n = this,
            r,
            i = { color: 1, background: 1, 'border-color': 1, 'border-top-color': 1, 'border-right-color': 1, 'border-bottom-color': 1, 'border-left-color': 1, border: 1, 'border-top': 1, 'border-right': 1, 'border-bottom': 1, 'border-left': 1, 'background-color': 1 },
            s;
          e.addListener('startrule', o),
            e.addListener('startfontface', o),
            e.addListener('startpage', o),
      ...
      CSSLint.addRule({
        ...
        init: function (e, t) {
          ...
          var n = this,
            ...
            o = {},
            u,
            a = { margin: ['margin-top', 'margin-bottom', 'margin-left', 'margin-right'], padding: ['padding-top', 'padding-bottom', 'padding-left', 'padding-right'] };
        ...
        formatResults: function (e, t) {
          ...
          return (
            n.length > 0 &&
              ...
              r.unshift('<testsuite time="0" tests="' + n.length + '" skipped="0" errors="' + i.error + '" failures="' + i.failure + '" package="net.csslint" name="' + t + '">'),
              r.push('</testsuite>')),
            r.join('')
          );
        },
