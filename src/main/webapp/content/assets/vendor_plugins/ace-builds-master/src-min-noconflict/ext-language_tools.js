      ...
      l = function (e) {
        ...
        (c.id = n.session.addMarker(c, 'ace_active-line', 'fullLine')),
          ...
          n.renderer.on('afterRender', function () {
            ...
            t.selectedNode && a.removeCssClass(t.selectedNode, 'ace_selected'), (t.selectedNode = r), r && a.addCssClass(r, 'ace_selected');
          });
        var h = function () {
            p(-1);
          },
        ...
        return (
          ...
          (n.show = function (e, t, r) {
            var s = this.container,
              ...
              c = l > o / 2 && !r;
            c && l + t + f > o ? ((a.$maxPixelHeight = l - 2 * this.$borderSize), (s.style.top = ''), (s.style.bottom = o - l + 'px'), (n.isTopdown = !1)) : ((l += t), (a.$maxPixelHeight = o - l - 0.2 * t), (s.style.top = l + 'px'), (s.style.bottom = ''), (n.isTopdown = !0)), (s.style.display = ''), this.renderer.$textLayer.checkForSizeChanges();
            var h = e.left;
          ...
          return (
            e.completers.forEach(function (a, f) {
              a.getCompletions(e, n, r, i, function (n, r) {
                !n && r && (o = o.concat(r)), t(null, { prefix: s.getCompletionPrefix(e), matches: o, finished: --u === 0 });
              });
            }),
            !0
          );
