ace.define('ace/snippets', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/event_emitter', 'ace/lib/lang', 'ace/range', 'ace/anchor', 'ace/keyboard/hash_handler', 'ace/tokenizer', 'ace/lib/dom', 'ace/editor'], function (e, t, n) {
    ...
    r.implement(this, i),
      ...
      (this.expandSnippetForSelection = function (e, t) {
        ...
        return (
          ...
          u ? (t && t.dryRun ? !0 : (e.session.doc.removeInLine(n.row, n.column - u.replaceBefore.length, n.column + u.replaceAfter.length), (this.variables.M__ = u.matchBefore), (this.variables.T__ = u.matchAfter), this.insertSnippetForSelection(e, u.content), (this.variables.M__ = this.variables.T__ = null), !0)) : !1
        );
      }),
      ...
      (this.register = function (e, t) {
        ...
        function a(e) {
          ...
          (e.startRe = u(e.trigger, e.guard, !0)), (e.triggerRe = new RegExp(e.trigger, '', !0)), (e.endRe = u(e.endTrigger, e.endGuard, !0)), (e.endTriggerRe = new RegExp(e.endTrigger, '', !0));
        }
    ...
    (this.attach = function (e) {
      ...
      (this.addTabstops = function (e, t, n) {
        ...
        e.forEach(function (e, n) {
          ...
          s.length > 2 && (this.tabstops.length && s.push(s.splice(2, 1)[0]), this.tabstops.splice.apply(this.tabstops, s));
      }),
  ...
  ace.define('ace/ext/emmet', ['require', 'exports', 'module', 'ace/keyboard/hash_handler', 'ace/editor', 'ace/snippets', 'ace/range', 'resources', 'resources', 'tabStops', 'resources', 'utils', 'actions', 'ace/config', 'ace/config'], function (e, t, n) {
    'use strict';
    function f() {}
    var r = e('ace/keyboard/hash_handler').HashHandler,
      i = e('ace/editor').Editor,
      s = e('ace/snippets').snippetManager,
      o = e('ace/range').Range,
      u,
      a;
    f.prototype = {
      setupContext: function (e) {
        (this.ace = e), (this.indentation = e.session.getTabString()), u || (u = window.emmet);
      ...
      getProfileName: function () {
        var e = u.resources || u.require('resources');
      ...
      $updateTabstops: function (e) {
        var t = 1e3,
          n = 0,
          r = null,
          i = u.tabStops || u.require('tabStops'),
          s = u.resources || u.require('resources'),
        ...
        if (o.variables.insert_final_tabstop && !/\$\{0\}$/.test(e)) e += '${0}';
          ...
          var f = u.utils ? u.utils.common : u.require('utils');
          e = f.replaceSubstring(e, '${0}', r[0], r[1]);
        }
        return e;
      },
    };
    var l = { expand_abbreviation: { mac: 'ctrl+alt+e', win: 'alt+e' }, match_pair_outward: { mac: 'ctrl+d', win: 'ctrl+,' }, match_pair_inward: { mac: 'ctrl+j', win: 'ctrl+shift+0' }, matching_pair: { mac: 'ctrl+alt+j', win: 'alt+j' }, next_edit_point: 'alt+right', prev_edit_point: 'alt+left', toggle_comment: { mac: 'command+/', win: 'ctrl+/' }, split_join_tag: { mac: "shift+command+'", win: 'shift+ctrl+`' }, remove_tag: { mac: "command+'", win: 'shift+ctrl+;' }, evaluate_math_expression: { mac: 'shift+command+y', win: 'shift+ctrl+y' }, increment_number_by_1: 'ctrl+up', decrement_number_by_1: 'ctrl+down', increment_number_by_01: 'alt+up', decrement_number_by_01: 'alt+down', increment_number_by_10: { mac: 'alt+command+up', win: 'shift+alt+up' }, decrement_number_by_10: { mac: 'alt+command+down', win: 'shift+alt+down' }, select_next_item: { mac: 'shift+command+.', win: 'shift+ctrl+.' }, select_previous_item: { mac: 'shift+command+,', win: 'shift+ctrl+,' }, reflect_css_value: { mac: 'shift+command+r', win: 'shift+ctrl+r' }, encode_decode_data_url: { mac: 'shift+ctrl+d', win: "ctrl+'" }, expand_abbreviation_with_tab: 'Tab', wrap_with_abbreviation: { mac: 'shift+ctrl+a', win: 'shift+ctrl+a' } },
      c = new f();
    (t.commands = new r()),
      (t.runEmmetCommand = function v(e) {
        try {
          c.setupContext(e);
          var t = u.actions || u.require('actions');
          ...
          if (this.action == 'wrap_with_abbreviation')
            return setTimeout(function () {
              t.run('wrap_with_abbreviation', c);
            }, 0);
          var i = t.run(this.action, c);
        } catch (s) {
          if (!u) return d(v.bind(this, e)), !0;
    ...
    var p = function (e, n) {
        ...
        e.enableEmmet === !1 && (i = !1), i && d(), t.updateCommands(r, i);
      },
      d = function (t) {
        typeof a == 'string' &&
    ...
    (t.AceEmmetEditor = f),
      e('ace/config').defineOptions(i.prototype, 'editor', {
        enableEmmet: {
          set: function (e) {
            this[e ? 'on' : 'removeListener']('changeMode', p), p({ enableEmmet: !!e }, this);
          },
          value: !0,
        },
      }),
