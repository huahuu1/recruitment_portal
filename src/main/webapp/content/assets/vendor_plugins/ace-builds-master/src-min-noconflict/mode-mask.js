ace.define('ace/mode/doc_comment_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (e, t, n) {
  ...
  ace.define('ace/mode/mask_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules', 'ace/mode/javascript_highlight_rules', 'ace/mode/css_highlight_rules', 'ace/mode/markdown_highlight_rules', 'ace/mode/html_highlight_rules'], function (e, t, n) {
    ...
    function k(e, t, n) {
      var r, i, s;
      return arguments.length === 4 ? ((r = n), (i = arguments[3])) : typeof n == 'string' ? (i = n) : (r = n), typeof e == 'function' && ((s = e), (e = 'empty')), { token: e, regex: t, push: r, next: i, onMatch: s };
    }
    ...
    var C = {
      ...
      syntax: function (e, t, n) {
        return { token: p, regex: e, push: { attr: [t + '-start', k(m, /;/, 'start')], multiline: [C.tagHead(/\./), C.tagHead(/#/), C.attribute(), C.expression(), k(b, /[>\{]/), k(m, /;/, 'start'), k(b, /'''|"""/, [t + '-start'])], block: [C.tagHead(/\./), C.tagHead(/#/), C.attribute(), C.expression(), k(b, /\{/, [t + '-start'])] }[n] };
      },
      attribute: function () {
        return k(
          function (e) {
          ...
          /[\w_-]+/,
          [k(m, /\s*=\s*/, [C.string('"'), C.string("'"), C.word(), C.goUp()]), C.goUp()]
        );
      },
      expression: function () {
