ace.define('ace/ext/static_highlight', ['require', 'exports', 'module', 'ace/edit_session', 'ace/layer/text', 'ace/config', 'ace/lib/dom'], function (e, t, n) {
  ...
  (f.render = function (e, t, n, i, s, u) {
    ...
    (f.renderSync = function (e, t, n, i, o) {
      ...
      var l = [],
        c = u.getLength();
      for (var h = 0; h < c; h++) l.push("<div class='ace_line'>"), o || l.push("<span class='ace_gutter ace_gutter-cell' unselectable='on'></span>"), f.$renderLine(l, h, !0, !1), l.push('\n</div>');
      var p = "<div class='" + n.cssClass + "'>" + "<div class='ace_static_highlight" + (o ? '' : ' ace_show_gutter') + "' style='counter-reset:ace_line " + (i - 1) + "'>" + l.join('') + '</div>' + '</div>';
