ace.define('ace/snippets/vala', ['require', 'exports', 'module'], function (e, t, n) {
  ...
  (t.snippets = [
    ...
    { content: 'public errordomain ${1:Error} {\n	$0\n}', name: 'error domain', scope: 'vala', tabTrigger: 'errordomain' },
