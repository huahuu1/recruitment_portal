...
var WeatherIcon = (function () {
  ...
  WeatherIcon.Canvas = (function () {
    ...
    var rv = -1, // Default value assumes no ie
  ...
  WeatherIcon.Point = (function () {
    ...
    Point.prototype.prod = function (n) {
      this.x *= n;
      this.y *= n;
    };
    Point.prototype.clone = function () {
      return new WeatherIcon.Point(this.x, this.y);
    };
  ...
  // Circle
  WeatherIcon.Circle = function (center, r) {
    this.center = center;
    this.r = r;
  };
  ...
  WeatherIcon.Cloud = (function () {
    var Cloud = function (xo, yo, w) {
      ...
      this.cc = new WeatherIcon.Circle(new WeatherIcon.Point(center.x - sizeMed.x * 0.2, center.y), w * 0.28);
  ...
  WeatherIcon.particles = {
    heavy: [new WeatherIcon.Point(22, 96), new WeatherIcon.Point(22, 116), new WeatherIcon.Point(36, 71), new WeatherIcon.Point(47, 95), new WeatherIcon.Point(47, 115), new WeatherIcon.Point(57, 64), new WeatherIcon.Point(66, 88), new WeatherIcon.Point(66, 108), new WeatherIcon.Point(78, 61), new WeatherIcon.Point(83, 94), new WeatherIcon.Point(83, 114), new WeatherIcon.Point(95, 72), new WeatherIcon.Point(104, 88), new WeatherIcon.Point(104, 108)],
    light: [new WeatherIcon.Point(22, 96), new WeatherIcon.Point(36, 71), new WeatherIcon.Point(47, 110), new WeatherIcon.Point(66, 88), new WeatherIcon.Point(78, 61), new WeatherIcon.Point(83, 110), new WeatherIcon.Point(104, 88)],
  };
