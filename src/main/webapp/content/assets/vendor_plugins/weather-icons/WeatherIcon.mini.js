...
var WeatherIcon = (function () {
  ...
  e.prototype = {
    ...
    addSleet: function () {
      var t = e.LIGHT,
        ...
        s = e.particles[t].length;
      while (s--) {
        var o = s % 2 ? new e.Drop(e.particles[t][s], n, r, i) : new e.Snow(e.particles[t][s], n, r, i);
    ...
    build: function () {
      ...
      switch (this.icon) {
        case e.SUN:
          this.objects.push(this.body == e.DAY ? new e.Sun(64, 64, 30) : new e.Moon(64, 64, 30));
          break;
        case e.LIGHTCLOUD:
        ...
        case e.PARTLYCLOUD:
          ...
          this.objects.push(this.body == e.DAY ? new e.Sun(64, 54, 30) : new e.Moon(64, 54, 30));
          break;
        case e.CLOUD:
        ...
        case e.LIGHTRAINSUN:
          this.objects.push(new e.Cloud(68, 60, 80));
          this.objects.push(this.body == e.DAY ? new e.Sun(40, 30, 20) : new e.Moon(40, 30, 20));
  ...
  e.Cloud = (function () {
    ...
    t.prototype = {
      ...
      draw: function (e) {
        ...
        e.arc(this.cl.center.x + this.cl.r, this.cl.center.y, this.cl.r, 0, 2 * this.pi);
        ...
        e.arc(this.cr.center.x, this.cr.center.y, 1.3 * this.cr.r, 0, 2 * this.pi);
        e.closePath();
        e.stroke();
        e.fill();
      },
    ...
    t.prototype = {
      ...
      draw: function (e) {
        ...
        if (this.isFreeze) {
          ...
          e.bezierCurveTo(this.p1.x, this.p1.y, this.p2.x, this.p2.y, this.po.x, this.po.y + 1e-5);
        }
        e.closePath();
        e.stroke();
        e.fill();
  ...
  e.Sun = (function () {
    ...
    t.prototype = {
      ...
      draw: function (e) {
        ...
        for (n = 0; n < t; n++) e.quadraticCurveTo(this.points[n].x, this.points[n].y, this.pointsExt[n].x, this.pointsExt[n].y);
        e.stroke();
        e.fill();
        e.restore();
      },
  ...
  e.particles = { heavy: [new e.Point(22, 96), new e.Point(22, 116), new e.Point(36, 71), new e.Point(47, 95), new e.Point(47, 115), new e.Point(57, 64), new e.Point(66, 88), new e.Point(66, 108), new e.Point(78, 61), new e.Point(83, 94), new e.Point(83, 114), new e.Point(95, 72), new e.Point(104, 88), new e.Point(104, 108)], light: [new e.Point(22, 96), new e.Point(36, 71), new e.Point(47, 110), new e.Point(66, 88), new e.Point(78, 61), new e.Point(83, 110), new e.Point(104, 88)] };
  e.DAY = 'Sun';
  e.NIGHT = 'Moon';
  e.LIGHT = 'light';
  e.HEAVY = 'heavy';
  ...
  e.add = function (t, n, r) {
    ...
    if (r == undefined) r = {};
    var i = new e(t, r.stroke === false ? false : true, r.shadow === true ? true : false);
    i.setIcon(n);
