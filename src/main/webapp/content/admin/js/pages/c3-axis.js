...
$(function () {
  ...
  var t = c3.generate({
    ...
    data: {
      columns: [['data', 120, 350, 185, 450, 90, 158, 90, 150, 302]],
    },
  ...
  var i = c3.generate({
    ...
    data: {
      columns: [['data', 10, 252, 125, 421, 131, 269, 45, 352, 142, 425, 125, 248, 41, 212, 154, 424, 136]],
    },
  ...
  var n = c3.generate({
    ...
    data: {
      columns: [['sample', 30, -200, 100, 300, 150, -250, 350, 150, 400, -50]],
    },
