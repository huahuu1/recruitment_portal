...
function drawDocSparklines() {
  ...
  $('#compositebar').sparkline([7, 3, 10, 5, 4, 8, 6, 4, 2, 4, 5, 3, 4, 5], { composite: true, fillColor: false, lineColor: '#ff4c52' });
  ...
  $('.sparktristatecols').sparkline('html', { type: 'tristate', colorMap: { '-2': '#3aa0dc', '2': '#3aa0dc' } });
  ...
  // Discrete charts
  $('.discrete1').sparkline('html', { type: 'discrete', lineColor: '#3aa0dc', xwidth: 18 });
  $('#discrete2').sparkline('html', { type: 'discrete', lineColor: '#3aa0dc', thresholdColor: '#ff4c52', thresholdValue: 4 });
